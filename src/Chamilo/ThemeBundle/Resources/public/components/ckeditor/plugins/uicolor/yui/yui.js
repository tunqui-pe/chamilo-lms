...
YAHOO.util.Event || (YAHOO.util.Event = function () {
    var c = !1, e = [], b = [], d = [], a = [], f = 0, g = [], h = [], i = 0, j = {
        ...
        63277: 34,
        25: 9
    }, k = YAHOO.env.ua.ie ? "focusin" : "focus", l = YAHOO.env.ua.ie ? "focusout" : "blur";
    return {
        POLL_RETRYS: 2E3,
        POLL_INTERVAL: 20,
        EL: 0,
        ...
        onAvailable: function (a, b, d, c, e) {
            for (var a = YAHOO.lang.isString(a) ? [a] : a, j = 0; j < a.length; j += 1)g.push({
                id: a[j],
                fn: b,
                obj: d,
                overrideContext: c,
...
(function () {
    ...
    YAHOO.lang.augmentObject(c, {
        getHorizSlider: function (a, b, d, e, i) {
...
YAHOO.util.Attribute.prototype = {
    ...
    setValue: function (c, e) {
        var b, d = this.owner, a = this.name, f = {
            type: a,
...
(function () {
    ...
    b.prototype = {
        DOM_EVENTS: null, DEFAULT_HTML_SETTER: function (b, a) {
...
this.getElement(this.ID.V).value=this.get(this.OPT.VALUE);this.getElement(this.ID.R).value=this.get(this.OPT.RED);this.getElement(this.ID.R_HEX).innerHTML=f.dec2hex(this.get(this.OPT.RED));this.getElement(this.ID.G).value=this.get(this.OPT.GREEN);this.getElement(this.ID.G_HEX).innerHTML=f.dec2hex(this.get(this.OPT.GREEN));this.getElement(this.ID.B).value=this.get(this.OPT.BLUE);this.getElement(this.ID.B_HEX).innerHTML=f.dec2hex(this.get(this.OPT.BLUE));this.getElement(this.ID.HEX).value=this.get(this.OPT.HEX)},
        ...
        initAttributes: function (a) {
            ...
            this.setAttributeConfig(this.OPT.SHOW_RGB_CONTROLS, {
                value: d.isBoolean(a.showrgbcontrols) ? a.showrgbcontrols : true,
                method: function (a) {
            ...
            this.setAttributeConfig(this.OPT.SHOW_HEX_CONTROLS, {
                value: d.isBoolean(a.showhexcontrols) ? a.showhexcontrols : false,
                method: function (a) {
                    this._hideShowEl(this.ID.HEX_CONTROLS, a)
                }
            });
            this.setAttributeConfig(this.OPT.SHOW_WEBSAFE, {
                value: d.isBoolean(a.showwebsafe) ? a.showwebsafe : true,
                method: function (a) {
            ...
            this.setAttributeConfig(this.OPT.SHOW_HEX_SUMMARY, {
                value: d.isBoolean(a.showhexsummary) ? a.showhexsummary : true,
                method: function (a) {
            ...
            this.setAttributeConfig(this.OPT.ANIMATE, {
                value: d.isBoolean(a.animate) ? a.animate : true,
                method: function (a) {
