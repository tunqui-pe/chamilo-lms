...
(function () {
    ...
    function m(a, d) {
        ...
        b.attachListener(this.inline ? b : this.frame, "mouseout", function (a) {
            ...
            (b <= 0 || b >= this.winTopPane.width || a <= 0 || a >= this.winTopPane.height) && this.hideVisible()
        }, this);
        ...
        this.lineTpl = (new CKEDITOR.template(p)).output({
            ...
            tipLeftStyle: CKEDITOR.tools.writeCssText(CKEDITOR.tools.extend({}, n, {
                left: "0px",
                "border-left-color": "red", "border-width": "6px 0 6px 6px"
    ...
    k.prototype = {
        start: function (a) {
            var d = this, b = this.editor, c = this.doc, e, g, f, h, i = CKEDITOR.tools.eventsBuffer(50, function () {
                if (!(b.readOnly || "wysiwyg" != b.mode))if (d.relations = {}, (g = c.$.elementFromPoint(f, h)) && g.nodeType)e = new CKEDITOR.dom.element(g), d.traverseSearch(e), isNaN(f + h) || d.pixelSearch(e, f, h), a && a(d.relations, f, h)
            });
            ...
            return function (d, b) {
                var c;
                if (b & CKEDITOR.LINEUTILS_AFTER && j(c = d.getNext()) && c.isVisible())a(c, CKEDITOR.LINEUTILS_BEFORE, this.relations), b ^= CKEDITOR.LINEUTILS_AFTER;
                if (b & CKEDITOR.LINEUTILS_INSIDE && j(c = d.getFirst()) && c.isVisible())a(c, CKEDITOR.LINEUTILS_BEFORE, this.relations), b ^= CKEDITOR.LINEUTILS_INSIDE;
            ...
            do if (c = a.$["data-cke-expando"], !(c && c in this.relations)) {
                ...
                if (j(a))for (d in this.lookups)(b = this.lookups[d](a)) && this.store(a, b)
            ...
            function a(a, c, e, g, f) {
                for (var h = 0, i; f(e);) {
                    e += g;
                    if (25 == ++h)break;
                    if (i = this.doc.$.elementFromPoint(c, e))if (i == a)h = 0; else if (d(a, i) && (h = 0, j(i = new CKEDITOR.dom.element(i))))return i
                }
            }
            ...
            this.relations =
            {};
            for (var a = this.editable.getElementsByTag("*"), d = 0, b, c, e; b = a.getItem(d++);)if (!b.equals(this.editable) && (b.hasAttribute("contenteditable") || !b.isReadOnly()) && j(b) && b.isVisible())for (e in this.lookups)(c = this.lookups[e](b)) && this.store(b, c);
    ...
    l.prototype = {
        locate: function () {
            function a(a, b) {
                ...
                return c && j(c) ? (a.siblingRect = c.getClientRect(), b == CKEDITOR.LINEUTILS_BEFORE ? (a.siblingRect.bottom + a.elementRect.top) /
    ...
    m.prototype = {
        removeAll: function () {
            ...
            if (e.top - this.winTopScroll.y < this.rect.top || e.top - this.winTopScroll.y >
                this.rect.bottom)return !1;
            if (this.inline)e.left = b.elementRect.left - this.rect.relativeX; else if (0 < b.elementRect.left ? e.left = this.rect.left + b.elementRect.left : (e.width += b.elementRect.left, e.left = this.rect.left), 0 < (b = e.left + e.width - (this.rect.left + this.winPane.width)))e.width -= b;
            ...
            var a = a.getClientRect(), d = this.container.getDocumentPosition(), b = this.container.getComputedStyle("position");
