...
(function () {
        ...
        a.addCommand(b.name, {
            exec: function (a, d) {
                ...
                if (f && f.name == b.name)f.edit(); else if (b.insert)b.insert(); else if (b.template) {
                    var f = "function" == typeof b.defaults ? b.defaults() : b.defaults, f = CKEDITOR.dom.element.createFromHtml(b.template.output(f)), h, l = a.widgets.wrapElement(f, b.name), k = new CKEDITOR.dom.documentFragment(l.getDocument());
                    k.append(l);
    ...
    function P(a, b) {
        ...
        var d = b.upcast, e = b.upcastPriority || 10;
        if (d)if ("string" == typeof d)for (d = d.split(","); d.length;)c(b.upcasts[d.pop()], b.name, e); else c(d, b.name, e)
    }
    ...
    function L(a) {
        ...
        b.on("drop", function (c) {
            var e = c.data.dataTransfer, f = e.getData("cke/widget-id"), h = e.getTransferType(b), e = b.createRange();
    ...
    function J(a) {
        ...
        b.on("doubleclick", function (c) {
            ...
            if (b && !g.getNestedEditable(b.wrapper, c.data.element))return b.fire("doubleclick", {element: c.data.element})
        }, null, null, 1)
    }
    ...
    function K(a) {
        a.editor.on("key", function (b) {
            ...
            c ? e = c.fire("key", {keyCode: b.data.keyCode}) : d && (c = b.data.keyCode, b = d.focusedEditable, c == CKEDITOR.CTRL + 65 ? (c = b.getBogus(), d = d.editor.createRange(), d.selectNodeContents(b),
    ...
    function I(a) {
        ...
        b.on("selectionChange", function (c) {
            var d = (c = g.getNestedEditable(b.editable(), c.data.selection.getStartElement())) && a.getByElement(c), e = a.widgetHoldingFocusedEditable;
    ...
    function G(a) {
        ...
        b.on("toDataFormat", function (b) {
            var e =
                CKEDITOR.tools.getNextNumber(), f = [];
    ...
    function y(a, b) {
        ...
        if (!d.getById("cke_copybin")) {
            var e = c.blockless || CKEDITOR.env.ie ? "span" : "div", f = d.createElement(e), h = d.createElement(e), e = CKEDITOR.env.ie && 9 > CKEDITOR.env.version;
            ...
            h.append(f);
            c.editable().append(h);
            var k = c.on("selectionChange", C, null, null, 0), m = a.repository.on("checkSelection", C, null, null, 0);
            if (e)var n = d.getDocumentElement().$, p = n.scrollTop;
            g = c.createRange();
    ...
    function X(a) {
        function b() {
            var c;
            for (n.reset(); c = g.pop();)c.removeListener();
            var b = k;
            c = a.sender;
        ...
        var c = this.repository.finder, d = this.repository.locator, e = this.repository.liner, f = this.editor, h = f.editable(), g = [], k = [];
        this.repository._.draggedWidget = this;
        var m = c.greedySearch(), n = CKEDITOR.tools.eventsBuffer(50, function () {
            p = d.locate(m);
            k = d.sort(q, 1);
    ...
    CKEDITOR.plugins.add("widget", {
        lang: "af,ar,bg,ca,cs,cy,da,de,el,en,en-gb,eo,es,eu,fa,fi,fr,gl,he,hr,hu,id,it,ja,km,ko,ku,lv,nb,nl,no,pl,pt,pt-br,ru,sk,sl,sq,sv,tr,tt,ug,uk,vi,zh,zh-cn",
    ...
    p.prototype = {
        MIN_SELECTION_CHECK_INTERVAL: 500, add: function (a, b) {
            ...
            var a = this.editor.getSelection(), b = a.getSelectedElement(), c = z(this), d;
    ...
    var U = /^(?:<(?:div|span)(?: data-cke-temp="1")?(?: id="cke_copybin")?(?: data-cke-temp="1")?>)?(?:<(?:div|span)(?: style="[^"]+")?>)?<span [^>]*data-cke-copybin-start="1"[^>]*>.?<\/span>([\s\S]+)<span [^>]*data-cke-copybin-end="1"[^>]*>.?<\/span>(?:<\/(?:div|span)>)?(?:<\/(?:div|span)>)?$/i,
        ca = {37: 1, 38: 1, 39: 1, 40: 1, 8: 1, 46: 1};
    (function () {
        function a() {
        }
