...
(function () {
    ...
    var l = {
        _attachScript: function (e, c) {
            ...
            function b() {
                g &&
                (g.remove(), delete CKEDITOR._.jsonpCallbacks[h], g = null)
            }

            var k = {};
            c = c || {};
            var h = CKEDITOR.tools.getNextNumber(), g;
        ...
        createWidgetBaseDefinition: function (e) {
            ...
            return {
                ...
                loadContent: function (a, b) {
                    function c(e) {
                        f.response = e;
                        d.editor.widgets.instances[d.id] ? d._handleResponse(f) && (d._cacheResponse(a, e), b.callback && b.callback()) :
                            (CKEDITOR.warn("embedbase-widget-invalid"), f.task && f.task.done())
                    }

                    b = b || {};
                    var d = this, e = this._getCachedResponse(a), f = {
                ...
                _sendRequest: function (a) {
                    var b = this, c = l.sendRequest(this.providerUrl, {url: encodeURIComponent(a.url)}, a.callback, function () {
                ...
                _handleResponse: function (a) {
                    ...
                    if (!1 !== this.fire("handleResponse", b))return a.task && a.task.done(), this._setContent(a.url, b.html), !0;
                ...
                _responseToHtml: function (a, b) {
                    return "photo" == b.type ? '\x3cimg src\x3d"' + CKEDITOR.tools.htmlEncodeAttr(b.url) + '" alt\x3d"' + CKEDITOR.tools.htmlEncodeAttr(b.title || "") + '" style\x3d"max-width:100%;height:auto" /\x3e' : "video" == b.type || "rich" == b.type ? b.html : null
                },
                ...
                _createTask: function () {
                    if (!c || c.isFinished())c =
                        new CKEDITOR.plugins.notificationAggregator(e, d.fetchingMany, d.fetchingOne), c.on("finished", function () {
                        c.notification.hide()
                    });
                    return c.createTask()
                },
