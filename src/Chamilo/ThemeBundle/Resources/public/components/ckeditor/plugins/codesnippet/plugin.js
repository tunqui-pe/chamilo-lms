...
(function () {
    ...
    function p(a) {
        ...
        a.widgets.add("codeSnippet", {
            ...
            highlight: function () {
                var d = this, c = this.data, b = function (a) {
    ...
    CKEDITOR.plugins.add("codesnippet", {
        ...
        lang: "ar,bg,ca,cs,da,de,el,en,en-gb,eo,es,et,eu,fa,fi,fr,fr-ca,gl,he,hr,hu,id,it,ja,km,ko,ku,lt,lv,nb,nl,no,pl,pt,pt-br,ro,ru,sk,sl,sq,sv,th,tr,tt,ug,uk,vi,zh,zh-cn",
        icons: "codesnippet",
        hidpi: !0,
        beforeInit: function (a) {
            ...
            this.setHighlighter = function (b) {
                ...
                a._.codesnippet.langsRegex = new RegExp("(?:^|\\s)language-(" + CKEDITOR.tools.objectKeys(b).join("|") + ")(?:\\s|$)")
            }
        },
        onLoad: function () {
