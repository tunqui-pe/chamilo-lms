...
CKEDITOR.dialog.add("colordialog", function (x) {
    function q() {
        d.getById(r).removeStyle("background-color");
        t.getContentElement("picker", "selectedColor").setValue("");
    ...
    function y(a) {
        a = a.data.getTarget();
        var c;
        "td" == a.getName() && (c = a.getChild(0).getHtml()) && (l = a, l.setAttribute("aria-selected", !0), t.getContentElement("picker", "selectedColor").setValue(c))
    }
    ...
    function C(a) {
        ...
        return "#" +
            (165 <= .2126 * b[0] + .7152 * b[1] + .0722 * b[2] ? "000" : "fff")
    }

    function z(a) {
        !a.name && (a = new CKEDITOR.event(a));
        var c = !/mouse/.test(a.name), b = a.data.getTarget(), g;
        "td" == b.getName() && (g = b.getChild(0).getHtml()) && (u(a), c ? e = b : A = b, c && (b.setStyle("border-color", C(g)), b.setStyle("border-style", "dotted")), d.getById(m).setStyle("background-color", g), d.getById(n).setHtml(g))
    }
    ...
    function u(a) {
        ...
        e || A ||
        (d.getById(m).removeStyle("background-color"), d.getById(n).setHtml("\x26nbsp;"))
    }

    function D(a) {
        var c = a.data, b = c.getTarget(), g = c.getKeystroke(), d = "rtl" == x.lang.dir;
        switch (g) {
            case 38:
            ...
            case 13:
                ...
                break;
            case d ? 37 : 39:
                (a = b.getNext()) ? 1 == a.type && (a.focus(), c.preventDefault(!0)) :
    ...
    var v = CKEDITOR.dom.element, d = CKEDITOR.document, f = x.lang.colordialog, t, B = {
        type: "html",
        html: "\x26nbsp;"
    }, l, e, A, p = function (a) {
        return CKEDITOR.tools.getNextId() + "_" + a
    }, m = p("hicolor"), n = p("hicolortext"), r = p("selhicolor"), h;
    (function () {
        function a(a, d) {
            for (var w =
                a; w < a + 3; w++) {
        ...
        h = CKEDITOR.dom.element.createFromHtml('\x3ctable tabIndex\x3d"-1" aria-label\x3d"' + f.options + '" role\x3d"grid" style\x3d"border-collapse:separate;" cellspacing\x3d"0"\x3e\x3ccaption class\x3d"cke_voice_label"\x3e' + f.options + '\x3c/caption\x3e\x3ctbody role\x3d"presentation"\x3e\x3c/tbody\x3e\x3c/table\x3e');
        h.on("mouseover", z);
        h.on("mouseout", u);
    ...
    return {
        title: f.title, minWidth: 360, minHeight: 220, onLoad: function () {
            ...
            d.getById(m).removeStyle("background-color");
            d.getById(n).setHtml("\x26nbsp;");
            e = null
        }, contents: [{
            id: "picker", label: f.title, accessKey: "I", elements: [{
                ...
                children: [{
                    ...
                    children: [{
                        type: "html",
                        html: "\x3cspan\x3e" + f.highlight + '\x3c/span\x3e\x3cdiv id\x3d"' + m + '" style\x3d"border: 1px solid; height: 74px; width: 74px;"\x3e\x3c/div\x3e\x3cdiv id\x3d"' +
                        n + '"\x3e\x26nbsp;\x3c/div\x3e\x3cspan\x3e' + f.selected + '\x3c/span\x3e\x3cdiv id\x3d"' + r + '" style\x3d"border: 1px solid; height: 20px; width: 74px;"\x3e\x3c/div\x3e'
                    }, {
                        type: "text",
                        label: f.selected,
                        ...
                        onChange: function () {
                            try {
                                d.getById(r).setStyle("background-color", this.getValue())
                            } catch (a) {
                                q()
                            }
                        }
