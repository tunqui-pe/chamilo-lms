...
CKEDITOR.plugins.add("devtools", {
    lang: "ar,bg,ca,cs,cy,da,de,el,en,en-gb,eo,es,et,eu,fa,fi,fr,fr-ca,gl,gu,he,hr,hu,id,it,ja,km,ko,ku,lt,lv,nb,nl,no,pl,pt,pt-br,ru,si,sk,sl,sq,sv,tr,tt,ug,uk,vi,zh,zh-cn",
    init: function (i) {
...
(function () {
    function i(a, c, b, f) {
        var a = a.lang.devtools, j = '<a href="http://docs.ckeditor.com/#!/api/CKEDITOR.dialog.definition.' + (b ? "text" == b.type ? "textInput" : b.type : "content") + '" target="_blank">' + (b ? b.type : "content") + "</a>", c = "<h2>" + a.title + "</h2><ul><li><strong>" + a.dialogName + "</strong> : " + c.getName() + "</li><li><strong>" + a.tabName + "</strong> : " + f + "</li>";
