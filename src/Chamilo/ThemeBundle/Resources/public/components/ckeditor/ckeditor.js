...
(function () {
    window.CKEDITOR && window.CKEDITOR.dom || (window.CKEDITOR || (window.CKEDITOR = function () {
        ...
        CKEDITOR.event.prototype = function () {
            ...
            b.prototype = {
                getListenerIndex: function (a) {
                    for (var b = 0, m = this.listeners; b < m.length; b++)if (m[b].fn == a)return b;
                    return -1
                }
            };
            return {
                define: function (b, d) {
                    var m = a.call(this, b);
                    CKEDITOR.tools.extend(m, d, !0)
                }, on: function (b, d, m, e, f) {
                    function h(a, g, f, h) {
                        a = {
                            name: b,
                            sender: this,
                    ...
                    if (0 > g.getListenerIndex(d)) {
                        ...
                        h.fn = d;
                        h.priority = f;
                        for (var u = g.length - 1; 0 <= u; u--)if (g[u].priority <= f)return g.splice(u + 1, 0, h), {removeListener: k};
                        g.unshift(h)
                    }
                    ...
                    return function (f, h, k) {
                        ...
                        if (g) {
                            var u = g.listeners;
                            if (u.length)for (var u = u.slice(0), q, v = 0; v < u.length; v++) {
                                if (g.errorProof)try {
                                    q = u[v].call(this, k, h, b, l)
                                } catch (r) {
                                } else q = u[v].call(this, k, h, b, l);
        ...
        var a = [], e = CKEDITOR.env.gecko ? "-moz-" :
            CKEDITOR.env.webkit ? "-webkit-" : CKEDITOR.env.ie ? "-ms-" : "", b = /&/g, c = />/g, d = /</g, m = /"/g, l = /&(lt|gt|amp|quot|nbsp|shy|#\d{1,5});/g, f = {
            lt: "\x3c",
            gt: "\x3e",
            amp: "\x26",
            quot: '"',
        ...
        CKEDITOR.tools = {
            ...
            transformPlainTextToHtml: function (a, g) {
                ...
                if (!b) {
                    var c = /\n{2}/g;
                    if (c.test(f))var d = "\x3c" + h + "\x3e", m = "\x3c/" + h + "\x3e", f = d + f.replace(c, function () {
                            return m + d
                        }) + m
                }
                f = f.replace(/\n/g, "\x3cbr\x3e");
            ...
            enableHtml5Elements: function (a, g) {
                for (var b = "abbr article aside audio bdi canvas data datalist details figcaption figure footer header hgroup main mark meter nav output progress section summary time video".split(" "), f = b.length, h; f--;)h = a.createElement(b[f]),
                g && a.appendChild(h)
            },
        ...
        var a = CKEDITOR.tools.extend, e = function (a, g) {
            ...
            b = {}, c = {}, d = {
                ...
                script: 1,
                style: 1
            }, l = {}, f = {"#": 1}, h = {center: 1, dir: 1, noframes: 1};
        a(b, {
            a: 1,
            abbr: 1,
            area: 1,
        ...
        appendTo: function (a, e) {
            ...
            function e(a, b) {
                var f = b ? a.nextSibling : a.previousSibling;
                return f && f.nodeType == CKEDITOR.NODE_TEXT ? f.nodeValue ? f : e(f, b) : null
            }

            var b = this.$, c = -1, d;
            if (!this.$.parentNode || a && b.nodeType ==
                CKEDITOR.NODE_TEXT && !b.nodeValue && !e(b) && !e(b, !0))return -1;
            do if (!a || b == this.$ || b.nodeType != CKEDITOR.NODE_TEXT || !d && b.nodeValue)c++, d = b.nodeType == CKEDITOR.NODE_TEXT; while (b = b.previousSibling);
            return c
        ...
        return (a = "string" == typeof a ? document.getElementById(a) || document.getElementsByName(a)[0] :
        ...
        var d = e.getCustomData("list_marker_id") || e.setCustomData("list_marker_id", CKEDITOR.tools.getNextNumber()).getCustomData("list_marker_id"), m = e.getCustomData("list_marker_names") || e.setCustomData("list_marker_names", {}).getCustomData("list_marker_names");
        a[d] = e;
        m[b] = 1;
        ...
        function c(a) {
            for (var b = 0, k = 0, g = l[a].length; k < g; k++)b += parseInt(this.getComputedStyle(l[a][k]) || 0, 10) || 0;
            return b
        }
        ...
        CKEDITOR.tools.extend(CKEDITOR.dom.element.prototype, {
            ...
            breakParent: function (a, b) {
                var k = new CKEDITOR.dom.range(this.getDocument());
                k.setStartAfter(this);
                k.setEndAfter(a);
                var g = k.extractContents(!1, b || !1);
                k.insertNode(this.remove());
            ...
            setHtml: CKEDITOR.env.ie && 9 > CKEDITOR.env.version ? function (a) {
                try {
                    ...
                    var k = this.getDocument()._getHtml5ShivFrag();
                    k.appendChild(b);
                    b.innerHTML = a;
                    k.removeChild(b);
                    return a
            ...
            isIdentical: function (a) {
                ...
                if (CKEDITOR.env.ie && 9 > CKEDITOR.env.version && this.is("a")) {
                    ...
                    k.type == CKEDITOR.NODE_ELEMENT && (k = k.clone(), k.setHtml(b), b = k.getHtml(), k.setHtml(a), a = k.getHtml())
                }
                return b ==
                    a
            },
            isVisible: function () {
                var a = (this.$.offsetHeight || this.$.offsetWidth) && "hidden" != this.getComputedStyle("visibility"), b, k;
                a && CKEDITOR.env.webkit && (b = this.getWindow(), !b.equals(CKEDITOR.document.getWindow()) && (k = b.$.frameElement) && (a = (new CKEDITOR.dom.element(k)).isVisible()));
                return !!a
            },
            isEmptyInlineRemoveable: function () {
                if (!CKEDITOR.dtd.$removeEmpty[this.getName()])return !1;
                for (var a = this.getChildren(), b = 0, k = a.count(); b < k; b++) {
                    var g = a.getItem(b);
                    if (g.type != CKEDITOR.NODE_ELEMENT || !g.data("cke-bookmark"))if (g.type ==
                        CKEDITOR.NODE_ELEMENT && !g.isEmptyInlineRemoveable() || g.type == CKEDITOR.NODE_TEXT && CKEDITOR.tools.trim(g.getText()))return !1
                }
                return !0
            },
                ...
                for (var a = this.$.attributes, b = 0; b < a.length; b++) {
                    ...
                    switch (k.nodeName) {
                        ...
                        case "data-cke-expando":
                            continue;
                        default:
                            if (k.specified)return !0
                    }
                }
                return !1
            } : function () {
                var a = this.$.attributes, b = a.length, k = {
                    "data-cke-expando": 1,
                    _moz_dirty: 1
                };
                return 0 < b && (2 < b || !k[a[0].nodeName] || 2 == b && !k[a[1].nodeName])
            },
            ...
            moveChildren: function (a, b) {
                ...
                if (k != a) {
                    var g;
                    if (b)for (; g = k.lastChild;)a.insertBefore(k.removeChild(g), a.firstChild); else for (; g = k.firstChild;)a.appendChild(k.removeChild(g))
                }
            },
            mergeSiblings: function () {
                function a(b, f, g) {
                    if (f && f.type == CKEDITOR.NODE_ELEMENT) {
                        for (var c = []; f.data("cke-bookmark") || f.isEmptyInlineRemoveable();)if (c.push(f), f = g ? f.getNext() : f.getPrevious(), !f || f.type != CKEDITOR.NODE_ELEMENT)return;
                        if (b.isIdentical(f)) {
                            for (var d =
                                g ? b.getLast() : b.getFirst(); c.length;)c.shift().move(b, !g);
                            f.moveChildren(b, !g);
                            f.remove();
            ...
            unselectable: function () {
                ...
                if (CKEDITOR.env.ie) {
                    ...
                    for (var a,
                             b = this.getElementsByTag("*"), c = 0, g = b.count(); c < g; c++)a = b.getItem(c), a.setAttribute("unselectable", "on")
                }
            },
            ...
            getDocumentPosition: function (a) {
                ...
                if (document.documentElement.getBoundingClientRect) {
                    var m = this.$.getBoundingClientRect(), l = g.$.documentElement, r = l.clientTop || d.$.clientTop ||
                        0, p = l.clientLeft || d.$.clientLeft || 0, w = !0;
                    CKEDITOR.env.ie && (w = g.getDocumentElement().contains(this), g = g.getBody().contains(this), w = e && g || !e && w);
                    w && (CKEDITOR.env.webkit || CKEDITOR.env.ie && 12 <= CKEDITOR.env.version ? (b = d.$.scrollLeft || l.scrollLeft, c = d.$.scrollTop || l.scrollTop) : (c = e ? d.$ : l, b = c.scrollLeft, c = c.scrollTop), b = m.left + b - p, c = m.top + c - r)
                } else for (r = this, p = null; r && "body" != r.getName() && "html" != r.getName();) {
                    b += r.$.offsetLeft - r.$.scrollLeft;
                    c += r.$.offsetTop - r.$.scrollTop;
                    r.equals(this) || (b += r.$.clientLeft ||
                        0, c += r.$.clientTop || 0);
                    for (; p && !p.equals(r);)b -= p.$.scrollLeft, c -= p.$.scrollTop, p = p.getParent();
                    p = r;
                    r = (m = r.$.offsetParent) ? new CKEDITOR.dom.element(m) : null
                }
                a && (m = this.getWindow(), r = a.getWindow(), !m.equals(r) && m.$.frameElement && (a = (new CKEDITOR.dom.element(m.$.frameElement)).getDocumentPosition(a), b += a.x, c += a.y));
            ...
            scrollIntoParent: function (a, b, c) {
                ...
                function r(a, b) {
                    ...
                    c = a.getWindow();
                    c.equals(b) || (c = r(CKEDITOR.dom.element.get(c.$.frameElement), b), g.x += c.x, g.y += c.y);
                    return g
                }
                ...
                e = a.getWindow();
                d = r(this, e);
                var x = r(a, e), B = this.$.offsetHeight;
                g = this.$.offsetWidth;
                var t = a.$.clientHeight,
                    z = a.$.clientWidth;
                e = d.x - p(this, "left") - x.x || 0;
                m = d.y - p(this, "top") - x.y || 0;
                g = d.x + g + p(this, "right") - (x.x + z) || 0;
                d = d.y + B + p(this, "bottom") - (x.y + t) || 0;
        ...
        function a(a, b) {
            ...
            c = g.endContainer;
            var f = g.startOffset, k = g.endOffset, h, e = this.guard, m = this.type, n = a ? "getPreviousSourceNode" : "getNextSourceNode";
            if (!a && !this._.guardLTR) {
                var l = c.type == CKEDITOR.NODE_ELEMENT ? c : c.getParent(), A = c.type == CKEDITOR.NODE_ELEMENT ? c.getChild(k) : c.getNext();
                this._.guardLTR = function (a, b) {
                    return (!b || !l.equals(a)) && (!A || !a.equals(A)) && (a.type != CKEDITOR.NODE_ELEMENT || !b || !a.equals(g.root))
                }
            }
            if (a && !this._.guardRTL) {
                var C = d.type == CKEDITOR.NODE_ELEMENT ? d : d.getParent(), G = d.type == CKEDITOR.NODE_ELEMENT ?
                    f ? d.getChild(f - 1) : null : d.getPrevious();
            ...
            this.current ? c = this.current[n](!1, m, h) : (a ? c.type == CKEDITOR.NODE_ELEMENT && (c = 0 < k ? c.getChild(k - 1) : !1 === h(c, !0) ? null : c.getPreviousSourceNode(!0, m, h)) : (c = d, c.type == CKEDITOR.NODE_ELEMENT && ((c = c.getChild(f)) || (c = !1 === h(d, !0) ? null : d.getNextSourceNode(!0,
                m, h)))), c && !1 === h(c) && (c = null));
            for (; c && !this._.end;) {
                this.current = c;
        ...
        CKEDITOR.dom.element.prototype.isBlockBoundary = function (a) {
            return "none" !=
            this.getComputedStyle("float") || this.getComputedStyle("position") in c || !b[this.getComputedStyle("display")] ? !!(this.is(CKEDITOR.dtd.$block) || a && this.is(a)) : !0
        };
        ...
        CKEDITOR.dom.walker.whitespaces = function (a) {
            return function (b) {
                var g;
                b && b.type == CKEDITOR.NODE_TEXT && (g = !CKEDITOR.tools.trim(b.getText()) || CKEDITOR.env.webkit && "​" == b.getText());
                return !!(a ^ g)
            }
        };
        ...
        var d = /^[\t\r\n ]*(?:&nbsp;|\xa0)$/, m = CKEDITOR.dom.walker.whitespaces(), l = CKEDITOR.dom.walker.bookmark(), f = CKEDITOR.dom.walker.temp(), h = function (a) {
        ...
        CKEDITOR.dom.walker.empty = function (a) {
            return function (b) {
                for (var g =
                    0, c = b.getChildCount(); g < c; ++g)if (!k(b.getChild(g)))return !!a;
                return !a
            }
        };
        ...
        CKEDITOR.dom.walker.editable = function (a) {
            return function (b) {
                b = k(b) ? !1 : b.type == CKEDITOR.NODE_TEXT || b.type == CKEDITOR.NODE_ELEMENT && (b.is(CKEDITOR.dtd.$inline) || b.is("hr") || "false" == b.getAttribute("contenteditable") ||
                !CKEDITOR.env.needsBrFiller && b.is(n) && g(b)) ? !0 : !1;
                return !!(a ^ b)
            }
        };
        ...
        function e(a, b, c, d, f) {
            function k(a, b, g, c) {
                ...
                if (c && m)return d;
                t || c ? b.append(a.clone(!0, f), g) : (a.remove(), l && b.append(a));
                return d
            }
            ...
            a.optimizeBookmark();
            var m = 0 === b, l = 1 == b, t = 2 == b;
            b = t || l;
            var z = a.startContainer, E = a.endContainer, y = a.startOffset, A = a.endOffset,
                C, G, F, I, H, K;
            if (t && E.type == CKEDITOR.NODE_TEXT && z.equals(E))z = a.document.createText(z.substring(y, A)), c.append(z); else {
                E.type == CKEDITOR.NODE_TEXT ? t ? K = !0 : E = E.split(A) : 0 < E.getChildCount() ? A >= E.getChildCount() ? (E = E.getChild(A - 1), G = !0) : E = E.getChild(A) : I = G = !0;
                z.type == CKEDITOR.NODE_TEXT ? t ? H = !0 : z.split(y) : 0 < z.getChildCount() ? 0 === y ? (z = z.getChild(y), C = !0) : z = z.getChild(y - 1) : F = C = !0;
                for (var D = z.getParents(), N = E.getParents(), R = h(), P = D.length - 1, T = N.length - 1, O = c, Y, M, W, U = -1, J = R; J <= P; J++) {
                    M = D[J];
                    W = M.getNext();
                    for (J !=
                         P || M.equals(N[J]) && P < T ? b && (Y = O.append(M.clone(0, f))) : C ? k(M, O, !1, F) : H && O.append(a.document.createText(M.substring(y))); W;) {
                        if (W.equals(N[J])) {
                            U = J;
                            break
                        }
        ...
        var m = {
            ...
            u: 1,
            "var": 1
        }, l = CKEDITOR.dom.walker.bogus(), f = /^[\t\r\n ]*(?:&nbsp;|\xa0)$/, h = CKEDITOR.dom.walker.editable(), k = CKEDITOR.dom.walker.ignored(!0);
        CKEDITOR.dom.range.prototype = {
            ...
            createBookmark: function (a) {
                ...
                k || (c = b.clone(), c.setHtml("\x26nbsp;"), a && c.setAttribute("id", d + "E"), f = this.clone(), f.collapse(),
                    f.insertNode(c));
                f = this.clone();
                f.collapse(!0);
                f.insertNode(b);
            ...
            createBookmark2: function () {
                function a(g) {
                    var c = g.container, d = g.offset, f;
                    f = c;
                    var k = d;
                    ...
                    f && (c = c.getChild(d - 1), d = c.getLength());
                    c.type == CKEDITOR.NODE_ELEMENT && 1 < d && (d = c.getChild(d - 1).getIndex(!0) + 1);
                    if (c.type == CKEDITOR.NODE_TEXT) {
                        f = c;
                        for (k = 0; (f = f.getPrevious()) && f.type == CKEDITOR.NODE_TEXT;)k += f.getLength();
                        f = k;
                        c.getText() ? d += f : (k = c.getPrevious(b), f ? (d = f, c = k ? k.getNext() : c.getParent().getFirst()) : (c = c.getParent(), d = k ? k.getIndex(!0) + 1 : 0))
                    }
                    g.container = c;
                    g.offset = d
                }
            ...
            enlarge: function (a, b) {
                ...
                switch (a) {
                    ...
                    case CKEDITOR.ENLARGE_ELEMENT:
                        var k = function (a, b) {
                            var g = new CKEDITOR.dom.range(e);
                            g.setStart(a, b);
                            g.setEndAt(e, CKEDITOR.POSITION_BEFORE_END);
                            var g = new CKEDITOR.dom.walker(g),
                                c;
                            for (g.guard = function (a) {
                                return !(a.type == CKEDITOR.NODE_ELEMENT && a.isBlockBoundary())
                            }; c = g.next();) {
                                if (c.type != CKEDITOR.NODE_TEXT)return !1;
                                C = c != a ? c.getText() : c.substring(b);
                                if (d.test(C))return !1
                            }
                            return !0
                        };
                        if (this.collapsed)break;
                        var h = this.getCommonAncestor(), e = this.root, m, l, t, z, E, y = !1, A, C;
                        A = this.startContainer;
                        var G = this.startOffset;
                        A.type == CKEDITOR.NODE_TEXT ? (G && (A = !CKEDITOR.tools.trim(A.substring(0, G)).length && A, y = !!A), A && ((z = A.getPrevious()) || (t = A.getParent()))) : (G && (z = A.getChild(G - 1) || A.getLast()),
                        z || (t = A));
                        for (t = c(t); t || z;) {
                            if (t && !z) {
                                !E && t.equals(h) && (E = !0);
                                if (f ? t.isBlockBoundary() : !e.contains(t))break;
                                y && "inline" == t.getComputedStyle("display") || (y = !1, E ? m = t : this.setStartBefore(t));
                                z = t.getPrevious()
                            }
                            for (; z;)if (A = !1, z.type == CKEDITOR.NODE_COMMENT)z = z.getPrevious(); else {
                                if (z.type == CKEDITOR.NODE_TEXT)C = z.getText(), d.test(C) && (z = null), A = /[\s\ufeff]$/.test(C); else if ((z.$.offsetWidth > (CKEDITOR.env.webkit ? 1 : 0) || b && z.is("br")) && !z.data("cke-bookmark"))if (y && CKEDITOR.dtd.$removeEmpty[z.getName()]) {
                                    C =
                                        z.getText();
                                    if (d.test(C))z = null; else for (var G = z.$.getElementsByTagName("*"), F = 0, I; I = G[F++];)if (!CKEDITOR.dtd.$removeEmpty[I.nodeName.toLowerCase()]) {
                                        z = null;
                                        break
                                    }
                                    z && (A = !!C.length)
                                } else z = null;
                                A && (y ? E ? m = t : t && this.setStartBefore(t) : y = !0);
                                if (z) {
                                    A = z.getPrevious();
                                    if (!t && !A) {
                                        t = z;
                        ...
                        t = z = null;
                        E = y = !1;
                        A.type == CKEDITOR.NODE_TEXT ? CKEDITOR.tools.trim(A.substring(G)).length ? y = !0 : (y = !A.getLength(), G == A.getLength() ? (z = A.getNext()) ||
                        (t = A.getParent()) : k(A, G) && (t = A.getParent())) : (z = A.getChild(G)) || (t = A);
                        for (; t || z;) {
                            if (t && !z) {
                                !E && t.equals(h) && (E = !0);
                                if (f ? t.isBlockBoundary() : !e.contains(t))break;
                                y && "inline" == t.getComputedStyle("display") || (y = !1, E ? l = t : t && this.setEndAfter(t));
                                z = t.getNext()
                            }
                            for (; z;) {
                                A = !1;
                                if (z.type == CKEDITOR.NODE_TEXT)C = z.getText(), k(z, 0) || (z = null), A = /^[\s\ufeff]/.test(C); else if (z.type == CKEDITOR.NODE_ELEMENT) {
                                    if ((0 < z.$.offsetWidth || b && z.is("br")) && !z.data("cke-bookmark"))if (y && CKEDITOR.dtd.$removeEmpty[z.getName()]) {
                                        C =
                                            z.getText();
                                        if (d.test(C))z = null; else for (G = z.$.getElementsByTagName("*"), F = 0; I = G[F++];)if (!CKEDITOR.dtd.$removeEmpty[I.nodeName.toLowerCase()]) {
                                            z = null;
                                            break
                                        }
                                        z && (A = !!C.length)
                    ...
                    case CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS:
                        ...
                        e = this.root;
                        t.setStartAt(e, CKEDITOR.POSITION_AFTER_START);
                        t.setEnd(this.startContainer, this.startOffset);
                        t = new CKEDITOR.dom.walker(t);
                        var H, K, D = CKEDITOR.dom.walker.blockBoundary(a == CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS ? {br: 1} : null), N = null, R = function (a) {
                        ...
                        t = t.lastBackward();
                        H = H || e;
                        this.setStartAt(H, !H.is("br") && (!t && this.checkStartOfBlock() || t && H.contains(t)) ? CKEDITOR.POSITION_AFTER_START : CKEDITOR.POSITION_AFTER_END);
                        ...
                        t = this.clone();
                        t.collapse();
                        t.setEndAt(e, CKEDITOR.POSITION_BEFORE_END);
                        t = new CKEDITOR.dom.walker(t);
                        t.guard = a == CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS ? f : R;
                        H = N = K = null;
                        t = t.lastForward();
                        H = H || e;
                        this.setEndAt(H, !t && this.checkEndOfBlock() || t && H.contains(t) ? CKEDITOR.POSITION_BEFORE_END : CKEDITOR.POSITION_BEFORE_START);
            ...
            shrink: function (a, b, c) {
                if (!this.collapsed) {
                    ...
                    var d = this.clone(), f = this.startContainer, k = this.endContainer, h = this.startOffset, e = this.endOffset, m = 1, l = 1;
                    f && f.type == CKEDITOR.NODE_TEXT && (h ? h >= f.getLength() ? d.setStartAfter(f) : (d.setStartBefore(f), m =
                        0) : d.setStartBefore(f));
                    ...
                    d.guard = function (b, d) {
                        if (t(b))return !0;
                        if (a == CKEDITOR.SHRINK_ELEMENT && b.type == CKEDITOR.NODE_TEXT || d && b.equals(z) || !1 === c && b.type == CKEDITOR.NODE_ELEMENT && b.isBlockBoundary() || b.type == CKEDITOR.NODE_ELEMENT &&
                            b.hasAttribute("contenteditable"))return !1;
                        d || b.type != CKEDITOR.NODE_ELEMENT || (z = b);
                        return !0
                    };
            ...
            splitBlock: function (a, b) {
                var c = new CKEDITOR.dom.elementPath(this.startContainer, this.root), d = new CKEDITOR.dom.elementPath(this.endContainer, this.root), f = c.block, k = d.block, h = null;
            ...
            removeEmptyBlocksAtEnd: function () {
                ...
                return function (b) {
                    for (var c = this.createBookmark(),
                             d = this[b ? "endPath" : "startPath"](), f = d.block || d.blockLimit, k; f && !f.equals(d.root) && !f.getFirst(a(f));)k = f.getParent(), this[b ? "setEndAt" : "setStartAt"](f, CKEDITOR.POSITION_AFTER_END), f.remove(1), f = k;
                    this.moveToBookmark(c)
                }
            }(),
            startPath: function () {
            ...
            moveToClosestEditablePosition: function (a, b) {
                ...
                if (a && !a.is(CKEDITOR.dtd.$block))d = 1; else if (f = c[b ? "getNextEditableNode" : "getPreviousEditableNode"]())d = 1, (k = f.type ==
                    CKEDITOR.NODE_ELEMENT) && f.is(CKEDITOR.dtd.$block) && "false" == f.getAttribute("contenteditable") ? (c.setStartAt(f, CKEDITOR.POSITION_BEFORE_START), c.setEndAt(f, CKEDITOR.POSITION_AFTER_END)) : !CKEDITOR.env.needsBrFiller && k && f.is(CKEDITOR.dom.walker.validEmptyBlockContainers) ? (c.setEnd(f, 0), c.collapse()) : c.moveToPosition(f, h[b ? 1 : 0]);
        ...
        a.prototype = {
            getNextParagraph: function (a) {
                ...
                if (!this._.started) {
                    ...
                    e = r.startPath();
                    var p = r.endPath(), w = !r.collapsed && c(r, e.block), x = !r.collapsed && c(r, p.block, 1);
                    r.shrink(CKEDITOR.SHRINK_ELEMENT, !0);
                    w && r.setStartAt(e.block, CKEDITOR.POSITION_BEFORE_END);
                    x && r.setEndAt(p.block, CKEDITOR.POSITION_AFTER_START);
                    e = r.endContainer.hasAscendant("pre", !0) || r.startContainer.hasAscendant("pre", !0);
                    r.enlarge(this.forceBrBreak && !e || !this.enlargeBr ? CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS : CKEDITOR.ENLARGE_BLOCK_CONTENTS);
                    r.collapsed || (e = new CKEDITOR.dom.walker(r.clone()), p = CKEDITOR.dom.walker.bookmark(!0, !0), e.evaluator = p, this._.nextNode = e.next(), e = new CKEDITOR.dom.walker(r.clone()), e.evaluator = p, e = e.previous(), this._.lastNode = e.getNextSourceNode(!0, null, r.root), this._.lastNode && this._.lastNode.type == CKEDITOR.NODE_TEXT && !CKEDITOR.tools.trim(this._.lastNode.getText()) && this._.lastNode.getParent().isBlockBoundary() && (p = this.range.clone(), p.moveToPosition(this._.lastNode, CKEDITOR.POSITION_AFTER_END), p.checkEndOfBlock() &&
                    (p = new CKEDITOR.dom.elementPath(p.endContainer, p.root), this._.lastNode = (p.block || p.blockLimit).getNextSourceNode(!0))), this._.lastNode && r.root.contains(this._.lastNode) || (this._.lastNode = this._.docEndMarker = r.document.createText(""), this._.lastNode.insertAfter(e)), r = null);
                    this._.started = 1;
                    e = r
                }
                p = this._.nextNode;
                ...
                for (this._.nextNode = null; p;) {
                    var w = 0, x = p.hasAscendant("pre"), B = p.type != CKEDITOR.NODE_ELEMENT, t = 0;
                    if (B)p.type == CKEDITOR.NODE_TEXT && d.test(p.getText()) && (B = 0); else {
                        var z = p.getName();
                        if (CKEDITOR.dtd.$block[z] && "false" == p.getAttribute("contenteditable")) {
                            g = p;
                            b(this, a, g);
                            break
                        } else if (p.isBlockBoundary(this.forceBrBreak && !x && {br: 1})) {
                            if ("br" == z)B = 1; else if (!e && !p.getChildCount() && "hr" != z) {
                                g = p;
                                l = p.equals(r);
                                break
                            }
                            e && (e.setEndAt(p, CKEDITOR.POSITION_BEFORE_START), "br" != z && (this._.nextNode = p));
                            w = 1
                        } else {
                            if (p.getFirst()) {
                    ...
                    if (e && !w)for (; !p.getNext(f) && !l;) {
                        z = p.getParent();
                        if (z.isBlockBoundary(this.forceBrBreak && !x && {br: 1})) {
                            w = 1;
                            B = 0;
                            l || z.equals(r);
                    ...
                    p = this._getNextSourceNode(p, t, r);
                    if ((l = !p) || w && e)break
                }
                if (!g) {
                    ...
                    w = {div: 1, th: 1, td: 1};
                    g = g.block;
                    !g && p && !this.enforceRealBlocks && w[p.getName()] && e.checkStartOfBlock() && e.checkEndOfBlock() && !p.equals(e.root) ? g = p : !g || this.enforceRealBlocks && g.is(h) ? (g = this.range.document.createElement(a), e.extractContents().appendTo(g), g.trim(), e.insertNode(g), q = v = !0) : "li" != g.getName() ? e.checkStartOfBlock() && e.checkEndOfBlock() || (g = g.clone(!1), e.extractContents().appendTo(g), g.trim(), v = e.splitBlock(), q = !v.wasStartOfBlock, v = !v.wasEndOfBlock, e.insertNode(g)) : l || (this._.nextNode = g.equals(r) ? null : this._getNextSourceNode(e.getBoundaryNodes().endNode,
                        1, r))
                }
                q && (q = g.getPrevious()) && q.type == CKEDITOR.NODE_ELEMENT && ("br" == q.getName() ? q.remove() : q.getLast() && "br" == q.getLast().$.nodeName.toLowerCase() && q.getLast().remove());
                v && (q = g.getLast()) && q.type == CKEDITOR.NODE_ELEMENT && "br" == q.getName() && (!CKEDITOR.env.needsBrFiller || q.getPrevious(m) || q.getNext(m)) && q.remove();
                this._.nextNode || (this._.nextNode = l || g.equals(r) || !r ? null : this._getNextSourceNode(g, 1, r));
                return g
    ...
    }, CKEDITOR.command.prototype =
    {
        ...
        function a(a, b, c, d, g) {
            ...
            for (f in b) {
                k = b[f];
                k = "boolean" == typeof k ? {} : "function" == typeof k ? {match: k} : F(k);
                "$" != f.charAt(0) && (k.elements = f);
                c && (k.featureName = c.toLowerCase());
                var e = k;
                e.elements = l(e.elements, /\s+/) || null;
                e.propertiesOnly = e.propertiesOnly || !0 === e.elements;
                var h = /\s*,\s*/, m = void 0;
                for (m in K) {
                    e[m] = l(e[m],
                            h) || null;
                    var t = e, z = D[m], r = l(e[D[m]], h), B = e[m], p = [], E = !0, n = void 0;
                    r ? E = !1 : r = {};
                    for (n in B)"!" == n.charAt(0) && (n = n.slice(1), p.push(n), r[n] = !0, E = !1);
            ...
            for (d = a.length; c < d; ++c) {
                f = F(a[c]);
                k = !0 === f.classes || !0 === f.styles || !0 === f.attributes;
                e = f;
                m = z = h = void 0;
                for (h in K)e[h] = w(e[h]);
                t = !0;
                for (m in D) {
                    h = D[m];
                    z = e[h];
                    r = [];
                    B = void 0;
                    for (B in z)-1 < B.indexOf("*") ? r.push(new RegExp("^" +
                        B.replace(/\*/g, ".*") + "$")) : r.push(B);
                    z = r;
                    z.length && (e[h] = z, t = !1)
                }
                e.nothingRequired = t;
                e.noProperties = !(e.attributes || e.classes || e.styles);
                if (!0 === f.elements || null === f.elements)g[k ? "unshift" : "push"](f); else for (v in e = f.elements, delete f.elements, e)if (b[v])b[v][k ? "unshift" : "push"](f); else b[v] = [f]
            }
        }
        ...
        function e(a, c, d, g) {
            if (!a.match || a.match(c))if (g || f(a, c))if (a.propertiesOnly || (d.valid = !0), d.allAttributes || (d.allAttributes = b(a.attributes, c.attributes, d.validAttributes)), d.allStyles || (d.allStyles = b(a.styles,
                ...
                if (a)if (!0 === a)a = !0; else {
                    for (var k = 0, e = c.length, h; k < e; ++k)h = c[k], g[h] || (g[h] = a(h));
                    a = !1
                } else a = !1;
                d.allClasses = a
            }
        ...
        function c(a, b, c) {
            if (!a.match || a.match(b)) {
                ...
                b = b.classes;
                if (a) {
                    for (var f = !1, g = !0 === a, k = b.length; k--;)if (g || a(b[k]))b.splice(k, 1), f = !0;
                    a = f
                } else a = !1;
        ...
        function f(a, b) {
            ...
            var c, d, f, g;
            if (f = a.requiredClasses)for (g = b.classes, c = 0; c < f.length; ++c)if (d = f[c], "string" == typeof d) {
        ...
        function g(a) {
            var b, c, d, f, g = {}, k = 1;
            for (a = I(a); b = a.match(N);)(c = b[2]) ? (d = n(c, "styles"), f = n(c, "attrs"), c = n(c, "classes")) : d = f = c = null, g["$" + k++] = {
                elements: b[1],
                classes: c,
                styles: d,
                attributes: f
        ...
        function q(a, b, d, f) {
            ...
            if (f.doCallbacks && a.elementCallbacks) {
                a:{
                    ...
                    for (var h = 0, m = k.length, t; h < m; ++h)if (t = k[h](b)) {
                        k = t;
                        break a
                    }
                    k = void 0
            ...
            if (f.doTransform && (k = a._.transformations[b.name])) {
                u(b);
                for (h = 0; h < k.length; ++h)z(a, b, k[h]);
                r(b)
            }
            if (f.doFilter) {
                a:{
                    ...
                    if (a || k) {
                        ...
                        if (a)for (D = 0, B = a.length; D < B; ++D)e(a[D], b, l, t);
                        if (k)for (D =
                                       0, B = k.length; D < B; ++D)e(k[D], b, l, t);
                        a = l
                    } else a = null
                }
                ...
                t = b.classBackup;
                var E = b.styleBackup, v, y, A = [], l = [], x = /^data-cke-/;
                D = !1;
                delete h.style;
                delete h["class"];
                delete b.classBackup;
                delete b.styleBackup;
                if (!a.allAttributes)for (v in h)B[v] || (x.test(v) ? v == (y = v.replace(/^data-cke-saved-/, "")) || B[y] || (delete h[v], D = !0) : (delete h[v], D = !0));
                if (!a.allStyles || a.hadInvalidStyle) {
                    for (v in n)a.allStyles ||
                    w[v] ? A.push(v + ":" + n[v]) : D = !0;
                    A.length && (h.style = A.sort().join("; "))
                } else E && (h.style = E);
                if (!a.allClasses || a.hadInvalidClass) {
                    for (v = 0; v < m.length; ++v)(a.allClasses || k[m[v]]) && l.push(m[v]);
                    l.length && (h["class"] = l.sort().join(" "));
                    t && l.length < t.split(/\s+/).length && (D = !0)
                } else t && (h["class"] = t);
                D && (g = 1);
        ...
        function t(a, b, c) {
            var d = a.name;
            if (G.$empty[d] || !a.children.length)"hr" == d && "br" == b ? a.replaceWith(x()) : (a.parent && c.push({
                check: "it",
                el: a.parent
            }), a.remove()); else if (G.$block[d] || "tr" == d)if ("br" == b)a.previous && !B(a.previous) && (b = x(), b.insertBefore(a)), a.next && !B(a.next) && (b = x(), b.insertAfter(a)), a.replaceWithChildren(); else {
                var d = a.children, f;
                b:{
                    f = G[b];
                    for (var g = 0, k = d.length, e; g < k; ++g)if (e = d[g], e.type == CKEDITOR.NODE_ELEMENT && !f[e.name]) {
                        f = !1;
                        break b
                    }
                    f = !0
                ...
                if (f)a.name = b, a.attributes = {}, c.push({
                    ...
                    f = a.parent;
                    for (var g = f.type == CKEDITOR.NODE_DOCUMENT_FRAGMENT || "body" == f.name, h, m, k = d.length; 0 < k;)e = d[--k], g && (e.type == CKEDITOR.NODE_TEXT || e.type == CKEDITOR.NODE_ELEMENT && G.$inline[e.name]) ? (h || (h = new CKEDITOR.htmlParser.element(b), h.insertAfter(a), c.push({
                        check: "parent-down",
                        el: h
                    })), h.add(e, 0)) : (h = null, m = G[f.name] || G.span, e.insertAfter(a), f.type == CKEDITOR.NODE_DOCUMENT_FRAGMENT || e.type != CKEDITOR.NODE_ELEMENT ||
                    m[e.name] || c.push({check: "el-up", el: e}));
                    a.remove()
                }
            } else d in {
                style: 1,
        ...
        function E(a, b) {
            var c = b.getDefinition(), d = c.attributes, f = c.styles, g, k, e, h;
            if (a.name != c.element)return !1;
            for (g in d)if ("class" == g)for (c = d[g].split(/\s+/), e = a.classes.join("|"); h = c.pop();) {
                if (-1 == e.indexOf(h))return !1
            } else if (a.attributes[g] !=
                d[g])return !1;
            for (k in f)if (a.styles[k] != f[k])return !1;
            return !0
        }
        ...
        CKEDITOR.filter.prototype = {
            allow: function (b, c, d) {
                ...
                if ("string" == typeof b)b = g(b); else if (b instanceof CKEDITOR.style) {
                    ...
                    for (f = 0; f < b.length; ++f)k = this.allow(b[f], c, d);
                    return k
                }
                ...
                var f = this, g = [], k = this.editor && this.editor.config.protectedSource, e, h = !1, m = {
                    doFilter: !c,
                    doTransform: !0,
                    doCallbacks: !0,
                    toHtml: b
                ...
                a.forEach(function (a) {
                    if (a.type == CKEDITOR.NODE_ELEMENT) {
                        ...
                        if (!b || "span" != a.name || !~CKEDITOR.tools.objectKeys(a.attributes).join("|").indexOf("data-cke-"))if (e = q(f, a, g, m), e & 1)h = !0; else if (e & 2)return !1
                        ...
                        a:{
                            ...
                            c = [];
                            var l, t, D;
                            if (k)for (t = 0; t < k.length; ++t)if ((D = d.match(k[t])) && D[0].length == d.length) {
                                c = !0;
                                break a
                            }
                            d = CKEDITOR.htmlParser.fragment.fromHtml(d);
                            1 == d.children.length && (l = d.children[0]).type == CKEDITOR.NODE_ELEMENT && q(f, l, c, m);
                            c = !c.length
                        }
                        c || g.push(a)
                    }
                ...
                for (var D; c = g.pop();)c.type == CKEDITOR.NODE_ELEMENT ? t(c, d, a) : c.remove();
                for (; l = a.pop();)if (c = l.el, c.parent)switch (D = G[c.parent.name] || G.span, l.check) {
                    case "it":
                        G.$removeEmpty[c.name] && !c.children.length ? t(c, d, a) : p(c) || t(c, d, a);
                        break;
                    case "el-up":
                        c.parent.type ==
                        CKEDITOR.NODE_DOCUMENT_FRAGMENT || D[c.name] || t(c, d, a);
                        break;
                    case "parent-down":
                        c.parent.type == CKEDITOR.NODE_DOCUMENT_FRAGMENT || D[c.name] || t(c.parent, d, a)
                }
                return h
            ...
            addContentForms: function (a) {
                if (!this.disabled && a) {
                    ...
                    if (f) {
                        for (b = 0; b < a.length; ++b)d.push(y(a[b], f));
                ...
                if (!this.disabled && a) {
                    ...
                    for (f = 0; f < a.length; ++f) {
                        b = a[f];
                        var g = void 0, k = void 0, e = void 0, h = void 0, m = void 0, l = void 0;
                        c = [];
                        for (k = 0; k < b.length; ++k)e = b[k], "string" == typeof e ? (e = e.split(/\s*:\s*/), h = e[0], m = null, l = e[1]) : (h = e.check, m = e.left, l = e.right), g || (g = e, g = g.element ? g.element : h ? h.match(/^([a-z0-9]+)/i)[0] :
                            g.left.getDefinition().element), m instanceof CKEDITOR.style && (m = A(m)), c.push({
                            check: h == g ? null : h,
                            left: m,
                            right: "string" == typeof l ? C(l) : l
                        });
                        b = g;
                        d[b] || (d[b] = []);
                        d[b].push(c)
                ...
                var h = CKEDITOR.tools.clone(f), m = [], l;
                if (!1 !== b && (l = this._.transformations[f.name])) {
                    for (d =
                             0; d < l.length; ++d)z(this, f, l[d]);
                    r(f)
                }
                q(this, h, m, {
                    doFilter: !0,
        ...
        var K = {
            ...
            }, N = /^([a-z0-9\-*\s]+)((?:\s*\{[!\w\-,\s\*]+\}\s*|\s*\[[!\w\-,\s\*]+\]\s*|\s*\([!\w\-,\s\*]+\)\s*){0,3})(?:;\s*|$)/i, R = {
                styles: /{([^}]+)}/,
                attrs: /\[([^\]]+)\]/,
                classes: /\(([^\)]+)\)/
                ...
                sizeToStyle: function (a) {
                    ...
                    if ("string" == typeof b)a.name = b; else {
                        var c = b.getDefinition(), d = c.styles,
                            f = c.attributes, g, k, e, h;
                        a.name = c.element;
                        for (g in f)if ("class" == g)for (c = a.classes.join("|"), e = f[g].split(/\s+/); h = e.pop();)-1 == c.indexOf(h) && a.classes.push(h); else a.attributes[g] = f[g];
                            ...
                            if (!(1 < d.length)) {
                                ...
                                c && (CKEDITOR.env.ie && 11 > CKEDITOR.env.version ? f.$.onreadystatechange = function () {
                                    if ("loaded" == f.$.readyState || "complete" ==
                                        f.$.readyState)f.$.onreadystatechange = null, u(b, !0)
                                } : (f.$.onload = function () {
                                    setTimeout(function () {
                                        u(b, !0)
                                    }, 0)
        ...
        return function (b, c, d) {
            var m = {}, l = function (b) {
                a.call(this, b, function (a) {
                    ...
                    var b = [], f;
                    for (f in a) {
                        var n = a[f], u = n && n.requires;
                        if (!e[f]) {
                            if (n.icons)for (var q = n.icons.split(","), v = q.length; v--;)CKEDITOR.skin.addIcon(q[v], n.path + "icons/" + (CKEDITOR.env.hidpi && n.hidpi ? "hidpi/" : "") + q[v] + ".png");
                            e[f] = 1
                        }
                        if (u)for (u.split && (u = u.split(",")), n = 0; n < u.length; n++)m[u[n]] ||
                        b.push(u[n])
                    }
                    if (b.length)l.call(this, b); else {
                        for (f in m)n = m[f], n.onLoad && !n.onLoad._called && (!1 === n.onLoad() && delete m[f], n.onLoad._called = 1);
                        c && c.call(d || window, m)
                    }
                }, this)
            };
        ...
        function m(a, b, c) {
            if (b) {
                ...
                for (f in g)d = g[f], (c || d.contextSensitive) &&
                d.refresh(a, b)
            }
        }
        ...
        function n(a) {
            var b = a.config,
                c = b.plugins, d = b.extraPlugins, f = b.removePlugins;
            if (d)var g = new RegExp("(?:^|,)(?:" + d.replace(/\s*,\s*/g, "|") + ")(?\x3d,|$)", "g"), c = c.replace(g, ""), c = c + ("," + d);
            if (f)var k = new RegExp("(?:^|,)(?:" + f.replace(/\s*,\s*/g, "|") + ")(?\x3d,|$)", "g"), c = c.replace(k, "");
            CKEDITOR.env.air && (c += ",adobeair");
            CKEDITOR.plugins.load(c.split(","), function (c) {
                var d = [], f = [], g = [];
                a.plugins = c;
                for (var e in c) {
                    var h = c[e], m = h.lang, l = null, t = h.requires, D;
                    CKEDITOR.tools.isArray(t) && (t = t.join(","));
                    if (t && (D = t.match(k)))for (; t = D.pop();)CKEDITOR.error("editor-plugin-required",
                        {plugin: t.replace(",", ""), requiredBy: e});
                    m && !a.lang[e] && (m.split && (m = m.split(",")), 0 <= CKEDITOR.tools.indexOf(m, a.langCode) ? l = a.langCode : (l = a.langCode.replace(/-.*/, ""), l = l != a.langCode && 0 <= CKEDITOR.tools.indexOf(m, l) ? l : 0 <= CKEDITOR.tools.indexOf(m, "en") ? "en" : m[0]), h.langEntries && h.langEntries[l] ? (a.lang[e] = h.langEntries[l], l = null) : g.push(CKEDITOR.getUrl(h.path + "lang/" + l + ".js")));
                    f.push(l);
                    d.push(h)
                }
                CKEDITOR.scriptLoader.load(g, function () {
                    for (var c = ["beforeInit", "init", "afterInit"], g = 0; g < c.length; g++)for (var k =
                        0; k < d.length; k++) {
                        var e = d[k];
                        0 === g && f[k] && e.lang && e.langEntries && (a.lang[e.name] = e.langEntries[f[k]]);
                        if (e[c[g]])e[c[g]](a)
                    }
        ...
        3,CKEDITOR.htmlParser = function () {
        ...
        $: function () {
            ...
            openTag: function (a) {
                ...
                "string" == typeof e && (e =
                    CKEDITOR.tools.htmlEncodeAttr(e));
        ...
        var e = CKEDITOR.tools.extend({table: 1, ul: 1, ol: 1, dl: 1},
        ...
        CKEDITOR.htmlParser.fragment.fromHtml = function (m, l, f) {
            function h(a) {
                ...
                if (0 < p.length)for (var c = 0; c < p.length; c++) {
                    var d = p[c], f = d.name, g = CKEDITOR.dtd[f], e = x.name && CKEDITOR.dtd[x.name];
                    e && !e[f] || a && g && !g[a] && CKEDITOR.dtd[a] ? f ==
                    x.name && (n(x, x.parent, 1), c--) : (b || (k(), b = 1), d = d.clone(), d.parent = x, x = d, p.splice(c, 1), c--)
                }
            }

            function k() {
                for (; w.length;)n(w.shift(), x)
            }
            ...
            function n(b, c, d) {
                c = c || x || r;
                var k = x;
                void 0 === b.previous && (u(c, b) && (x = c, v.onTagOpen(f, {}), b.returnPoint = c = x), g(b), a(b) && !b.children.length || c.add(b), "pre" ==
                b.name && (t = !1), "textarea" == b.name && (B = !1));
                b.returnPoint ? (x = b.returnPoint, delete b.returnPoint) : x = d ? c : k
            }

            function u(a, b) {
                if ((a == r || "body" == a.name) && f && (!a.name || CKEDITOR.dtd[a.name][f])) {
                    var c, d;
            ...
            var v =
                new CKEDITOR.htmlParser, r = l instanceof CKEDITOR.htmlParser.element ? l : "string" == typeof l ? new CKEDITOR.htmlParser.element(l) : new CKEDITOR.htmlParser.fragment, p = [], w = [], x = r, B = "textarea" == r.name, t = "pre" == r.name;
            v.onTagOpen = function (d, f, g, m) {
            ...
            v.onTagClose = function (a) {
                ...
                for (var c = [], d = [], g = x; g != r && g.name != a;)g._.isBlockLike || d.unshift(g), c.push(g), g = g.returnPoint || g.parent;
                if (g != r) {
            ...
            v.onText = function (a) {
                if (!(x._.hasInlineStarted && !w.length || t || B) && (a = CKEDITOR.tools.ltrim(a),
                    0 === a.length))return;
                var b = x.name, g = b ? CKEDITOR.dtd[b] || (x._.isBlockLike ? CKEDITOR.dtd.div : CKEDITOR.dtd.span) : c;
                if (!B && !g["#"] && b in e)v.onTagOpen(d[b] || ""), v.onText(a); else {
                    k();
                    h();
                    t || B || (a = a.replace(/[\t\r\n ]{2,}|[\t\r\n]/g, " "));
                    a = new CKEDITOR.htmlParser.text(a);
                    if (u(x, a))this.onTagOpen(f, {}, 0, 1);
                    x.add(a)
                }
            };
        ...
        CKEDITOR.htmlParser.fragment.prototype = {
            ...
            filter: function (a, b) {
                ...
                if (!1 !== d) {
                    c = this.children;
                    for (var k = 0; k < c.length; k++)d = c[k], d.type == CKEDITOR.NODE_ELEMENT ? d.forEach(a, b) : b && d.type != b || a(d)
                }
            }, getFilterContext: function (a) {
                return a || {}
            }
        ...
        CKEDITOR.htmlParser.filter = CKEDITOR.tools.createClass({
            $: function (b) {
                ...
                addRules: function (a, c) {
                    ...
                    a.attributeNames && this.attributeNameRules.addMany(a.attributeNames,
                        d, c);
                    ...
                    var d = c.type;
                    return d == CKEDITOR.NODE_ELEMENT ? this.onElement(a, c) : d == CKEDITOR.NODE_TEXT ? new CKEDITOR.htmlParser.text(this.onText(a, c.value)) :
                        d == CKEDITOR.NODE_COMMENT ? new CKEDITOR.htmlParser.comment(this.onComment(a, c.value)) : null
        ...
        a.prototype = {
            add: function (a, c, d) {
                ...
                var d = c instanceof CKEDITOR.htmlParser.node || c instanceof CKEDITOR.htmlParser.fragment, e = Array.prototype.slice.call(arguments, 1), l = this.rules, f = l.length, h, k, g, n;
        ...
        function a(a, f) {
            ...
            function k(a, d) {
                return function (f) {
                    if (f.type != CKEDITOR.NODE_DOCUMENT_FRAGMENT) {
                        var k = [], h = b(f), t, l;
                        if (h)for (e(h, 1) && k.push(h); h;)m(h) &&
                        (t = c(h)) && e(t) && ((l = c(t)) && !m(l) ? k.push(t) : (g(D).insertAfter(t), t.remove())), h = h.previous;
                        for (h = 0; h < k.length; h++)k[h].remove();
                        if (k = !a || !1 !== ("function" == typeof d ? d(f) : d))D || CKEDITOR.env.needsBrFiller || f.type != CKEDITOR.NODE_DOCUMENT_FRAGMENT ? D || CKEDITOR.env.needsBrFiller || !(7 < document.documentMode || f.name in CKEDITOR.dtd.tr || f.name in CKEDITOR.dtd.$listItem) ? (k = b(f), k = !k || "form" == f.name && "input" == k.name) : k = !1 : k = !1;
                        k && f.add(g(a))
                    }
                }
            }
            ...
            function e(a, b) {
                if ((!D || CKEDITOR.env.needsBrFiller) && a.type == CKEDITOR.NODE_ELEMENT &&
            ...
            var h = {elements: {}}, D = "html" == f, B = CKEDITOR.tools.extend({}, t), z;
            for (z in B)"#" in x[z] || delete B[z];
            for (z in B)h.elements[z] = k(D, a.config.fillEmptyBlocks);
            h.root = k(D, !1);
            h.elements.br =
                function (a) {
                    return function (b) {
                        if (b.parent.type != CKEDITOR.NODE_DOCUMENT_FRAGMENT) {
                            ...
                            if ("data-cke-bogus" in f || "data-cke-eol" in f)delete f["data-cke-bogus"]; else {
                                ...
                                var k = c(b);
                                !f && m(b.parent) ? l(b.parent, g(a)) : m(f) && k && !m(k) && g(a).insertBefore(f)
                            }
                        }
                    }
                }(D);
        ...
        function r(a, b) {
            var c = [], d = b.config.protectedSource, f = b._.dataStore || (b._.dataStore = {id: 1}), g = /<\!--\{cke_temp(comment)?\}(\d*?)--\x3e/g, d = [/<script[\s\S]*?(<\/script>|$)/gi, /<noscript[\s\S]*?<\/noscript>/gi, /<meta[\s\S]*?\/?>/gi].concat(d);
            a = a.replace(/\x3c!--[\s\S]*?--\x3e/g, function (a) {
                return "\x3c!--{cke_tempcomment}" + (c.push(a) -
                    1) + "--\x3e"
            });
            for (var k = 0; k < d.length; k++)a = a.replace(d[k], function (a) {
            ...
            return a = a.replace(/<(title|iframe|textarea)([^>]*)>([\s\S]*?)<\/\1>/g, function (a, c, d, f) {
                return "\x3c" + c + d + "\x3e" + v(q(f), b) + "\x3c/" + c + "\x3e"
            })
        }
        ...
        CKEDITOR.htmlDataProcessor = function (b) {
            ...
            b.on("toHtml", function (a) {
                a = a.data;
                var c = a.dataValue, d, c = r(c, b), c = g(c, H), c = k(c), c = g(c, I), c = c.replace(D, "$1cke:$2"), c = c.replace(R, "\x3ccke:$1$2\x3e\x3c/cke:$1\x3e"), c = c.replace(/(<pre\b[^>]*>)(\r\n|\n)/g, "$1$2$2"), c = c.replace(/([^a-z0-9<\-])(on\w{3,})(?!>)/gi, "$1data-cke-" + CKEDITOR.rnd + "-$2");
        ...
        CKEDITOR.htmlDataProcessor.prototype = {
            toHtml: function (a, b, c, d) {
                var f = this.editor,
                    g, k, e, h;
                b && "object" == typeof b ? (g = b.context, c = b.fixForBody, d = b.dontFilter, k = b.filter, e = b.enterMode, h = b.protectedWhitespaces) : g = b;
        ...
        var p = /(?:&nbsp;|\xa0)$/, w = "{cke_protected}", x = CKEDITOR.dtd, B = "caption colgroup col thead tfoot tbody".split(" "), t = CKEDITOR.tools.extend({}, x.$blockLimit, x.$block), z = {
            elements: {
                input: f,
                textarea: f
            }
        }, E = {attributeNames: [[/^on/, "data-cke-pa-on"], [/^data-cke-expando$/, ""]]}, y = {
            elements: {
                embed: function (a) {
                    var b = a.parent;
                    if (b && "object" == b.name) {
        ...
        var C = /<(a|area|img|input|source)\b([^>]*)>/gi, G = /([\w-:]+)\s*=\s*(?:(?:"[^"]*")|(?:'[^']*')|(?:[^ "'>]+))/gi, F = /^(href|src|name)$/i, I = /(?:<style(?=[ >])[^>]*>[\s\S]*?<\/style>)|(?:<(:?link|meta|base)[^>]*>)/gi, H = /(<textarea(?=[ >])[^>]*>)([\s\S]*?)(?:<\/textarea>)/gi, K = /<cke:encoded>([^<]*)<\/cke:encoded>/gi, D = /(<\/?)((?:object|embed|param|html|body|head|title)[^>]*>)/gi, N = /(<\/?)cke:((?:html|body|head|title)[^>]*>)/gi, R = /<cke:(param|embed)([^>]*?)\/?>(?!\s*<\/cke:\1)/gi
        ...
        CKEDITOR.inline =
            function (a, e) {
                ...
                c ? (b.setData(c.getValue(), null, !0), a = CKEDITOR.dom.element.createFromHtml('\x3cdiv contenteditable\x3d"' + !!b.readOnly + '" class\x3d"cke_textarea_inline"\x3e' + c.getValue() + "\x3c/div\x3e", CKEDITOR.document), a.insertAfter(c),
                    c.hide(), c.$.form && b._attachToForm()) : b.setData(a.getHtml(), null, !0);
        ...
        function b(a) {
            var b = a.name, e = a.element, l = a.elementMode, f = a.fire("uiSpace", {
                    space: "top",
                    html: ""
                }).html, h = a.fire("uiSpace", {
                    space: "bottom",
                    html: ""
                }).html, k = new CKEDITOR.template('\x3c{outerEl} id\x3d"cke_{name}" class\x3d"{id} cke cke_reset cke_chrome cke_editor_{name} cke_{langDir} ' +
        ...
        CKEDITOR.editor.prototype.resize = function (a, b, e, l) {
            ...
            l.setSize("width", a, !0);
            k && (k.style.width = "1%");
            var g = (l.$.offsetHeight || 0) - (h.$.clientHeight ||
                0), f = Math.max(b - (e ? 0 : g), 0);
            b = e ? b + g : b;
        ...
        function a(a) {
            var b = a.editor, d = a.data.path, f = d.blockLimit, g = a.data.selection,
                k = g.getRanges()[0], h;
            if (CKEDITOR.env.gecko || CKEDITOR.env.ie && CKEDITOR.env.needsBrFiller)if (g = e(g, d))g.appendBogus(), h = CKEDITOR.env.ie;
            l(b, d.block, f) && k.collapsed && !k.getCommonAncestor().isReadOnly() && (d = k.clone(), d.enlarge(CKEDITOR.ENLARGE_BLOCK_CONTENTS), f = new CKEDITOR.dom.walker(d), f.guard = function (a) {
                return !c(a) || a.type == CKEDITOR.NODE_COMMENT || a.isReadOnly()
            }, !f.checkForward() || d.checkStartOfBlock() && d.checkEndOfBlock()) && (b = k.fixBlock(!0, b.activeEnterMode == CKEDITOR.ENTER_DIV ? "div" : "p"), CKEDITOR.env.needsBrFiller ||
            (b = b.getFirst(c)) && b.type == CKEDITOR.NODE_TEXT && CKEDITOR.tools.trim(b.getText()).match(/^(?:&nbsp;|\xa0)$/) && b.remove(), h = 1, a.cancel());
            h && k.select()
        }

        function e(a, b) {
            if (a.isFake)return 0;
            var d = b.block || b.blockLimit, f = d && d.getLast(c);
        ...
        function m(a) {
            ...
            if (f.startPath().contains(g)) {
                ...
                a.guard = b();
                a.checkBackward();
                if (d)return e = f.clone(), e.collapse(), e.setEndAt(d, CKEDITOR.POSITION_AFTER_END), a = new CKEDITOR.dom.walker(e), a.guard = b(!0), d = !1, a.checkForward(), d
            }
            return null
        }
        ...
        CKEDITOR.editable = CKEDITOR.tools.createClass({
            base: CKEDITOR.dom.element, $: function (a, b) {
                ...
                focus: function () {
                    ...
                    CKEDITOR.env.ie && /^focus|blur$/.exec(a) && (a = "focus" ==
                    a ? "focusin" : "focusout", b = d(b, this), c[0] = a, c[1] = b);
                    ...
                    for (c in a)a.hasOwnProperty(c) && (b = a[c], null !== b ? this.setAttribute(c, b) :
                    ...
                    d.focus();
                    d.fire("saveSnapshot");
                    var f = d.activeEnterMode, d = d.getSelection(), g = a.getName(), g = CKEDITOR.dtd.$block[g];
                    b || (b = d.getRanges()[0]);
                    ...
                    var e, k;
                    if (g)for (; (e = b.getCommonAncestor(0, 1)) && (k = CKEDITOR.dtd[e.getName()]) && (!k || !k[f]);)e.getName() in CKEDITOR.dtd.span ? b.splitElement(e) :
                        b.checkStartOfBlock() && b.checkEndOfBlock() ? (b.setStartBefore(e), b.collapse(!0), e.remove()) : b.splitBlock(d == CKEDITOR.ENTER_DIV ? "div" : "p", c.editable());
                    b.insertNode(a);
                    return !0
                    ...
                    function a() {
                        ...
                        a:if (d.anchorNode && d.anchorNode == c.$)f = !0; else {
                        ...
                        f && (f = new CKEDITOR.dom.range(c), f.moveToElementEditStart(c),
                            b = b.createRange(), b.setStart(f.startContainer.$, f.startOffset), b.collapse(!0), d.removeAllRanges(), d.addRange(b))
                    }
                    ...
                    (this.focus(), b()); else if (this.hasFocus)this.focus(), a(); else this.once("focus", function () {
                        a()
                    }, null, null, -999)
                    ...
                    var c = x, d = {range: a, doc: a.document},
                    ...
                    d.tableContentsRanges ? (c.table.deleteRanges(d), a.moveToBookmark(d.bookmark), d.range = a) : (a.moveToBookmark(d.bookmark),
                        d.range = a, a.extractContents(c.detectExtractMerge(d)));
                    ...
                    if (b) {
                        ...
                        if (d = a.checkStartOfBlock() && a.checkEndOfBlock() && c.block && !a.root.equals(c.block)) {
                            a:{
                                var d = c.block.getElementsByTag("span"), g = 0, e;
                                if (d)for (; e = d.getItem(g++);)if (!n(e)) {
                                    d = !0;
                                    break a
                                }
                                d = !1
                    ...
                    } else c.autoParagraph(this.editor,
                        a), u(a.startContainer) && a.startContainer.appendBogus();
                    ...
                    if (!this.is("textarea")) {
                        ...
                        e && (f = d.getHead(), f.getCustomData("stylesheet") ||
                        (e = d.appendStyleText(e), e = new CKEDITOR.dom.element(e.ownerNode || e.owningElement), f.setCustomData("stylesheet", e), e.data("cke-temp", 1)));
                        ...
                        this.attachListener(a,
                            "key", function (b) {
                                ...
                                if (c in h) {
                                    b = a.getSelection();
                                    var f, e = b.getRanges()[0], k = e.startPath(), l, D, t, c = 8 == c;
                                    CKEDITOR.env.ie && 11 > CKEDITOR.env.version && (f = b.getSelectedElement()) || (f = m(b)) ? (a.fire("saveSnapshot"), e.moveToPosition(f, CKEDITOR.POSITION_BEFORE_START), f.remove(), e.select(), a.fire("saveSnapshot"), d = 1) : e.collapsed && ((l = k.block) && (t = l[c ? "getPrevious" : "getNext"](g)) && t.type == CKEDITOR.NODE_ELEMENT && t.is("table") && e[c ? "checkStartOfBlock" : "checkEndOfBlock"]() ?
                                        (a.fire("saveSnapshot"), e[c ? "checkEndOfBlock" : "checkStartOfBlock"]() && l.remove(), e["moveToElementEdit" + (c ? "End" : "Start")](t), e.select(), a.fire("saveSnapshot"), d = 1) : k.blockLimit && k.blockLimit.is("td") && (D = k.blockLimit.getAscendant("table")) && e.checkBoundaryOfElement(D, c ? CKEDITOR.START : CKEDITOR.END) && (t = D[c ? "getPrevious" : "getNext"](g)) ? (a.fire("saveSnapshot"), e["moveToElementEdit" + (c ? "End" : "Start")](t), e.checkStartOfBlock() && e.checkEndOfBlock() ? t.remove() : e.select(), a.fire("saveSnapshot"), d = 1) : (D = k.contains(["td",
                                        "th", "caption"])) && e.checkBoundaryOfElement(D, c ? CKEDITOR.START : CKEDITOR.END) && (d = 1))
                                }
                                return !d
                            });
                        ...
                        CKEDITOR.env.webkit && this.attachListener(a, "key", function (b) {
                            ...
                            if (b in h) {
                                var c =
                                    8 == b, d = a.getSelection().getRanges()[0];
                                b = d.startPath();
                                if (d.collapsed)a:{
                                    var f = b.block;
        ...
        var g = CKEDITOR.dom.walker.whitespaces(!0),
            n = CKEDITOR.dom.walker.bookmark(!1, !0), u = CKEDITOR.dom.walker.empty(), q = CKEDITOR.dom.walker.bogus(), v = /(^|<body\b[^>]*>)\s*<(p|div|address|h\d|center|pre)[^>]*>\s*(?:<br[^>]*>|&nbsp;|\u00A0|&#160;)?\s*(:?<\/\2>)?\s*(?=$|<\/body>)/gi, r = function () {
                function a(b) {
                    return b.type == CKEDITOR.NODE_ELEMENT
                }

                function b(c, d) {
                    var f, g, e, k, h = [], l = d.range.startContainer;
                    f = d.range.startPath();
                    for (var l = m[l.getName()], n = 0, w = c.getChildren(), v = w.count(), p = -1, z = -1, r = 0, E = f.contains(m.$list); n < v; ++n)f = w.getItem(n), a(f) ? (e =
                        f.getName(), E && e in CKEDITOR.dtd.$list ? h = h.concat(b(f, d)) : (k = !!l[e], "br" != e || !f.data("cke-eol") || n && n != v - 1 || (r = (g = n ? h[n - 1].node : w.getItem(n + 1)) && (!a(g) || !g.is("br")), g = g && a(g) && m.$block[g.getName()]), -1 != p || k || (p = n), k || (z = n), h.push({
                        isElement: 1,
                        isLineBreak: r,
                        ...
                        name: e,
                        allowed: k
                    }), g = r = 0)) : h.push({isElement: 0, node: f, allowed: 1});
                    -1 < p && (h[p].firstNotAllowed = 1);
                    -1 < z && (h[z].lastNotAllowed = 1);
                    return h
                }

                function d(b, c) {
                    var f = [], g = b.getChildren(), e = g.count(),
                        k, h = 0, l = m[c], t = !b.is(m.$inline) || b.is("br");
                    for (t && f.push(" "); h < e; h++)k = g.getItem(h), a(k) && !k.is(l) ? f = f.concat(d(k, c)) : f.push(k);
                    t && f.push(" ");
                    return f
                }
                ...
                function k(b, c, d, f) {
                    ...
                    (e = (new CKEDITOR.dom.walker(g)).next()) && a(e) && n[e.getName()] && (h = e.getPrevious()) && a(h) && !h.getParent().equals(b.startContainer) &&
                    d.contains(h) && f.contains(e) && e.isIdentical(h) && (e.moveChildren(h), e.remove(), k(b, c, d, f))
                }
                ...
                var m = CKEDITOR.dtd, n = {
                    ...
                    p: 1, div: 1, h1: 1, h2: 1,
                    h3: 1, h4: 1, h5: 1, h6: 1
                }, v = CKEDITOR.tools.extend({}, m.$inline);
                delete v.br;
                return function (n, D, p, r) {
                    var q = n.editor, x = !1;
                    "unfiltered_html" == D && (D = "html", x = !0);
                    if (!r.checkReadOnly()) {
                        var u = (new CKEDITOR.dom.elementPath(r.startContainer, r.root)).blockLimit || r.root;
                        n = {
                            type: D,
                            dontFilter: x,
                            editable: n,
                        ...
                        r = n.mergeCandidates;
                        var F, M;
                        "text" == n.type && D.shrink(CKEDITOR.SHRINK_ELEMENT, !0, !1) && (F = CKEDITOR.dom.element.createFromHtml("\x3cspan\x3e\x26nbsp;\x3c/span\x3e",
                            D.document), D.insertNode(F), D.setStartAfter(F));
                        x = new CKEDITOR.dom.elementPath(D.startContainer);
                        n.endPath = u = new CKEDITOR.dom.elementPath(D.endContainer);
                        if (!D.collapsed) {
                            var q = u.block || u.blockLimit, W = D.getCommonAncestor();
                            q && !q.equals(W) && !q.contains(W) && D.checkEndOfBlock() && n.zombies.push(q);
                            D.deleteContents()
                        }
                        for (; (M = g(D)) && a(M) && M.isBlockBoundary() && x.contains(M);)D.moveToPosition(M, CKEDITOR.POSITION_BEFORE_END);
                        k(D, n.blockLimit, x, u);
                        F && (D.setEndBefore(F), D.collapse(), F.remove());
                        F = D.startPath();
                        if (q = F.contains(e, !1, 1))D.splitElement(q), n.inlineStylesRoot = q, n.inlineStylesPeak = F.lastElement;
                        F = D.createBookmark();
                        (q = F.startNode.getPrevious(c)) && a(q) && e(q) && r.push(q);
                        (q = F.startNode.getNext(c)) && a(q) && e(q) && r.push(q);
                        for (q = F.startNode; (q = q.getParent()) && e(q);)r.push(q);
                        D.moveToBookmark(F);
                        if (F = p) {
                            F = n.range;
                            if ("text" == n.type && n.inlineStylesRoot) {
                                ...
                                for (r = n.inlineStylesRoot.getParent(); !M.equals(r);)D = D.appendTo(M.clone()), M = M.getParent();
                                p = D.getOuterHtml().split("{cke-peak}").join(p)
                            }
                            M = n.blockLimit.getName();
                            if (/^\s+|\s+$/.test(p) && "span" in CKEDITOR.dtd[M]) {
                            ...
                            if ((U = F.startPath().block) && (1 !=
                                ...
                                if (1 == M.getChildCount() && a(J = M.getFirst()) && J.is(w) && !J.hasAttribute("contenteditable")) {
                                    ...
                                    F = 0;
                                    for (r = U.count(); F < r; F++)if (D = U.getItem(F), !D.is(v))break a;
                        ...
                        if (F) {
                            ...
                            D = b(n.dataWrapper, n);
                            for (h(D, J); r < D.length; r++) {
                                u = D[r];
                                if (L = u.isLineBreak) {
                                    L = J;
                                    V = M;
                                    var X = void 0, ea = void 0;
                                    u.hasBlockSibling ? L = 1 : (X = L.startContainer.getAscendant(m.$block, 1)) && X.is({
                                        div: 1,
                                        p: 1
                                ...
                                if (L)p = 0 < r; else {
                                    L = J.startPath();
                                    !u.isBlock && l(n.editor, L.block, L.blockLimit) && (aa =
                                        f(n.editor)) && (aa = F.createElement(aa), aa.appendBogus(), J.insertNode(aa), CKEDITOR.env.needsBrFiller && (S = aa.getBogus()) && S.remove(), J.moveToPosition(aa, CKEDITOR.POSITION_BEFORE_END));
                                    if ((L = J.startPath().block) && !L.equals(Q)) {
                                        if (S = L.getBogus())S.remove(), U.push(L);
                                        Q = L
                                    }
                                    u.firstNotAllowed && (q = 1);
                                    if (q && u.isElement) {
                                        L = J.startContainer;
                                        for (V = null; L && !m[L.getName()][u.name];) {
                                            if (L.equals(M)) {
                                                L = null;
                                                break
                                            }
                                    ...
                                    if (ba) {
                                        ...
                                        ba = 0
                                    } else J.insertNode(u.node);
                                    u.lastNotAllowed && r < D.length - 1 && ((da = W ? x : da) && J.setEndAt(da, CKEDITOR.POSITION_AFTER_START), q = 0);
                                    J.collapse()
                                }
                            }
                            1 != D.length ? S = !1 : (S = D[0], S = S.isElement && "false" == S.node.getAttribute("contenteditable"));
                            S && (p = !0, L = D[0].node, J.setStartAt(L, CKEDITOR.POSITION_BEFORE_START), J.setEndAt(L, CKEDITOR.POSITION_AFTER_END));
                            n.dontMoveCaret = p;
                ...
                return function (d) {
                    var f = d.startContainer, g = f.getAscendant("table", 1), e = !1;
                    c(g.getElementsByTag("td"));
                    c(g.getElementsByTag("th"));
                    g = d.clone();
                    g.setStart(f, 0);
                    g = a(g).lastBackward();
                    g || (g = d.clone(), g.setEndAt(f, CKEDITOR.POSITION_BEFORE_END),
                        g = a(g).lastForward(), e = !0);
                    g || (g = f);
                ...
                eol: {
                    detect: function (a, b) {
                        var c = a.range, d = c.clone(), f = c.clone(), g = new CKEDITOR.dom.elementPath(c.startContainer, b), e = new CKEDITOR.dom.elementPath(c.endContainer,
                            b);
                        d.collapse(1);
                        f.collapse();
                ...
                bogus: {
                    ...
                    rebuild: function (a, b) {
                        var c = a.range, d = c.getCommonAncestor(), f = new CKEDITOR.dom.elementPath(d, b), g = new CKEDITOR.dom.elementPath(c.startContainer, b), c = new CKEDITOR.dom.elementPath(c.endContainer, b), e;
                        d.type == CKEDITOR.NODE_TEXT && (d = d.getParent());
                        if (f.blockLimit.is({tr: 1, table: 1})) {
                            var k = f.contains("table").getParent();
                            e = function (a) {
                                return !a.equals(k)
                            }
                        } else if (f.block &&
                            f.block.is(CKEDITOR.dtd.$listItem) && (g = g.contains(CKEDITOR.dtd.$list), c = c.contains(CKEDITOR.dtd.$list), !g.equals(c))) {
                            var h = f.contains(CKEDITOR.dtd.$list).getParent();
                            e = function (a) {
                                return !a.equals(h)
                            }
                        }
                    ...
                    list: {
                        detectMerge: function (a, b) {
                            var d = c(b, a.bookmark),
                                f = d.startPath(), g = d.endPath(), e = f.contains(CKEDITOR.dtd.$list), k = g.contains(CKEDITOR.dtd.$list);
                            ...
                            if (a.mergeListBookmark) {
                                var d = a.mergeListBookmark.startNode,
                                    f = a.mergeListBookmark.endNode, g = new CKEDITOR.dom.elementPath(d, c), e = new CKEDITOR.dom.elementPath(f, c);
                                if (a.mergeList) {
                                    var k = g.contains(CKEDITOR.dtd.$list), h = e.contains(CKEDITOR.dtd.$list);
                        ...
                        detectMerge: function (a, b) {
                            ...
                            if (a.mergeBlockBookmark && !a.purgeTableBookmark) {
                                var d = a.mergeBlockBookmark.startNode, f = a.mergeBlockBookmark.endNode, g = new CKEDITOR.dom.elementPath(d, c), e = new CKEDITOR.dom.elementPath(f, c), g = g.block, e = e.block;
                        ...
                        function a(c) {
                            var f = [], g, e = new CKEDITOR.dom.walker(c), k = c.startPath().contains(d), h = c.endPath().contains(d), l = {};
                            e.guard = function (a,
                                                e) {
                                if (a.type == CKEDITOR.NODE_ELEMENT) {
                                ...
                                if (e && k && a.equals(k))g = c.clone(), g.setEndAt(k, CKEDITOR.POSITION_BEFORE_END), f.push(g); else if (!e && h && a.equals(h))g = c.clone(), g.setStartAt(h, CKEDITOR.POSITION_AFTER_START), f.push(g); else {
                                    if (m = !e)m = a.type == CKEDITOR.NODE_ELEMENT && a.is(d) && (!k || b(a, k)) && (!h || b(a, h));
                        ...
                        function b(a, c) {
                            var d = CKEDITOR.POSITION_CONTAINS + CKEDITOR.POSITION_IS_CONTAINED, f = a.getPosition(c);
                        ...
                        return {
                            detectPurge: function (a) {
                                ...
                                var c = new CKEDITOR.dom.walker(c), f = 0;
                                ...
                                var e = c(g, f.bookmark), k = e.clone(), h, m, l = e.getCommonAncestor();
                                ...
                                l = l.contains("table");
                                m = m.contains("table");
                                if (l || m)l && m && b(l, m) ? (f.tableSurroundingRange =
                                ...
                                for (var b; b =
                                    a.tableContentsRanges.pop();)b.extractContents(), u(b.startContainer) && b.startContainer.appendBogus();
        ...
        function d(a) {
            ...
            var d = a.startContainer, f = a.getPreviousNode(c, null, d), g = a.getNextNode(c, null, d);
        ...
        function l(a, b) {
            ...
            if (c) {
                if (!1 !== b) {
                    var d, g = a.getDocument().getSelection().getNative(), e = g && "None" != g.type && g.getRangeAt(0);
                    1 < c.getLength() && e && e.intersectsNode(c.$) && (d = h(g), e = g.focusNode == c.$ && 0 < g.focusOffset, g.anchorNode == c.$ && 0 < g.anchorOffset && d[0].offset--, e && d[1].offset--)
                }
        ...
        function g(a) {
            ...
            a.fire("lockSnapshot");
            a.editable().append(b);
            var c = a.getSelection(1), d = a.createRange(), f = c.root.on("selectionchange",
                function (a) {
                    a.cancel()
                }, null, null, 0);
        ...
        function n(a) {
            ...
            return function (c) {
                ...
                if (b[d]) {
                    ...
                    1 == f.length && g.collapsed && (d = g[38 > d ? "getPreviousEditableNode" : "getNextEditableNode"]()) && d.type == CKEDITOR.NODE_ELEMENT && "false" == d.getAttribute("contenteditable") &&
        ...
        function u(a) {
            for (var b = 0; b < a.length; b++) {
                ...
                if (!c.collapsed) {
                    if (c.startContainer.isReadOnly())for (var d = c.startContainer, f; d && !((f = d.type == CKEDITOR.NODE_ELEMENT) && d.is("body") || !d.isReadOnly());)f && "false" == d.getAttribute("contentEditable") && c.setStartAfter(d), d = d.getParent();
                    d = c.startContainer;
                    f = c.endContainer;
                    var g = c.startOffset, e = c.endOffset, k = c.clone();
                    d && d.type == CKEDITOR.NODE_TEXT &&
                    (g >= d.getLength() ? k.setStartAfter(d) : k.setStartBefore(d));
                    f && f.type == CKEDITOR.NODE_TEXT && (e ? k.setEndAfter(f) : k.setEndBefore(f));
                    ...
                    d.evaluator = function (d) {
                        if (d.type == CKEDITOR.NODE_ELEMENT && d.isReadOnly()) {
                            ...
                            d.getPosition(k.endContainer) & CKEDITOR.POSITION_CONTAINS || (f.setStartAfter(d), f.collapsed || a.splice(b + 1, 0, f));
                            return !0
                        }
                        return !1
                    };
        ...
        var q, v, r = CKEDITOR.dom.walker.invisible(1), p = function () {
            function a(b) {
                return function (a) {
                    var c =
        ...
        CKEDITOR.on("instanceCreated", function (b) {
            ...
            d.on("contentDom", function () {
                function b() {
                    p = new CKEDITOR.dom.selection(d.getSelection());
                    p.lock()
                }
                ...
                var f = d.document, g = CKEDITOR.document, k = d.editable(),
                    h = f.getBody(), m = f.getDocumentElement(), t = k.isInline(), D, p;
                CKEDITOR.env.gecko && k.attachListener(k, "focus", function (a) {
                    a.removeListener();
                    0 !== D && (a = d.getSelection().getNative()) && a.isCollapsed && a.anchorNode == k.$ && (a = d.createRange(), a.moveToElementEditStart(k), a.select())
                }, null, null, -2);
                k.attachListener(k, CKEDITOR.env.webkit ? "DOMFocusIn" : "focus", function () {
                    D && CKEDITOR.env.webkit && (D = d._.previousActive && d._.previousActive.equals(f.getActive()));
                    d.unlockSelection(D);
                    D = 0
                }, null, null, -1);
                k.attachListener(k,
                ...
                if (CKEDITOR.env.ie || t)w ? k.attachListener(k, "beforedeactivate", b, null, null, -1) : k.attachListener(d, "selectionCheck", b, null, null, -1), k.attachListener(k, CKEDITOR.env.webkit ? "DOMFocusOut" : "blur", function () {
                    d.lockSelection(p);
                    D = 1
                ...
                if (CKEDITOR.env.ie && !t) {
                    ...
                    if ("BackCompat" != f.$.compatMode) {
                        ...
                        if (7 < CKEDITOR.env.version && 11 > CKEDITOR.env.version)m.on("mousedown", function (a) {
                            a.data.getTarget().is("html") && (g.on("mouseup", c), m.on("mouseup", c))
                        })
                    }
                }
                ...
                CKEDITOR.env.webkit && k.attachListener(f, "keydown", function (a) {
                    ...
                    null, null, -1);
                k.attachListener(k, "keydown", n(d), null, null, -1)
            });
        ...
        CKEDITOR.on("instanceReady", function (a) {
            function b() {
                ...
                if (a && (a = m(a))) {
                    ...
                    "None" == c.type || c.anchorNode != a.$ && c.focusNode !=
                    a.$ || (e = h(c));
                    g = a.getText();
                    a.setText(f(g))
                }
            ...
            function c() {
                var a = d.editable();
                a && (a = m(a)) && (a.setText(g), e && (k(d.document.$, e), e = null))
            }

            var d = a.editor, g, e;
            CKEDITOR.env.webkit && (d.on("selectionChange", function () {
                var a = d.editable(), b = m(a);
                b && (b.getCustomData("ready") ? l(a) : b.setCustomData("ready", 1))
        ...
        var w = "function" != typeof window.getSelection, x = 1;
        CKEDITOR.dom.selection = function (a) {
            ...
            var d,
                f;
            if (a)if (a.getRangeAt)d = (f = a.rangeCount && a.getRangeAt(0)) && new CKEDITOR.dom.node(f.commonAncestorContainer); else {
                try {
                    f = a.createRange()
                } catch (g) {
                }
        ...
        CKEDITOR.dom.selection.prototype = {
            getNative: function () {
                ...
                if (!c || !c.rangeCount)b = CKEDITOR.SELECTION_NONE; else if (1 == c.rangeCount) {
                    ...
                    d == c.endContainer && 1 == d.nodeType && 1 == c.endOffset - c.startOffset && B[d.childNodes[c.startOffset].nodeName.toLowerCase()] &&
                ...
                var a = w ? function () {
                    ...
                    var b = function (b, c) {
                        ...
                        for (var f = d.children, g, e, k = b.duplicate(), h = 0, m = f.length - 1, l = -1, n, p; h <= m;)if (l = Math.floor((h + m) / 2), g = f[l], k.moveToElementText(g), n = k.compareEndPoints("StartToStart", b), 0 < n)m = l - 1; else if (0 > n)h = l + 1; else return {
                            container: d,
                            offset: a(g)
                        };
                        if (-1 == l || l == f.length - 1 && 0 > n) {
                            k.moveToElementText(d);
                            k.setEndPoint("StartToStart", b);
                            k = k.text.replace(/(\r\n|\r)/g, "\n").length;
                            f = d.childNodes;
                            if (!k)return g = f[f.length - 1], g.nodeType != CKEDITOR.NODE_TEXT ? {
                                container: d,
                                offset: f.length
                            } : {container: g, offset: g.nodeValue.length};
                            for (d = f.length; 0 < k && 0 < d;)e = f[--d], e.nodeType == CKEDITOR.NODE_TEXT && (p = e, k -= e.nodeValue.length);
                        ...
                        for (; 0 < k;)try {
                            e = g[0 < n ? "previousSibling" : "nextSibling"], e.nodeType == CKEDITOR.NODE_TEXT && (k -= e.nodeValue.length, p = e), g = e
                        } catch (w) {
                    ...
                    return function () {
                        ...
                        if (d == CKEDITOR.SELECTION_ELEMENT) {
                            for (var d = [], f = 0; f < c.length; f++) {
                                for (var g = c.item(f), e = g.parentNode, k = 0, a = new CKEDITOR.dom.range(this.root); k < e.childNodes.length && e.childNodes[k] != g; k++);
                                a.setStart(new CKEDITOR.dom.node(e), k);
                                a.setEnd(new CKEDITOR.dom.node(e), k + 1);
                                d.push(a)
                            }
                            return d
                        }
                ...
                var b = this, c = CKEDITOR.tools.tryThese(function () {
                    ...
                    for (var a = b.getRanges()[0].clone(), c, d, f = 2; f && !((c = a.getEnclosedNode()) && c.type == CKEDITOR.NODE_ELEMENT && B[c.getName()] &&
                ...
                if (this.isLocked) {
                    if (a)var b =
                        this.getSelectedElement(), c = !b && this.getRanges(), d = this.isFake;
                    this.isLocked = 0;
                    this.reset();
                ...
                this.reset();
                if (b)for (var b = this.root, c, f = 0; f < a.length; ++f)c = a[f], c.endContainer.equals(b) && (c.endOffset = Math.min(c.endOffset, b.getChildCount()));
                if (a.length)if (this.isLocked) {
                    ...
                    a:{
                        var k, h;
                        if (1 == a.length && !(h = a[0]).collapsed && (e = h.getEnclosedNode()) && e.type == CKEDITOR.NODE_ELEMENT && (h = h.clone(), h.shrink(CKEDITOR.SHRINK_ELEMENT, !0), (k = h.getEnclosedNode()) && k.type == CKEDITOR.NODE_ELEMENT && (e = k), "false" == e.getAttribute("contenteditable")))break a;
                        e = void 0
                    }
                    if (e)this.fake(e); else {
                        if (w) {
                            ...
                            1 < a.length && (e = a[a.length -
                            1], a[0].setEnd(e.endContainer, e.endOffset));
                            e = a[0];
                            a = e.collapsed;
                            var m, n, p;
                            if ((c = e.getEnclosedNode()) && c.type == CKEDITOR.NODE_ELEMENT && c.getName() in B && (!c.is("a") || !c.getText()))try {
                            ...
                            g ? (k = e.document.$.body.createTextRange(), k.moveToElementText(g.$), p.setEndPoint("EndToEnd", k), p.moveEnd("character", -1)) : (m = b.getNext(h), n = b.hasAscendant("pre"), m = !(m && m.getText && m.getText().match(k)) && (n || !b.hasPrevious() || b.getPrevious().is && b.getPrevious().is("br")), n = e.document.createElement("span"), n.setHtml("\x26#65279;"), n.insertBefore(b), m && e.document.createText("﻿").insertBefore(b));
                            e.setStartBefore(b);
                            b.remove();
                            a ? (m ? (p.moveStart("character", -1), p.select(), e.document.$.selection.clear()) : p.select(), e.moveToPosition(n, CKEDITOR.POSITION_BEFORE_START), n.remove()) : (e.setEndBefore(g), g.remove(), p.select())
                        } else {
                            g = this.getNative();
                            if (!g)return;
                            this.removeAllRanges();
                            for (p = 0; p < a.length; p++) {
                                if (p < a.length - 1 && (m = a[p], n = a[p + 1], k = m.clone(), k.setStart(m.endContainer, m.endOffset), k.setEnd(n.startContainer, n.startOffset), !k.collapsed && (k.shrink(CKEDITOR.NODE_ELEMENT, !0), e = k.getCommonAncestor(), k = k.getEnclosedNode(),
                                    e.isReadOnly() || k && k.isReadOnly()))) {
                                ...
                                e.collapsed && CKEDITOR.env.webkit && d(e) && (m = this.root, l(m, !1), k = m.getDocument().createText("​"), m.setCustomData("cke-fillingChar", k), e.insertNode(k), (m = k.getNext()) && !k.getPrevious() && m.type == CKEDITOR.NODE_ELEMENT && "br" == m.getName() ? (l(this.root), e.moveToPosition(m, CKEDITOR.POSITION_BEFORE_START)) : e.moveToPosition(k, CKEDITOR.POSITION_AFTER_END));
                                n.setStart(e.startContainer.$,
                                    e.startOffset);
                                try {
                                    n.setEnd(e.endContainer.$, e.endOffset)
                                } catch (v) {
                                    if (0 <= v.toString().indexOf("NS_ERROR_ILLEGAL_VALUE"))e.collapse(1), n.setEnd(e.endContainer.$, e.endOffset); else throw v;
                                }
                                g.addRange(n)
                            }
                        }
        ...
        function b(c) {
            var f = c.document;
            if (c.collapsed)f = w(this, f), c.insertNode(f), c.moveToPosition(f, CKEDITOR.POSITION_BEFORE_END); else {
                var g = this.element, k = this._.definition, h, m = k.ignoreReadonly, l = m || k.includeReadonly;
                ...
                c.trim();
                var p = c.createBookmark(), r = p.startNode, q = p.endNode, x = r, u;
                if (!m) {
                    var t = c.getCommonAncestor(), m = a(r, t), t = a(q,
                        t);
                    m && (x = m.getNextSourceNode(!0));
                    t && (q = t)
                }
                for (x.getPosition(q) == CKEDITOR.POSITION_FOLLOWING && (x = 0); x;) {
                    m = !1;
                    if (x.equals(q))x = null, m = !0; else {
                        var B = x.type == CKEDITOR.NODE_ELEMENT ? x.getName() : null, t = B && "false" == x.getAttribute("contentEditable"), z = B && x.getAttribute("data-nostyle");
                        if (B && x.data("cke-bookmark")) {
                            x = x.getNextSourceNode(!0);
                            continue
                        }
                        if (t && l && CKEDITOR.dtd.$block[B])for (var E = x, y = d(E), A = void 0, C = y.length, G = 0, E = C && new CKEDITOR.dom.range(E.getDocument()); G < C; ++G) {
                            var A = y[G], ga = CKEDITOR.filter.instances[A.data("cke-filter")];
                            if (ga ? ga.check(this) : 1)E.selectNodeContents(A), b.call(this, E)
                        }
                        y = B ? !n[B] || z ? 0 : t && !l ? 0 : e(x, q, k, H) : 1;
                        if (y)if (A = x.getParent(), y = k, C = g, G = h, !A || !(A.getDtd() || CKEDITOR.dtd.span)[C] && !G || y.parentRule && !y.parentRule(A))m = !0; else {
                            if (u || B && CKEDITOR.dtd.$removeEmpty[B] && (x.getPosition(q) | H) != H || (u = c.clone(), u.setStartBefore(x)), B = x.type, B == CKEDITOR.NODE_TEXT || t || B == CKEDITOR.NODE_ELEMENT && !x.getChildCount()) {
                                for (var B = x, fa; (m = !B.getNext(F)) && (fa = B.getParent(), n[fa.getName()]) && e(fa, r, k, K);)B = fa;
                                u.setEndAfter(B)
                            }
                        } else m = !0;
                        x = x.getNextSourceNode(z || t)
                    }
                    if (m && u && !u.collapsed) {
                        for (var m = w(this, f), t = m.hasAttributes(), z = u.getCommonAncestor(), B = {}, y = {}, A = {}, C = {}, I, Z, ha; m && z;) {
                            if (z.getName() == g) {
                                for (I in k.attributes)!C[I] && (ha = z.getAttribute(Z)) && (m.getAttribute(I) == ha ? y[I] = 1 : C[I] = 1);
                                for (Z in k.styles)!A[Z] && (ha = z.getStyle(Z)) && (m.getStyle(Z) == ha ? B[Z] = 1 : A[Z] = 1)
                            }
                            z = z.getParent()
                        }
                        for (I in y)m.removeAttribute(I);
                        for (Z in B)m.removeStyle(Z);
                        t && !m.hasAttributes() && (m = null);
                        m ? (u.extractContents().appendTo(m), u.insertNode(m), v.call(this,
                            m), m.mergeSiblings(), CKEDITOR.env.ie || m.$.normalize()) : (m = new CKEDITOR.dom.element("span"), u.extractContents().appendTo(m), u.insertNode(m), v.call(this, m), m.remove(!0));
                        u = null
                    }
                }
                c.moveToBookmark(p);
        ...
        function c(a) {
            function b() {
                for (var a = new CKEDITOR.dom.elementPath(d.getParent()), c = new CKEDITOR.dom.elementPath(m.getParent()), f = null, g = null, e = 0; e < a.elements.length; e++) {
                    var k = a.elements[e];
                    if (k == a.block || k == a.blockLimit)break;
                    l.checkElementRemovable(k,
                        !0) && (f = k)
                }
                for (e = 0; e < c.elements.length; e++) {
                    k = c.elements[e];
                    if (k == c.block || k == c.blockLimit)break;
                    l.checkElementRemovable(k, !0) && (g = k)
                }
                g && m.breakParent(g);
                f && d.breakParent(f)
            }
            ...
            if (a.collapsed) {
                for (var f = new CKEDITOR.dom.elementPath(d.getParent(), a.root), g, e = 0, k; e < f.elements.length && (k = f.elements[e]) && k != f.block && k != f.blockLimit; e++)if (this.checkElementRemovable(k)) {
                    var h;
                    a.collapsed && (a.checkBoundaryOfElement(k, CKEDITOR.END) ||
                    (h = a.checkBoundaryOfElement(k, CKEDITOR.START))) ? (g = k, g.match = h ? "start" : "end") : (k.mergeSiblings(), k.is(this.element) ? q.call(this, k) : r(k, t(this)[k.getName()]))
                }
                if (g) {
                    k = d;
                    for (e = 0; ; e++) {
                ...
                b();
                for (f = d; !f.equals(m);)g = f.getNextSourceNode(), f.type == CKEDITOR.NODE_ELEMENT && this.checkElementRemovable(f) && (f.getName() == this.element ? q.call(this,
                    f) : r(f, t(this)[f.getName()]), g.type == CKEDITOR.NODE_ELEMENT && g.contains(d) && (b(), g = d.getNext())), f = g
            }
            a.moveToBookmark(c);
        ...
        function f(a) {
            ...
            for (var d, f = a.document, g; d = c.getNextParagraph();)!d.isReadOnly() && (c.activeFilter ? c.activeFilter.check(this) :
                1) && (g = w(this, f, d), k(d, g));
            a.moveToBookmark(b)
        }
        ...
        function h(a) {
            ...
            for (var d, f; d = c.getNextParagraph();)this.checkElementRemovable(d) && (d.is("pre") ? ((f = this._.enterMode == CKEDITOR.ENTER_BR ? null : a.document.createElement(this._.enterMode == CKEDITOR.ENTER_P ? "p" : "div")) && d.copyAttributes(f), k(d, f)) : q.call(this, d));
            a.moveToBookmark(b)
        }
        ...
        function k(a, b) {
            ...
            if (d && !f) {
                ...
                if (CKEDITOR.env.ie) {
                    ...
                    f.copyAttributes(k.getFirst());
                    f = k.getFirst().remove()
                } else f.setHtml(e);
                b = f
            } else e ? b = u(c ?
                [a.getHtml()] : g(a), b) : a.moveChildren(b);
            b.replace(a);
            if (d) {
                var c = b, h;
                (h = c.getPrevious(I)) && h.type == CKEDITOR.NODE_ELEMENT && h.is("pre") && (d = n(h.getHtml(), /\n$/, "") + "\n\n" + n(c.getHtml(), /^\n/, ""), CKEDITOR.env.ie ? c.$.outerHTML = "\x3cpre\x3e" + d + "\x3c/pre\x3e" : c.setHtml(d), h.remove())
            } else c && p(b)
        }
        ...
        function g(a) {
            ...
            }).replace(/<pre\b.*?>([\s\S]*?)<\/pre>/gi, function (a,
                                                                  c) {
                b.push(c)
            });
            return b
        ...
        function q(a, b) {
            var c = this._.definition, d = c.attributes, c = c.styles, f = t(this)[a.getName()], g = CKEDITOR.tools.isEmpty(d) && CKEDITOR.tools.isEmpty(c), e;
            for (e in d)if ("class" != e && !this._.definition.fullMatch || a.getAttribute(e) == z(e, d[e]))b &&
            "data-" == e.slice(0, 5) || (g = a.hasAttribute(e), a.removeAttribute(e));
            for (var k in c)this._.definition.fullMatch && a.getStyle(k) != z(k, c[k], !0) || (g = g || !!a.getStyle(k), a.removeStyle(k));
            r(a, f, y[a.getName()]);
        ...
        function v(a) {
            for (var b = t(this), c = a.getElementsByTag(this.element), d, f = c.count(); 0 <= --f;)d = c.getItem(f),
            d.isReadOnly() || q.call(this, d, !0);
            for (var g in b)if (g != this.element)for (c = a.getElementsByTag(g), f = c.count() - 1; 0 <= f; f--)d = c.getItem(f), d.isReadOnly() || r(d, b[g])
        }
        ...
        function p(a, b) {
            if (!a.hasAttributes() || b)if (CKEDITOR.dtd.$block[a.getName()]) {
                ...
                !c || c.type != CKEDITOR.NODE_TEXT &&
                c.isBlockBoundary({br: 1}) || a.append("br", 1);
        ...
        function w(a, b, c) {
            ...
            d = x(d, a);
            b.getCustomData("doc_processing_style") && d.hasAttribute("id") ? d.removeAttribute("id") :
        ...
        function t(a) {
            ...
            if (c) {
                ...
                for (var d = 0; d < c.length; d++) {
                    var f = c[d], g, e;
                    "string" == typeof f ?
                        g = f.toLowerCase() : (g = f.element ? f.element.toLowerCase() : a.element, e = f.attributes);
                    f = b[g] || (b[g] = {});
                    if (e) {
                        var f = f.attributes = f.attributes || [], k;
                        for (k in e)f.push([k.toLowerCase(), e[k]])
                    }
                }
            }
            return b
        ...
        function E(a, b, c) {
            var d = a.document, f = a.getRanges();
        ...
        var y = {
            ...
            audio: 1,
            video: 1
        }, C = /\s*(?:;\s*|$)/, G = /#\((.+?)\)/g, F = CKEDITOR.dom.walker.bookmark(0, 1), I = CKEDITOR.dom.walker.whitespaces(1);
        CKEDITOR.style = function (a, b) {
            ...
            this.type = a.type || (y[c] ? CKEDITOR.STYLE_BLOCK : A[c] ? CKEDITOR.STYLE_OBJECT : CKEDITOR.STYLE_INLINE);
            ...
            checkActive: function (a, b) {
                switch (this.type) {
                    ...
                    case CKEDITOR.STYLE_INLINE:
                        for (var c = a.elements, d = 0, f; d < c.length; d++)if (f = c[d], this.type != CKEDITOR.STYLE_INLINE || f != a.block && f != a.blockLimit) {
                ...
                if ("string" == typeof this.element ? d == this.element : d in this.element) {
                    ...
                    if (c._length) {
                        for (var k in c)if ("_length" != k) {
                            f = a.getAttribute(k) || "";
                            if ("style" == k)a:{
                                d = c[k];
                                "string" == typeof d && (d = CKEDITOR.tools.parseCssText(d));
                                "string" == typeof f && (f = CKEDITOR.tools.parseCssText(f, !0));
                                e = void 0;
                                for (e in d)if (!(e in f) || f[e] != d[e] && "inherit" != d[e] && "inherit" != f[e]) {
                                    d = !1;
                                    break a
                                }
                                d = !0
        ...
        var H = CKEDITOR.POSITION_PRECEDING | CKEDITOR.POSITION_IDENTICAL | CKEDITOR.POSITION_IS_CONTAINED, K = CKEDITOR.POSITION_FOLLOWING | CKEDITOR.POSITION_IDENTICAL | CKEDITOR.POSITION_IS_CONTAINED
    ...
    },CKEDITOR.tools.extend(CKEDITOR.editor.prototype,
        {
            attachStyleStateChange: function (a, e) {
                ...
                b || (b = this._.styleStateChangeCallbacks = [], this.on("selectionChange", function (a) {
                    for (var d = 0; d < b.length; d++) {
                        var e = b[d], l = e.style.checkActive(a.data.path, this) ? CKEDITOR.TRISTATE_ON : CKEDITOR.TRISTATE_OFF;
                        e.fn.call(this, l)
                    }
                }));
                b.push({style: a, fn: e})
            ...
            if (this._.stylesDefinitions)a(this._.stylesDefinitions); else {
                var e = this, b =
                    e.config.stylesCombo_stylesSet || e.config.stylesSet;
        ...
        CKEDITOR.dom.domObject.call(this, a)
    },CKEDITOR.dom.comment.prototype =
        new CKEDITOR.dom.node,CKEDITOR.tools.extend(CKEDITOR.dom.comment.prototype, {
        ...
        compare: function (a) {
            ...
            } : "function" == typeof a ? c = a : "object" == typeof a &&
            (c = function (b) {
        ...
        type: CKEDITOR.NODE_TEXT, getLength: function () {
            ...
            var e = this.$.parentNode, b = e.childNodes.length, c = this.getLength(), d = this.getDocument(), m = new CKEDITOR.dom.text(this.$.splitText(a), d);
            e.childNodes.length == b && (a >= c ? (m = d.createText(""),
                m.insertAfter(this)) : (a = d.createText(""), a.insertAfter(m), a.remove()));
            return m
        ...
        function a(a, c, d) {
            var e = a.serializable, l = c[d ? "endContainer" : "startContainer"], f = d ? "endOffset" : "startOffset", h = e ? c.document.getById(a.startNode) : a.startNode;
            a = e ? c.document.getById(a.endNode) : a.endNode;
            l.equals(h.getPrevious()) ? (c.startOffset = c.startOffset - l.getLength() - a.getPrevious().getLength(), l =
                a.getNext()) : l.equals(a.getPrevious()) && (c.startOffset -= l.getLength(), l = a.getNext());
        ...
        if (a = CKEDITOR._.pending)for (delete CKEDITOR._.pending, e = 0; e < a.length; e++)CKEDITOR.editor.prototype.constructor.apply(a[e][0],
...
panel:new CKEDITOR.template(".cke_panel_grouptitle [{lightGradient}border-color:{defaultBorder};] .cke_menubutton_icon [background-color:{menubuttonIcon};] .cke_menubutton:hover .cke_menubutton_icon, .cke_menubutton:focus .cke_menubutton_icon, .cke_menubutton:active .cke_menubutton_icon [background-color:{menubuttonIconHover};] .cke_menuseparator [background-color:{menubuttonIcon};] a:hover.cke_colorbox, a:focus.cke_colorbox, a:active.cke_colorbox [border-color:{defaultBorder};] a:hover.cke_colorauto, a:hover.cke_colormore, a:focus.cke_colorauto, a:focus.cke_colormore, a:active.cke_colorauto, a:active.cke_colormore [background-color:{ckeColorauto};border-color:{defaultBorder};] ")};
        ...
        onLoad: function () {
            ...
            CKEDITOR.tools.extend(CKEDITOR.ui.dialog, {
                labeledElement: function (b, c, d, f) {
                    if (!(4 > arguments.length)) {
                        var e = a.call(this, c);
                        e.labelId = CKEDITOR.tools.getNextId() +
                            "_label";
                        this._.children = [];
                        ...
                        CKEDITOR.ui.dialog.uiElement.call(this, b, c, d, "div", null, m, function () {
                            ...
                            "horizontal" != c.labelLayout ? a.push('\x3clabel class\x3d"cke_dialog_ui_labeled_label' + d + '" ', ' id\x3d"' + e.labelId + '"', e.inputId ? ' for\x3d"' + e.inputId + '"' : "", (c.labelStyle ? ' style\x3d"' + c.labelStyle + '"' : "") + "\x3e", c.label, "\x3c/label\x3e", '\x3cdiv class\x3d"cke_dialog_ui_labeled_content"',
                    ...
                    if (!(3 > arguments.length)) {
                        a.call(this, c);
                        var e = this._.inputId = CKEDITOR.tools.getNextId() + "_textInput", m = {
                        ...
                        CKEDITOR.ui.dialog.labeledElement.call(this, b, c, d, function () {
                            ...
                            this._.required &&
                            (m["aria-required"] = this._.required);
                    ...
                    if (!(3 > arguments.length)) {
                        ...
                        CKEDITOR.ui.dialog.labeledElement.call(this, b, c, d, function () {
                            ...
                            var a = ['\x3cdiv class\x3d"cke_dialog_ui_input_textarea" role\x3d"presentation"\x3e\x3ctextarea id\x3d"', m, '" '], b;
                    ...
                    if (!(3 > arguments.length)) {
                        ...
                        CKEDITOR.ui.dialog.uiElement.call(this, b, c, d, "span", null, null, function () {
                            var a = CKEDITOR.tools.extend({}, c, {id: c.id ? c.id + "_checkbox" : CKEDITOR.tools.getNextId() + "_checkbox"}, !0), d = [], e = CKEDITOR.tools.getNextId() + "_label", g = {
                        ...
                        CKEDITOR.ui.dialog.labeledElement.call(this,
                            b, c, d, function () {
                                for (var a = [], d = [], g = (c.id ? c.id : CKEDITOR.tools.getNextId()) + "_radio", m = 0; m < c.items.length; m++) {
                                    var w = c.items[m], x = void 0 !== w[2] ? w[2] : w[0], B = void 0 !== w[1] ? w[1] : w[0], t = CKEDITOR.tools.getNextId() + "_radio_input", z = t + "_label", t = CKEDITOR.tools.extend({}, c, {
                                        id: t,
                                        title: null,
                                        type: null
                                    }, !0), x = CKEDITOR.tools.extend({}, t, {title: x}, !0), E = {
                                        type: "radio",
                                    ...
                                    f.push(new CKEDITOR.ui.dialog.uiElement(b, t, y, "input", null, E));
                                    y.push(" ");
                                    new CKEDITOR.ui.dialog.uiElement(b, x, y, "label", null, {
                                        id: z,
                                        "for": E.id
                                    }, w[0]);
                                    a.push(y.join(""))
                    ...
                    if (arguments.length) {
                        ...
                        CKEDITOR.ui.dialog.uiElement.call(this, b, e, d, "a", null, {
                            ...
                            role: "button",
                            "aria-labelledby": m
                        }, '\x3cspan id\x3d"' + m + '" class\x3d"cke_dialog_ui_button"\x3e' +
                    ...
                    if (!(3 > arguments.length)) {
                        ...
                        CKEDITOR.ui.dialog.labeledElement.call(this, b, c, d, function () {
                            var a = CKEDITOR.tools.extend({}, c, {id: c.id ? c.id + "_select" : CKEDITOR.tools.getNextId() + "_select"}, !0), d = [], e = [], g = {
                                id: f.inputId,
                            ...
                            l(a);
                            for (var m = 0, w; m < c.items.length && (w = c.items[m]); m++)e.push('\x3coption value\x3d"', CKEDITOR.tools.htmlEncode(void 0 !== w[1] ? w[1] : w[0]).replace(/"/g, "\x26quot;"), '" /\x3e ', CKEDITOR.tools.htmlEncode(w[0]));
                            "undefined" != typeof a.inputStyle && (a.style = a.inputStyle);
                            f.select = new CKEDITOR.ui.dialog.uiElement(b, a, d, "select", null,
                                g, e.join(""));
                            d.push("\x3c/div\x3e");
                            return d.join("")
                        })
                    ...
                    CKEDITOR.ui.dialog.uiElement.call(this, a, f, d, "fieldset", null, null, function () {
                        var a = [];
                        e && a.push("\x3clegend" +
                            (f.labelStyle ? ' style\x3d"' + f.labelStyle + '"' : "") + "\x3e" + e + "\x3c/legend\x3e");
            ...
            CKEDITOR.ui.dialog.file.prototype = CKEDITOR.tools.extend(new CKEDITOR.ui.dialog.labeledElement, c, {
                getInputElement: function () {
                    ...
                    var b = this._, c = CKEDITOR.document.getById(b.frameId).getFrameDocument(), d = b.definition, f = b.buttons, e = this.formLoadedNumber, m = this.formUnloadNumber, l = b.dialog._.editor.lang.dir, p = b.dialog._.editor.langCode;
        ...
        function m(a) {
            var b = CKEDITOR.dom.element.createFromHtml(CKEDITOR.addTemplate("dialog", r).output({
            ...
            })), c = b.getChild([0, 0, 0, 0, 0]), d = c.getChild(0), f = c.getChild(1);
        ...
        function k(a) {
            function b(c) {
                var h = a.getSize(), m = CKEDITOR.document.getWindow().getViewPaneSize(), l = c.data.$.screenX, n = c.data.$.screenY, p = l - d.x, w = n - d.y;
                d = {x: l, y: n};
                f.x += p;
                f.y += w;
                a.move(f.x + k[3] < g ? -k[3] : f.x - k[1] > m.width - h.width - g ? m.width - h.width + ("rtl" == e.lang.dir ? 0 : k[1]) : f.x, f.y + k[0] < g ? -k[0] : f.y - k[2] > m.height - h.height - g ? m.height - h.height + k[2] : f.y, 1);
            ...
            var d = null, f = null, e = a.getParentEditor(), g = e.config.dialog_magnetDistance, k = CKEDITOR.skin.margins || [0, 0, 0, 0];
        ...
        function g(a) {
            function b(c) {
                var n = "rtl" == e.lang.dir, p = l.width, w = l.height, x = p + (c.data.$.screenX - m.x) * (n ? -1 : 1) * (a._.moved ? 1 : 2), v = w + (c.data.$.screenY - m.y) * (a._.moved ? 1 : 2), t = a._.element.getFirst(), t = n && t.getComputedStyle("right"), r = a.getPosition();
                r.y + v > h.height && (v = h.height - r.y);
                (n ? t : r.x) + x > h.width && (x = h.width - (n ? t : r.x));
                if (f == CKEDITOR.DIALOG_RESIZE_WIDTH || f == CKEDITOR.DIALOG_RESIZE_BOTH)p = Math.max(d.minWidth ||
                    0, x - g);
                if (f == CKEDITOR.DIALOG_RESIZE_HEIGHT || f == CKEDITOR.DIALOG_RESIZE_BOTH)w = Math.max(d.minHeight || 0, v - k);
                a.resize(p, w);
                a._.moved || a.layout();
                c.data.preventDefault()
            }
            ...
            var d = a.definition, f = d.resizable;
            if (f != CKEDITOR.DIALOG_RESIZE_NONE) {
                var e = a.getParentEditor(),
                    g, k, h, m, l, n, p = CKEDITOR.tools.addFunction(function (d) {
                        l = a.getSize();
                        ...
                        CKEDITOR.document.on("mousemove", b);
                        CKEDITOR.document.on("mouseup", c);
                        CKEDITOR.env.ie6Compat && (f = y.getChild(0).getFrameDocument(), f.on("mousemove", b), f.on("mouseup", c));
                ...
                a.on("load", function () {
                    ...
                    b = CKEDITOR.dom.element.createFromHtml('\x3cdiv class\x3d"cke_resizer' + b + " cke_resizer_" + e.lang.dir + '" title\x3d"' + CKEDITOR.tools.htmlEncode(e.lang.common.resize) +
                        '" onmousedown\x3d"CKEDITOR.tools.callFunction(' + p + ', event )"\x3e' + ("ltr" == e.lang.dir ? "◢" : "◣") + "\x3c/div\x3e");
        ...
        function u(a) {
            var b = CKEDITOR.document.getWindow(), c = a.config, d = c.dialog_backgroundCoverColor || "white", f = c.dialog_backgroundCoverOpacity, e = c.baseFloatZIndex, c = CKEDITOR.tools.genKey(d, f, e), g = E[c];
            g ? g.show() : (e = ['\x3cdiv tabIndex\x3d"-1" style\x3d"position: ', CKEDITOR.env.ie6Compat ?
                "absolute" : "fixed", "; z-index: ", e, "; top: 0px; left: 0px; ", CKEDITOR.env.ie6Compat ? "" : "background-color: " + d, '" class\x3d"cke_dialog_background_cover"\x3e'], CKEDITOR.env.ie6Compat && (d = "\x3chtml\x3e\x3cbody style\x3d\\'background-color:" + d + ";\\'\x3e\x3c/body\x3e\x3c/html\x3e", e.push('\x3ciframe hidefocus\x3d"true" frameborder\x3d"0" id\x3d"cke_dialog_background_iframe" src\x3d"javascript:'), e.push("void((function(){" + encodeURIComponent("document.open();(" + CKEDITOR.tools.fixDomain + ")();document.write( '" +
                    d + "' );document.close();") + "})())"), e.push('" style\x3d"position:absolute;left:0;top:0;width:100%;height: 100%;filter: progid:DXImageTransform.Microsoft.Alpha(opacity\x3d0)"\x3e\x3c/iframe\x3e')), e.push("\x3c/div\x3e"), g = CKEDITOR.dom.element.createFromHtml(e.join("")), g.setOpacity(void 0 !== f ? f : .5), g.on("keydown", n), g.on("keypress", n), g.on("keyup", n), g.appendTo(CKEDITOR.document.getBody()), E[c] = g);
        ...
        function q(a) {
            y && (a.focusManager.remove(y),
                a = CKEDITOR.document.getWindow(), y.hide(), a.removeListener("resize", z), CKEDITOR.env.ie6Compat && a.$.setTimeout(function () {
        ...
        CKEDITOR.dialog = function (b, f) {
            ...
            function l(a) {
                ...
                if (!(1 > b.length)) {
                    ...
                    var f = c, e = 1 < y._.pageCount;
                    do {
                        f += a;
                        if (e && !y._.tabBarMode && (f == b.length || -1 == f)) {
                            y._.tabBarMode = !0;
            ...
            function n(c) {
                if (y == CKEDITOR.dialog._.currentTop) {
                    var d = c.data.getKeystroke(), f = "rtl" == b.lang.dir, g = [37, 38, 39, 40];
                    u = z = 0;
                    if (9 == d || d == CKEDITOR.SHIFT + 9)l(d == CKEDITOR.SHIFT + 9 ? -1 : 1), u = 1; else if (d == CKEDITOR.ALT + 121 && !y._.tabBarMode && 1 < y.getPageCount())y._.tabBarMode = !0, y._.tabs[y._.currentTabId][0].focus(), y._.currentFocusIndex = -1, u = 1; else if (-1 != CKEDITOR.tools.indexOf(g,
                        ...
                        this._.tabBarMode = !1, this._.currentFocusIndex = -1, l(1), u = 1;
                    w(c)
                }
            }

            function w(a) {
                u ? a.data.preventDefault(1) : z && a.data.stopPropagation()
            }

            var x = CKEDITOR.dialog._.dialogDefinitions[f], v = CKEDITOR.tools.clone(p), r = b.config.dialog_buttonsOrder || "OS", q = b.lang.dir, B = {}, u, z;
            ("OS" == r && CKEDITOR.env.mac || "rtl" == r && "ltr" == q || "ltr" == r && "rtl" == q) && v.buttons.reverse();
            x = CKEDITOR.tools.extend(x(b), v);
            ...
            if (b._.removeDialogTabs && (B = b._.removeDialogTabs[f]))for (q = 0; q < B.length; q++)x.removeContents(B[q]);
            if (x.onLoad)this.on("load", x.onLoad);
            if (x.onShow)this.on("show", x.onShow);
            if (x.onHide)this.on("hide", x.onHide);
            if (x.onOk)this.on("ok", function (a) {
                b.fire("saveSnapshot");
                setTimeout(function () {
                    b.fire("saveSnapshot")
                }, 0);
            ...
            var y = this, A = function (a) {
                var b = y._.contents, c = !1, d;
                for (d in b)for (var f in b[d])if (c = a.call(this, b[d][f]))return
            };
            this.on("ok", function (a) {
                A(function (b) {
                    if (b.validate) {
                        var d = b.validate(this), f = "string" == typeof d || !1 === d;
                        f && (a.data.hide = !1, a.stop());
                        c.call(b, !f, "string" == typeof d ?
                            d : void 0);
                        return f
                    }
                })
            ...
            this.on("show", function () {
                ...
                b.config.dialog_startupFocusTab && a ? (y._.tabBarMode = !0, y._.tabs[y._.currentTabId][0].focus(), y._.currentFocusIndex = -1) : this._.hasFocus || (this._.currentFocusIndex = a ? -1 : this._.focusList.length - 1, x.onFocus ?
                (a = x.onFocus.call(this)) && a.focus() : l(1))
            ...
            for (q = 0; q < x.contents.length; q++)(B = x.contents[q]) && this.addPage(B);
            ...
            for (q = 0; q < B.length; q++)this._.buttons[B[q].id] = B[q]
        };
        CKEDITOR.dialog.prototype = {
            destroy: function () {
                ...
                var d = this._.element.getFirst(), f = "rtl" == this._.editor.lang.dir, e = "fixed" == d.getComputedStyle("position");
                CKEDITOR.env.ie && d.setStyle("zoom", "100%");
                e && this._.position && this._.position.x == a && this._.position.y == b || (this._.position = {
                    x: a,
                    y: b
                }, e || (e = CKEDITOR.document.getWindow().getScrollPosition(), a += e.x, b += e.y), f && (e = this.getSize(), a = CKEDITOR.document.getWindow().getViewPaneSize().width - e.width - a), b = {top: (0 < b ? b : 0) + "px"},
                ...
                null === CKEDITOR.dialog._.currentTop ? (CKEDITOR.dialog._.currentTop = this, this._.parentDialog = null, u(this._.editor)) : (this._.parentDialog = CKEDITOR.dialog._.currentTop, this._.parentDialog.getElement().getFirst().$.style.zIndex -= Math.floor(this._.editor.config.baseFloatZIndex / 2), CKEDITOR.dialog._.currentTop = this);
                a.on("keydown", C);
                a.on("keyup", G);
                this._.hasFocus = !1;
                ...
                CKEDITOR.env.ie6Compat || (b.height + (0 < f ? f : 0) > c.height ||
            ...
            commitContent: function () {
                ...
                if (!a.requiredContent || this._.editor.filter.check(a.requiredContent)) {
                    ...
                    c = CKEDITOR.dom.element.createFromHtml(['\x3ca class\x3d"cke_dialog_tab"', 0 < this._.pageCount ? " cke_last" : "cke_first", c, a.hidden ? ' style\x3d"display:none"' : "", ' id\x3d"', f, '"', d.gecko && !d.hc ? "" : ' href\x3d"javascript:void(0)"',
        ...
        var p = {
            ...
            for (var d = 0, f; f = a[d]; d++)if (f.id == b || c && f[c] && (f = w(f[c],
                    b, c)))return f;
            return null
            ...
            if (c) {
                for (var e = 0, g; g = a[e]; e++) {
                    ...
                    if (d && g[d] && (g = x(g[d], b, c, d, !0)))return g
                }
                if (f)return null
            }
            a.push(b);
        ...
        t.prototype = {
            getContents: function (a) {
                ...
                return x(this.contents, a, b)
            }, addButton: function (a, b) {
                return x(this.buttons, a, b)
        ...
        h.prototype = {
            get: function (a) {
                ...
                return x(this.elements, a, b, "children")
            }, remove: function (a) {
                B(this.elements, a, "children")
            }
        };
        var z, E = {}, y, A = {}, C = function (a) {
            var b = a.data.$.ctrlKey || a.data.$.metaKey, c =
                a.data.$.altKey, d = a.data.$.shiftKey, f = String.fromCharCode(a.data.$.keyCode);
            (b = A[(b ? "CTRL+" : "") + (c ? "ALT+" : "") + (d ? "SHIFT+" : "") + f]) && b.length && (b = b[b.length - 1], b.keydown && b.keydown.call(b.uiElement, b.dialog, b.key), a.data.preventDefault())
        }, G = function (a) {
            var b = a.data.$.ctrlKey || a.data.$.metaKey, c = a.data.$.altKey, d = a.data.$.shiftKey, f = String.fromCharCode(a.data.$.keyCode);
            (b = A[(b ? "CTRL+" : "") + (c ? "ALT+" : "") + (d ? "SHIFT+" : "") + f]) && b.length && (b = b[b.length - 1], b.keyup && (b.keyup.call(b.uiElement, b.dialog, b.key),
                a.data.preventDefault()))
        ...
        (function () {
            CKEDITOR.ui.dialog = {
                uiElement: function (a, b, c, d, f, e, g) {
                    if (!(4 > arguments.length)) {
                        var k = (d.call ? d(b) : d) || "div",
                            h = ["\x3c", k, " "], m = (f && f.call ? f(b) : f) || {}, l = (e && e.call ? e(b) : e) || {}, n = (g && g.call ? g.call(this, a, b) : g) || "", p = this.domId = l.id || CKEDITOR.tools.getNextId() + "_uiElement";
                        ...
                        for (var x = l["class"] && l["class"].split ? l["class"].split(" ") : [], p = 0; p < x.length; p++)x[p] && (w[x[p]] = 1);
                        x = [];
                        for (p in w)x.push(p);
                        l["class"] = x.join(" ");
                        b.title && (l.title = b.title);
                        w = (b.style || "").split(";");
                        b.align && (x = b.align, m["margin-left"] = "left" == x ? 0 : "auto", m["margin-right"] = "right" == x ? 0 : "auto");
                        ...
                        for (p in l)h.push(p + '\x3d"' + CKEDITOR.tools.htmlEncode(l[p]) + '" ');
                    ...
                    if (!(4 > arguments.length)) {
                        this._ || (this._ = {});
                        var e = this._.children = b, g = f && f.widths || null, k = f && f.height || null, h, m = {role: "presentation"};
                        f && f.align && (m.align = f.align);
                        CKEDITOR.ui.dialog.uiElement.call(this, a, f || {type: "hbox"}, d, "table", {}, m, function () {
                            ...
                            for (h = 0; h < c.length; h++) {
                                ...
                                g ? g[h] && d.push("width:" + v(g[h])) : d.push("width:" + Math.floor(100 / c.length) + "%");
                                k && d.push("height:" + v(k));
                                f && void 0 !== f.padding && d.push("padding:" + v(f.padding));
                                CKEDITOR.env.ie && CKEDITOR.env.quirks && e[h].align && d.push("text-align:" + e[h].align);
                ...
                vbox: function (a, b, c, d, f) {
                    if (!(3 > arguments.length)) {
                        this._ || (this._ = {});
                        var e = this._.children = b, g = f && f.width || null, k = f && f.heights || null;
                        CKEDITOR.ui.dialog.uiElement.call(this, a, f || {type: "vbox"}, d, "div", null, {role: "presentation"}, function () {
                            ...
                            b.push('"');
                            b.push('align\x3d"', CKEDITOR.tools.htmlEncode(f &&
                                f.align || ("ltr" == a.getParentEditor().lang.dir ? "left" : "right")), '" ');
                            b.push("\x3e\x3ctbody\x3e");
                            for (var d = 0; d < c.length; d++) {
                                var h = [];
                                b.push('\x3ctr\x3e\x3ctd role\x3d"presentation" ');
                                g && h.push("width:" + v(g || "100%"));
                                k ? h.push("height:" + v(k[d])) : f && f.expand && h.push("height:" + Math.floor(100 / c.length) + "%");
                                f && void 0 !== f.padding && h.push("padding:" + v(f.padding));
        ...
        (function () {
            var a = {
                build: function (a, b, c) {
                    for (var d = b.children, f, e = [], g = [], k = 0; k < d.length && (f = d[k]); k++) {
                        var h = [];
                        e.push(h);
                ...
                functions: function () {
                    ...
                    return function () {
                        var b = this && this.getValue ? this.getValue() :
                            a[0], c, d = CKEDITOR.VALIDATE_AND, f = [], e;
                        for (e = 0; e < a.length; e++)if ("function" == typeof a[e])f.push(a[e]); else break;
        ...
        CKEDITOR.tools.extend(CKEDITOR.editor.prototype, {
            openDialog: function (a, b) {
                ...
                null === CKEDITOR.dialog._.currentTop && u(this);
        ...
        CKEDITOR.plugins.add("a11yhelp", {
            ...
            init: function (a) {
                ...
                a.addCommand("a11yHelp", {
                    exec: function () {
                        var b =
                            a.langCode, b = e.availableLangs[b] ? b : e.availableLangs[b.replace(/-.*/, "")] ? b.replace(/-.*/, "") : "en";
        ...
        CKEDITOR.plugins.add("blockquote", {
            init: function (e) {
                e.blockless ||
                (e.addCommand("blockquote", a), e.ui.addButton && e.ui.addButton("Blockquote", {
        ...
        function e(b) {
            function c() {
                ...
                a.on(A.mainPasteEvent, function (a) {
                    "beforepaste" == A.mainPasteEvent && C || z(a)
                });
                "beforepaste" == A.mainPasteEvent && (a.on("paste", function (a) {
                    G || (e(), a.data.preventDefault(), z(a), h("paste") || b.openDialog("paste"))
                }), a.on("contextmenu", k, null, null, 0),
            ...
            function d(a) {
                return {
                    ...
                    exec: function () {
                        ...
                        var a;
                        var c = this.type;
                        if (CKEDITOR.env.ie)a = h(c); else try {
            ...
            function l(a, c) {
                ...
                if (!d.getById("cke_pastebin")) {
                    var h = b.getSelection(), m = h.createBookmarks();
                    ...
                    CKEDITOR.env.webkit ? (f.append(n), n.addClass("cke_editable"), f.is("body") || (p = "static" != f.getComputedStyle("position") ?
                        f : CKEDITOR.dom.element.get(f.$.offsetParent), p = p.getDocumentPosition().y)) : f.getAscendant(CKEDITOR.env.ie ? "body" : "html", 1).append(n);
                    n.setStyles({
                        position: "absolute",
                    ...
                    (p = n.getParent().isReadOnly()) ? (n.setOpacity(0), n.setAttribute("contenteditable", !0)) : n.setStyle("ltr" == b.config.contentsLangDirection ?
                        "left" : "right", "-1000px");
                    b.on("selectionChange", e, null, null, 0);
                    if (CKEDITOR.env.webkit || CKEDITOR.env.gecko)k = f.once("blur", e, null, null, -100);
                    p && n.focus();
                    p = new CKEDITOR.dom.range(n);
                    p.selectNodeContents(n);
                    var w = p.select();
                    CKEDITOR.env.ie && (k = f.once("blur", function () {
                        b.lockSelection(w)
                    }));
            ...
            function B() {
                ...
                a.lock();
                if (b.editable().fire(A.mainPasteEvent) && !h("paste"))return a.unlock(), !1;
                a.unlock();
                return !0
            }
            ...
            b.getClipboardData = function (a, c) {
                ...
                !1 === B() && (b.removeListener("paste", d), k && b.fire("pasteDialog", e) ? (b.on("pasteDialogCommit", f), b.on("dialogHide", function (a) {
                    a.removeListener();
        ...
        function h(b) {
            ...
            b.on("contentDom", function () {
                ...
                var h = b.editable(), m = CKEDITOR.plugins.clipboard.getDropTarget(b), l = b.ui.space("top"), B = b.ui.space("bottom");
                c.preventDefaultDropOnElement(l);
                c.preventDefaultDropOnElement(B);
                h.attachListener(m, "dragstart", e);
                ...
                h.attachListener(b, "dragstart", function () {
                    ...
                    CKEDITOR.env.ie && 10 > CKEDITOR.env.version && (c.dragStartContainerChildCount =
                        a ? k(a.startContainer) : null, c.dragEndContainerChildCount = a ? k(a.endContainer) : null)
                }, null, null, 100);
                h.attachListener(m, "dragend", e);
                h.attachListener(b, "dragend", c.initDragDataTransfer, c, null, 1);
                ...
                h.attachListener(b, "drop", function (a) {
                    if (a = a.data) {
                        var e = a.dropRange, k = a.dragRange, h = a.dataTransfer;
                        h.getTransferType(b) == CKEDITOR.DATA_TRANSFER_INTERNAL ? setTimeout(function () {
                            c.internalDrop(k,
                                e, h, b)
                        }, 0) : h.getTransferType(b) == CKEDITOR.DATA_TRANSFER_CROSS_EDITORS ? d(k, e, h) : f(e, h)
                    }
                }, null, null, 9999)
            })
        }
            ...
            requires: "dialog", init: function (a) {
                ...
                a.on("paste", function (a) {
                    ...
                    if (b.match(/^<[^<]+cke_(editable|contents)/i)) {
                        ...
                        for (e.setHtml(b); 1 == e.getChildCount() && (d = e.getFirst()) && d.type == CKEDITOR.NODE_ELEMENT && (d.hasClass("cke_editable") ||
                        d.hasClass("cke_contents"));)e = f = d;
                ...
                a.on("paste", function (d) {
                        d = d.data;
                        var f = d.type, e = d.dataValue, h, l = a.config.clipboard_defaultContentType ||
                            "html", n = d.dataTransfer.getTransferType(a);
        ...
        CKEDITOR.plugins.clipboard = {
            ...
            fixSplitNodesAfterDrop: function (a, b, c, d) {
                function f(a, c, d) {
                    ...
                    if (e.equals(c) && d != c.getChildCount())return a =
            ...
            isDropRangeAffectedByDragRange: function (a, b) {
                ...
                return a.endContainer.equals(c) &&
            ...
            internalDrop: function (b, c, d, f) {
                var e = CKEDITOR.plugins.clipboard, k = f.editable(), h, m;
                f.fire("saveSnapshot");
            ...
            getRangeAtDropPosition: function (a, b) {
                var c = a.data.$, d = c.clientX, f = c.clientY, e = b.getSelection(!0).getRanges()[0], k =
                    b.createRange();
                if (a.data.testRange)return a.data.testRange;
                if (document.caretRangeFromPoint)c = b.document.$.caretRangeFromPoint(d, f), k.setStart(CKEDITOR.dom.node(c.startContainer), c.startOffset), k.collapse(!0); else if (c.rangeParent)k.setStart(CKEDITOR.dom.node(c.rangeParent), c.rangeOffset), k.collapse(!0); else {
                    ...
                    if (document.body.createTextRange) {
                        ...
                        try {
                            ...
                            if (h) {
                                ...
                                var E = b.document.getById(z);
                                k.moveToPosition(E, CKEDITOR.POSITION_BEFORE_START);
                                E.remove()
                            } else {
                                var y = b.document.$.elementFromPoint(d, f), A = new CKEDITOR.dom.element(y), C;
                                if (A.equals(b.editable()) || "html" == A.getName())return e && e.startContainer && !e.startContainer.equals(b.editable()) ? e : null;
                                C = A.getClientRect();
                                d < C.left ? k.setStartAt(A, CKEDITOR.POSITION_AFTER_START) : k.setStartAt(A, CKEDITOR.POSITION_BEFORE_END);
                                k.collapse(!0)
                            }
                        } catch (G) {
                            return null
        ...
        CKEDITOR.plugins.clipboard.dataTransfer.prototype = {
            getData: function (a) {
                ...
                "text/html" == a ? (b = b.replace(this._.metaRegExp, ""), (a = this._.bodyRegExp.exec(b)) && a.length && (b = a[1], b = b.replace(this._.fragmentRegExp, ""))) : "Text" == a && CKEDITOR.env.gecko && this.getFilesCount() && "file://" == b.substring(0,
                    7) && (b = "");
                return b
            }, setData: function (a, b) {
                a = this._.normalizeType(a);
        ...
        CKEDITOR.ui.panel.prototype = {
            render: function (c, d) {
                ...
                if (this.isFramed) {
                    var l = CKEDITOR.env.air ? "javascript:void(0)" :
                        CKEDITOR.env.ie ? "javascript:void(function(){" + encodeURIComponent("document.open();(" + CKEDITOR.tools.fixDomain + ")();document.close();") + "}())" : "";
                ...
                a = this._.blocks[a];
                var b =
                    this._.currentBlock, e = !this.forceIFrame || CKEDITOR.env.ie ? this._.holder : this.document.getById(this.id + "_frame");
                b && b.hide();
        ...
        function a(a, c, d, m, l) {
            ...
            var f = e[l];
            f || (f = e[l] = new CKEDITOR.ui.panel(c,
                m), f.element = d.append(CKEDITOR.dom.element.createFromHtml(f.render(a), c)), f.element.setStyles({
                display: "none",
                position: "absolute"
            }));
            return f
        ...
        CKEDITOR.ui.floatPanel = CKEDITOR.tools.createClass({
            $: function (b, c, d, e) {
                ...
                addBlock: function (a, c) {
                    ...
                    var n = this.element, g = this._.iframe, g = CKEDITOR.env.ie && !CKEDITOR.env.edge ? g : new CKEDITOR.dom.window(g.$.contentWindow), u = n.getDocument(), q = this._.parentElement.getPositionedAncestor(), v = c.getDocumentPosition(u), u = q ? q.getDocumentPosition(u) : {
                        x: 0,
                        y: 0
                    }, r = "rtl" == this._.dir, p = v.x + (e || 0) - u.x, w = v.y + (l || 0) - u.y;
                    !r || 1 != d && 4 != d ? r || 2 != d && 3 != d || (p += c.$.offsetWidth -
                        1) : p += c.$.offsetWidth;
                    ...
                    CKEDITOR.tools.setTimeout(function () {
                        var a = CKEDITOR.tools.bind(function () {
                            ...
                            a.removeStyle("width");
                            if (k.autoSize) {
                                var b = k.element.getDocument(), b = (CKEDITOR.env.webkit ? k.element : b.getBody()).$.scrollWidth;
                            ...
                            var b = h.element.getWindow(), a = n.$.getBoundingClientRect(), b = b.getViewPaneSize(), c = a.width || a.right - a.left, d = a.height || a.bottom - a.top, e = r ? a.right : b.width - a.left, g = r ? b.width - a.right : a.left;
                            r ? e < c && (p = g > c ? p + c : b.width > c ? p - a.left : p - a.right + b.width) : e < c && (p = g > c ? p - c : b.width > c ? p - a.right + b.width : p - a.left);
                            c = a.top;
                            ...
                            (b = b.getDocument().getBody()), "rtl" == b.getComputedStyle("direction") && (p = CKEDITOR.env.ie8Compat ? p - 2 * n.getDocument().getDocumentElement().$.scrollLeft : p - (a.$.scrollWidth - a.$.clientWidth)));
                            var a = n.getFirst(), m;
                    ...
                    }, this), this._.activeChild = a, this._.focused = !1, a.showBlock(c, d, e, l, f), this.blur(),
        ...
        CKEDITOR.menu = CKEDITOR.tools.createClass({
            $: function (a, b) {
                ...
                onShow: function () {
                    var a = this.editor.getSelection(), b = a && a.getStartElement(), c = this.editor.elementPath(), f = this._.listeners;
                    this.removeAll();
                ...
                add: function (a) {
                    ...
                    if (!g) {
                        ...
                        u["rtl" == k.lang.dir ? 37 : 39] = CKEDITOR.env.ie ? "mouseup" : "click";
                        u[32] = CKEDITOR.env.ie ? "mouseup" :
                            "click";
                    ...
                    a(h);
                    for (var u = k.elementPath(), u = ['\x3cdiv class\x3d"cke_menu' + (u && u.direction() != k.lang.dir ? " cke_mixed_dir_content" : "") + '" role\x3d"presentation"\x3e'], q = h.length, v = q && h[0].group, r = 0; r < q; r++) {
                        var p = h[r];
                        v != p.group && (u.push('\x3cdiv class\x3d"cke_menuseparator" role\x3d"separator"\x3e\x3c/div\x3e'),
                            v = p.group);
                        p.render(this, r, u)
                    }
                    u.push("\x3c/div\x3e");
        ...
        CKEDITOR.menuItem = CKEDITOR.tools.createClass({
            $: function (a, b, c) {
                ...
                render: function (a, e, l) {
                    ...
                    var n = this.getItems, u = "\x26#" + ("rtl" == this.editor.lang.dir ? "9668" : "9658") + ";", q = this.name;
                    this.icon && !/\./.test(this.icon) && (q =
                        this.icon);
                    a = {
                        id: f,
                        name: this.name,
                        ...
                        a.on("contextmenu", function (a) {
                            ...
                            if (!e || !c) {
                                ...
                                if (CKEDITOR.env.mac && CKEDITOR.env.webkit) {
                                    var c = this.editor, l = (new CKEDITOR.dom.elementPath(a.getTarget(), c.editable())).contains(function (a) {
                                        return a.hasAttribute("contenteditable")
                                    }, !0);
                                    l && "false" == l.getAttribute("contenteditable") && c.getSelection().fake(l)
                                }
                                var l = a.getTarget().getDocument(), f = a.getTarget().getDocument().getDocumentElement(), c = !l.equals(CKEDITOR.document),
                                    l = l.getWindow().getScrollPosition(), h = c ? a.$.clientX : a.$.pageX || l.x + a.$.clientX, k = c ? a.$.clientY : a.$.pageY || l.y + a.$.clientY;
                                CKEDITOR.tools.setTimeout(function () {
        ...
        function a(a, b) {
            ...
            g.onClick = l;
            var u = CKEDITOR.tools.addFunction(l), q = CKEDITOR.tools.addFunction(function (b, c) {
                var f = g.idBase, e;
                ...
                switch (c.getKeystroke()) {
                    ...
                    case CKEDITOR.SHIFT + 9:
                        return (e = CKEDITOR.document.getById(f + (b - 1))) || (e = CKEDITOR.document.getById(f + (g.list.length -
                            1))), e.focus(), !1;
                    case 27:
                        return a.focus(), !1;
                    case 13:
            ...
            a.on("selectionChange", function () {
                for (var b = [], f = g.list = [], e = [], m = g.filters, l = !0, B = a.elementPath().elements, t, z = B.length; z--;) {
                    var E = B[z], y = 0;
                    t = E.data("cke-display-name") ? E.data("cke-display-name") : E.data("cke-real-element-type") ? E.data("cke-real-element-type") : E.getName();
                    (l = E.hasAttribute("contenteditable") ? "true" == E.getAttribute("contenteditable") : l) || E.hasAttribute("contenteditable") || (y = 1);
                    ...
                    y || (f.unshift(E), e.unshift(t))
                }
                f = f.length;
                for (m = 0; m < f; m++)t = e[m], l = a.lang.elementspath.eleTitle.replace(/%1/, t), t = c.output({
                    id: n + m,
                    label: l,
                    text: t,
        ...
        CKEDITOR.plugins.add("indent", {
            init: function (b) {
                ...
                b.on("dirChanged", function (a) {
                    ...
                    d.setStartBefore(f);
                    d.setEndAfter(f);
                    for (var e = new CKEDITOR.dom.walker(d), k; k = e.next();)if (k.type == CKEDITOR.NODE_ELEMENT)if (!k.equals(f) && k.getDirection())d.setStartAfter(k),
                        e = new CKEDITOR.dom.walker(d); else {
                        var g = b.config.indentClasses;
                        if (g)for (var n = "ltr" == a.data.dir ? ["_rtl", ""] : ["", "_rtl"], u = 0; u < g.length; u++)k.hasClass(g[u] + n[0]) && (k.removeClass(g[u] + n[0]), k.addClass(g[u] + n[1]));
        ...
        CKEDITOR.plugins.indent.specificDefinition.prototype = {
            execJob: function (a, b) {
                ...
                a.activeFilter.checkFeature(this) ?
                    b.state = b.refresh.call(this, a, m) : b.state = e;
                return b.state
        ...
        function a(a) {
            function c(e) {
                for (var h = q.startContainer, l = q.endContainer; h && !h.getParent().equals(e);)h = h.getParent();
                for (; l && !l.getParent().equals(e);)l = l.getParent();
                if (!h || !l)return !1;
                for (var v = h, h = [], r = !1; !r;)v.equals(l) && (r = !0), h.push(v), v = v.getNext();
                if (1 > h.length)return !1;
                v = e.getParents(!0);
                for (l = 0; l < v.length; l++)if (v[l].getName && m[v[l].getName()]) {
                    e = v[l];
                    break
                }
                for (var v =
                    d.isIndent ? 1 : -1, l = h[0], h = h[h.length - 1], r = CKEDITOR.plugins.list.listToArray(e, g), z = r[h.getCustomData("listarray_index")].indent, l = l.getCustomData("listarray_index"); l <= h.getCustomData("listarray_index"); l++)if (r[l].indent += v, 0 < v) {
                    var u = r[l].parent;
                    r[l].parent = new CKEDITOR.dom.element(u.getName(), u.getDocument())
                }
                for (l = h.getCustomData("listarray_index") + 1; l < r.length && r[l].indent > z; l++)r[l].indent += v;
                h = CKEDITOR.plugins.list.arrayToList(r, g, null, a.config.enterMode, e.getDirection());
                if (!d.isIndent) {
                    var y;
                    if ((y = e.getParent()) && y.is("li"))for (var v = h.listNode.getChildren(), A = [], C, l = v.count() - 1; 0 <= l; l--)(C = v.getItem(l)) && C.is && C.is("li") && A.push(C)
                }
                h && h.listNode.replace(e);
                if (A && A.length)for (l = 0; l < A.length; l++) {
                    for (C = e = A[l]; (C = C.getNext()) && C.is && C.getName() in m;)CKEDITOR.env.needsNbspFiller && !e.getFirst(b) && e.append(q.document.createText(" ")), e.append(C);
                    e.insertAfter(y)
                }
            ...
            for (var d = this, g = this.database, m = this.context, l = a.getSelection(), l = (l && l.getRanges()).createIterator(),
                     q; q = l.getNextRange();) {
                for (var v = q.getCommonAncestor(); v && (v.type != CKEDITOR.NODE_ELEMENT || !m[v.getName()]);) {
                ...
                v || (v = q.startPath().contains(m)) && q.setEndAt(v, CKEDITOR.POSITION_BEFORE_END);
                if (!v) {
                    var r = q.getEnclosedNode();
                    r && r.type == CKEDITOR.NODE_ELEMENT && r.getName() in m && (q.setStartAt(r, CKEDITOR.POSITION_AFTER_START), q.setEndAt(r, CKEDITOR.POSITION_BEFORE_END), v = r)
                }
                v && q.startContainer.type == CKEDITOR.NODE_ELEMENT && q.startContainer.getName() in m && (r =
                    new CKEDITOR.dom.walker(q), r.evaluator = e, q.startContainer = r.next());
                v && q.endContainer.type == CKEDITOR.NODE_ELEMENT && q.endContainer.getName() in m && (r = new CKEDITOR.dom.walker(q), r.evaluator = e, q.endContainer = r.previous());
                if (v)return c(v)
            }
            return 0
        }
        ...
        var c = CKEDITOR.dom.walker.whitespaces(!0), d = CKEDITOR.dom.walker.bookmark(!1, !0), m = CKEDITOR.TRISTATE_DISABLED, l = CKEDITOR.TRISTATE_OFF;
        ...
        function () {
            function a(a, b, c) {
                function d(c) {
                    if (!(!(l = h[c ? "getFirst" : "getLast"]()) || l.is && l.isBlockBoundary() || !(m = b.root[c ? "getPrevious" : "getNext"](CKEDITOR.dom.walker.invisible(!0))) || m.is && m.isBlockBoundary({br: 1})))a.document.createElement("br")[c ? "insertBefore" : "insertAfter"](l)
                }

                for (var f = CKEDITOR.plugins.list.listToArray(b.root, c), e = [], g = 0; g < b.contents.length; g++) {
                    var k = b.contents[g];
                    (k = k.getAscendant("li", !0)) && !k.getCustomData("list_item_processed") && (e.push(k), CKEDITOR.dom.element.setMarker(c,
                        k, "list_item_processed", !0))
                }
                k = null;
                for (g = 0; g < e.length; g++)k = e[g].getCustomData("listarray_index"), f[k].indent = -1;
                for (g = k + 1; g < f.length; g++)if (f[g].indent > f[g - 1].indent + 1) {
                    e = f[g - 1].indent + 1 - f[g].indent;
                    for (k = f[g].indent; f[g] && f[g].indent >= k;)f[g].indent += e, g++;
                    g--
                }
                var h = CKEDITOR.plugins.list.arrayToList(f, c, null, a.config.enterMode, b.root.getAttribute("dir")).listNode, l, m;
                d(!0);
                d();
                h.replace(b.root);
            ...
            function m(a, d, f) {
                ...
                d.trim(!1, !0);
                var k = d.createBookmark(), h = new CKEDITOR.dom.elementPath(d.startContainer), m = h.block, h = h.lastElement.getAscendant("li", 1) || m, q = new CKEDITOR.dom.elementPath(f.startContainer), u = q.contains(CKEDITOR.dtd.$listItem), q = q.contains(CKEDITOR.dtd.$list);
                ...
                u && (e = l(u)) && (h.contains(u) ? (b(e, u.getParent(), u), e.remove()) : h.append(e));
                for (; f.checkStartOfBlock() && f.checkEndOfBlock();) {
                    q = f.startPath();
                    e = q.block;
                    if (!e)break;
                    e.is("li") && (h = e.getParent(), e.equals(h.getLast(g)) && e.equals(h.getFirst(g)) && (e = h));
                ...
                listToArray: function (a, b, c, d, e) {
                    ...
                    for (var g = 0, k = a.getChildCount(); g < k; g++) {
                        ...
                        if ("li" == h.$.nodeName.toLowerCase()) {
                            ...
                            c.push(m);
                            for (var l = 0, n = h.getChildCount(), q; l < n; l++)q = h.getChild(l), q.type == CKEDITOR.NODE_ELEMENT && f[q.getName()] ? CKEDITOR.plugins.list.listToArray(q, b, c, d + 1, m.grandparent) : m.contents.push(q)
                        }
                    }
                    return c
                    ...
                    for (var h, m = a[c].parent.getDocument(), l = new CKEDITOR.dom.documentFragment(m), n = null, q = c, u = Math.max(a[c].indent, 0), C = null, G, F, I = d == CKEDITOR.ENTER_P ? "p" : "div"; ;) {
                        var H = a[q];
                        h = H.grandparent;
                        G = H.element.getDirection(1);
                        if (H.indent == u) {
                            n && a[q].parent.getName() ==
                            n.getName() || (n = a[q].parent.clone(!1, 1), e && n.setAttribute("dir", e), l.append(n));
                            ...
                            q++
                        } else if (H.indent == Math.max(u, 0) + 1)H = a[q - 1].element.getDirection(1), q = CKEDITOR.plugins.list.arrayToList(a, null, q, d, H != G ? G : null), !C.getChildCount() && CKEDITOR.env.needsNbspFiller && 7 >= m.$.documentMode && C.append(m.createText(" ")), C.append(q.listNode), q = q.nextIndex; else if (-1 ==
                            H.indent && !c && h) {
                            f[h.getName()] ? (C = H.element.clone(!1, !0), G != h.getDirection(1) && C.setAttribute("dir", G)) : C = new CKEDITOR.dom.documentFragment(m);
                            var n = h.getDirection(1) != G, K = H.element, D = K.getAttribute("class"), N = K.getAttribute("style"), R = C.type == CKEDITOR.NODE_DOCUMENT_FRAGMENT && (d != CKEDITOR.ENTER_BR || n || N || D), P, T = H.contents.length, O;
                            ...
                            } else R ? (F || (F = m.createElement(I), C.append(F), n && F.setAttribute("dir", G)), N && F.setAttribute("style", N), D && F.setAttribute("class", D), O && (F.append(O), O = null), F.append(P.clone(1, 1))) : C.append(P.clone(1, 1));
                            O && ((F || C).append(O), O = null);
                            C.type == CKEDITOR.NODE_DOCUMENT_FRAGMENT && q != a.length - 1 && (CKEDITOR.env.needsBrFiller &&
                            (G = C.getLast()) && G.type == CKEDITOR.NODE_ELEMENT && G.is("br") && G.remove(), (G = C.getLast(g)) && G.type == CKEDITOR.NODE_ELEMENT && G.is(CKEDITOR.dtd.$block) || C.append(m.createElement("br")));
                        ...
                        F = null;
                        if (a.length <= q || Math.max(a[q].indent, 0) < u)break
                    }
                    if (b)for (a = l.getFirst(); a;) {
                        if (a.type == CKEDITOR.NODE_ELEMENT && (CKEDITOR.dom.element.clearMarkers(b, a), a.getName() in CKEDITOR.dtd.$listItem && (c = a, m = e = d = void 0, d = c.getDirection()))) {
                            for (e =
                                     c.getParent(); e && !(m = e.getDirection());)e = e.getParent();
                            d == m && c.removeAttribute("dir")
                        }
            ...
            var u = /^h[1-6]$/, q = CKEDITOR.dom.walker.nodeType(CKEDITOR.NODE_ELEMENT);
            e.prototype = {
                exec: function (b) {
                    ...
                    if (this.state == CKEDITOR.TRISTATE_OFF) {
                        var k = b.editable();
                        if (k.getFirst(g)) {
                            var m = 1 == h.length && h[0];
                            (d = m && m.getEnclosedNode()) && d.is && this.type == d.getName() && this.setState(CKEDITOR.TRISTATE_ON)
                        } else d.enterMode ==
                        CKEDITOR.ENTER_BR ? k.appendBogus() : h[0].fixBlock(1, d.enterMode == CKEDITOR.ENTER_P ? "p" : "div"), e.selectRanges(h)
                    }
                    for (var d = e.createBookmarks(!0), k = [], l = {}, h = h.createIterator(), n = 0; (m = h.getNextRange()) && ++n;) {
                        var q = m.getBoundaryNodes(), y = q.startNode, A = q.endNode;
                        y.type == CKEDITOR.NODE_ELEMENT && "td" == y.getName() && m.setStartAt(q.startNode, CKEDITOR.POSITION_AFTER_START);
                        A.type == CKEDITOR.NODE_ELEMENT && "td" == A.getName() && m.setEndAt(q.endNode, CKEDITOR.POSITION_BEFORE_END);
                        m = m.createIterator();
                        for (m.forceBrBreak =
                                 this.state == CKEDITOR.TRISTATE_OFF; q = m.getNextParagraph();)if (!q.getCustomData("list_block")) {
                            CKEDITOR.dom.element.setMarker(l, q, "list_block", 1);
                            for (var C = b.elementPath(q), y = C.elements, A = 0, C = C.blockLimit, G, F = y.length - 1; 0 <= F && (G = y[F]); F--)if (f[G.getName()] && C.contains(G)) {
                                C.removeCustomData("list_group_object_" + n);
                                (y = G.getCustomData("list_group_object")) ? y.contents.push(q) : (y = {
                                    root: G,
                                    contents: [q]
                                }, k.push(y), CKEDITOR.dom.element.setMarker(l, G, "list_group_object", y));
                                A = 1;
                                break
                            }
                            A || (A = C, A.getCustomData("list_group_object_" +
                                n) ? A.getCustomData("list_group_object_" + n).contents.push(q) : (y = {
                                root: A,
                                contents: [q]
                            }, CKEDITOR.dom.element.setMarker(l, A, "list_group_object_" + n, y), k.push(y)))
                        }
                    }
                    for (G = []; 0 < k.length;)if (y = k.shift(), this.state == CKEDITOR.TRISTATE_OFF)if (f[y.root.getName()]) {
                        h = b;
                        n = y;
                        y = l;
                        m = G;
                        A = CKEDITOR.plugins.list.listToArray(n.root, y);
                        C = [];
                        for (q = 0; q < n.contents.length; q++)F = n.contents[q], (F = F.getAscendant("li", !0)) && !F.getCustomData("list_item_processed") && (C.push(F), CKEDITOR.dom.element.setMarker(y, F, "list_item_processed",
                            !0));
                        for (var F = n.root.getDocument(), I = void 0, H = void 0, q = 0; q < C.length; q++) {
                            var K = C[q].getCustomData("listarray_index"), I = A[K].parent;
                            I.is(this.type) || (H = F.createElement(this.type), I.copyAttributes(H, {
                                start: 1,
                                type: 1
                            }), H.removeStyle("list-style-type"), A[K].parent = H)
                        }
                        y = CKEDITOR.plugins.list.arrayToList(A, y, null, h.config.enterMode);
                        A = void 0;
                        C = y.listNode.getChildCount();
                        for (q = 0; q < C && (A = y.listNode.getChild(q)); q++)A.getName() == this.type && m.push(A);
                        ...
                        q = G;
                        C = m.contents;
                        h = m.root.getDocument();
                        n = [];
                        1 == C.length && C[0].equals(m.root) && (y = h.createElement("div"), C[0].moveChildren && C[0].moveChildren(y), C[0].append(y), C[0] = y);
                        m = m.contents[0].getParent();
                        for (F = 0; F < C.length; F++)m = m.getCommonAncestor(C[F].getParent());
                        ...
                        if (!(1 > n.length)) {
                            C =
                                n[n.length - 1].getNext();
                            F = h.createElement(this.type);
                            q.push(F);
                            for (I = q = void 0; n.length;)q = n.shift(), I = h.createElement("li"), H = q, H.is("pre") || u.test(H.getName()) || "false" == H.getAttribute("contenteditable") ? q.appendTo(I) : (q.copyAttributes(I), y && q.getDirection() && (I.removeStyle("direction"), I.removeAttribute("dir")), q.moveChildren(I), q.remove()), I.appendTo(F);
                            y && A && F.setAttribute("dir", y);
                            C ? F.insertBefore(C) : F.appendTo(m)
                        }
                    } else this.state == CKEDITOR.TRISTATE_ON && f[y.root.getName()] && a.call(this, b, y, l);
                ...
                requires: "indentlist", init: function (a) {
                    ...
                    (a.ui.addButton("NumberedList", {
                        ...
                        if ("wysiwyg" == a.mode && c in {8: 1, 46: 1}) {
                            ...
                            if (h && h.collapsed) {
                                var q = 8 == c, u = a.editable(), E = new CKEDITOR.dom.walker(h.clone());
                                ...
                                if (q) {
                                    var y;
                                    (y = k.contains(f)) && h.checkBoundaryOfElement(y, CKEDITOR.START) && (y = y.getParent()) && y.is("li") && (y = l(y)) ? (e = y, y = y.getPrevious(g), c.moveToPosition(y && n(y) ? y : e, CKEDITOR.POSITION_BEFORE_START)) : (E.range.setStartAt(u, CKEDITOR.POSITION_AFTER_START), E.range.setEnd(h.startContainer, h.startOffset), (y = E.previous()) && y.type == CKEDITOR.NODE_ELEMENT && (y.getName() in f || y.is("li")) && (y.is("li") || (E.range.selectNodeContents(y),
                                        E.reset(), E.evaluator = d, y = E.previous()), e = y, c.moveToElementEditEnd(e), c.moveToPosition(c.endPath().block, CKEDITOR.POSITION_BEFORE_END)));
                                    if (e)m(a, c, h), b.cancel(); else {
                                        var A = k.contains(f);
                                        A && h.checkBoundaryOfElement(A, CKEDITOR.START) && (e = A.getFirst(g), h.checkBoundaryOfElement(e, CKEDITOR.START) && (y = A.getPrevious(g), l(e) ? y && (h.moveToElementEditEnd(y), h.select()) : a.execCommand("outdent"), b.cancel()))
                                    }
                                } else if (e = k.contains("li")) {
                                    if (E.range.setEndAt(u, CKEDITOR.POSITION_BEFORE_END), q = (u = e.getLast(g)) &&
                                        d(u) ? u : e, k = 0, (y = E.next()) && y.type == CKEDITOR.NODE_ELEMENT && y.getName() in f && y.equals(u) ? (k = 1, y = E.next()) : h.checkBoundaryOfElement(q, CKEDITOR.END) && (k = 2), k && y) {
                                        h = h.clone();
        ...
        function a(a, b, c) {
            ...
            "wysiwyg" == a.mode && (b ||
            (b = a.activeEnterMode), a.elementPath().isContextFor("p") || (b = CKEDITOR.ENTER_BR, c = 1), a.fire("saveSnapshot"), b == CKEDITOR.ENTER_BR ? l(a, b, null, c) : f(a, b, null, c), a.fire("saveSnapshot"))
        }
        ...
        CKEDITOR.plugins.enterkey = {
            enterBlock: function (a, f, m, u) {
                if (m = m || e(a)) {
                    m = b(m);
                    var q = m.document, v = m.checkStartOfBlock(),
                        r = m.checkEndOfBlock(), p = a.elementPath(m.startContainer), w = p.block, x = f == CKEDITOR.ENTER_DIV ? "div" : "p", B;
                    if (v && r) {
                        if (w && (w.is("li") || w.getParent().is("li"))) {
                            ...
                            B = m.getParent();
                            u = !w.hasPrevious();
                            var t = !w.hasNext(), x = a.getSelection(), z = x.createBookmarks(), v = w.getDirection(1), r = w.getAttribute("class"), E = w.getAttribute("style"), y = B.getDirection(1) != v;
                            a = a.enterMode != CKEDITOR.ENTER_BR || y || E || r;
                            if (B.is("li"))u || t ? (u && t && m.remove(), w[t ? "insertAfter" : "insertBefore"](B)) :
                                w.breakParent(B); else {
                                if (a)if (p.block.is("li") ? (B = q.createElement(f == CKEDITOR.ENTER_P ? "p" : "div"), y && B.setAttribute("dir", v), E && B.setAttribute("style", E), r && B.setAttribute("class", r), w.moveChildren(B)) : B = p.block, u || t)B[u ? "insertBefore" : "insertAfter"](m); else w.breakParent(m), B.insertAfter(m); else if (w.appendBogus(!0), u || t)for (; q = w[u ? "getFirst" : "getLast"]();)q[u ? "insertBefore" : "insertAfter"](m); else for (w.breakParent(m); q = w.getLast();)q.insertAfter(m);
                                w.remove()
                            }
                            x.selectBookmarks(z);
                            return
                    ...
                    if (v = m.splitBlock(x)) {
                        ...
                        p = v.wasStartOfBlock;
                        a = v.wasEndOfBlock;
                        w ? (z = w.getParent(), z.is("li") && (w.breakParent(z), w.move(w.getNext(), 1))) : f && (z = f.getParent()) && z.is("li") && (f.breakParent(z), z = f.getNext(), m.moveToElementEditStart(z),
                            f.move(f.getPrevious()));
                        if (p || a) {
                            if (f) {
                                if (f.is("li") || !h.test(f.getName()) && !f.is("pre"))B = f.clone()
                            } else w && (B = w.clone());
                            B ? u && !B.is("li") && B.renameNode(x) : z && z.is("li") ? B = z : (B = q.createElement(x), f && (t = f.getDirection()) && B.setAttribute("dir", t));
                            if (q = v.elementPath)for (u = 0, x = q.elements.length; u < x; u++) {
                                z = q.elements[u];
                        ...
                        }, (z = B.next()) && z.type == CKEDITOR.NODE_ELEMENT && z.is("ul", "ol") && (CKEDITOR.env.needsBrFiller ? q.createElement("br") :
                            q.createText(" ")).insertBefore(z)), w && m.moveToElementEditStart(w);
                        m.select();
                        m.scrollIntoView()
                    }
                }
                ...
                if (c = c || e(a)) {
                    var m = c.document, l = c.checkEndOfBlock(), r = new CKEDITOR.dom.elementPath(a.getSelection().getStartElement()), p = r.block, w = p && r.block.getName();
                    d || "li" != w ? (!d && l && h.test(w) ? (l = p.getDirection()) ? (m = m.createElement("div"), m.setAttribute("dir", l), m.insertAfter(p), c.setStart(m, 0)) : (m.createElement("br").insertAfter(p), CKEDITOR.env.gecko && m.createText("").insertAfter(p),
                        c.setStartAt(p.getNext(), CKEDITOR.env.ie ? CKEDITOR.POSITION_BEFORE_START : CKEDITOR.POSITION_AFTER_START)) : (a = "pre" == w && CKEDITOR.env.ie && 8 > CKEDITOR.env.version ? m.createText("\r") : m.createElement("br"), c.deleteContents(), c.insertNode(a), CKEDITOR.env.needsBrFiller ? (m.createText("﻿").insertAfter(a), l && (p || r.blockLimit).appendBogus(), a.getNext().$.nodeValue = "", c.setStartAt(a.getNext(), CKEDITOR.POSITION_AFTER_START)) : c.setStartAt(a, CKEDITOR.POSITION_AFTER_END)), c.collapse(!0), c.select(), c.scrollIntoView()) :
                        f(a, b, c, d)
                }
            }
        };
        ...
        CKEDITOR.plugins.add("entities", {
            afterInit: function (e) {
                ...
                if (e = (e = e.dataProcessor) && e.htmlFilter) {
                    ...
                    d.entities_additional && m.push(d.entities_additional));
        ...
        popup: function (a, e, b, c) {
            ...
            640 > e && (e = 640);
            420 > b && (b = 420);
            var d = parseInt((window.screen.height - b) / 2, 10), m = parseInt((window.screen.width -
                e) / 2, 10);
        ...
        function m(a, f, g, l) {
            if (l && l.length)for (var u, q = l.length; q--;)if (u = l[q], "hbox" != u.type && "vbox" != u.type && "fieldset" != u.type || m(a, f, g, u.children), u.filebrowser)if ("string" == typeof u.filebrowser && (u.filebrowser = {
                    action: "fileButton" == u.type ? "QuickUpload" : "Browse",
                    target: u.filebrowser
                }), "Browse" == u.filebrowser.action) {
                var v = u.filebrowser.url;
                void 0 === v && (v = a.config["filebrowser" + e(f) + "BrowseUrl"], void 0 === v && (v = a.config.filebrowserBrowseUrl));
                v && (u.onClick = b, u.filebrowser.url = v, u.hidden = !1)
            } else if ("QuickUpload" == u.filebrowser.action && u["for"] && (v = u.filebrowser.url, void 0 === v && (v = a.config["filebrowser" + e(f) + "UploadUrl"], void 0 === v && (v = a.config.filebrowserUploadUrl)), v)) {
                var r = u.onClick;
                u.onClick = function (a) {
                    var b = a.sender;
                    return r && !1 === r.call(b, a) ? !1 : c.call(b, a)
                };
                u.filebrowser.url = v;
                u.hidden = !1;
                d(a, g.getContents(u["for"][0]).get(u["for"][1]), u.filebrowser)
            }
        }
        ...
        function l(a, b, c) {
            if (-1 !== c.indexOf(";")) {
                c = c.split(";");
                for (var d = 0; d < c.length; d++)if (l(a,
                        b, c[d]))return !0;
                return !1
            }
        ...
        function f(a, b) {
            ...
            if ("function" != typeof b || !1 !== b.call(this._.filebrowserSe))if (!f || !1 !== f.call(this._.filebrowserSe, a, b))if ("string" == typeof b && b && alert(b), a && (d = this._.filebrowserSe, c = d.getDialog(), d = d.filebrowser.target || null))if (d = d.split(":"), f = c.getContentElement(d[0],
                    d[1]))f.setValue(a), c.selectPage(d[0])
        }
        ...
        function a(a) {
            var d =
                ...
                function g(a) {
                    ...
                    switch (a) {
                        case "top":
                            f("absolute", "top", b.y - x - z);
                            break;
                        case "pin":
                            f("fixed", "top", y);
                            break;
                        case "bottom":
                            f("absolute", "top", b.y + (p.height || p.bottom - p.top) + z)
                    }
                    k = a
                }

                var k, m, r, p, w, x, B, t = d.floatSpaceDockedOffsetX || 0, z = d.floatSpaceDockedOffsetY || 0, E = d.floatSpacePinnedOffsetX || 0, y = d.floatSpacePinnedOffsetY || 0;
                return function (f) {
                    if (m =
                            a.editable()) {
                        ...
                        k ? (x + z <= p.top ? g("top") : x + z > w.height - p.bottom ? g("pin") : g("bottom"), f = w.width / 2, f = d.floatSpacePreferRight ? "right" : 0 < p.left && p.right < w.width && p.width > r.width ? "rtl" == d.contentsLangDirection ? "right" : "left" : f - p.left >
                        p.right - f ? "left" : "right", r.width > w.width ? (f = "left", n = 0) : (n = "left" == f ? 0 < p.left ? p.left : 0 : p.right < w.width ? w.width - p.right : 0, n + r.width > w.width && (f = "left" == f ? "right" : "left", n = 0)), h.setStyle(f, b(("pin" == k ? E : t) + n + ("pin" == k ? 0 : "left" == f ? B : -B)))) : (k = "pin", g("pin"), l(f))
                    }
                }
            }();
            if (m) {
                var f = new CKEDITOR.template('\x3cdiv id\x3d"cke_{name}" class\x3d"cke {id} cke_reset_all cke_chrome cke_editor_{name} cke_float cke_{langDir} ' + CKEDITOR.env.cssClass + '" dir\x3d"{langDir}" title\x3d"' + (CKEDITOR.env.gecko ? " " : "") + '" lang\x3d"{langCode}" role\x3d"application" style\x3d"{style}"' +
                    (a.title ? ' aria-labelledby\x3d"cke_{name}_arialbl"' : " ") + "\x3e" + (a.title ? '\x3cspan id\x3d"cke_{name}_arialbl" class\x3d"cke_voice_label"\x3e{voiceLabel}\x3c/span\x3e' : " ") + '\x3cdiv class\x3d"cke_inner"\x3e\x3cdiv id\x3d"{topId}" class\x3d"cke_top" role\x3d"presentation"\x3e{content}\x3c/div\x3e\x3c/div\x3e\x3c/div\x3e'), h = CKEDITOR.document.getBody().append(CKEDITOR.dom.element.createFromHtml(f.output({
                    content: m,
                    id: a.id,
                    langDir: a.lang.dir,
                    langCode: a.langCode,
        ...
        requires: "panel", onLoad: function () {
            ...
            CKEDITOR.ui.listBlock = CKEDITOR.tools.createClass({
                base: CKEDITOR.ui.panel.block, $: function (a, b) {
                    ...
                    focus: function (a) {
                        this._.focusIndex = -1;
                        var b = this.element.getElementsByTag("a"), c, f = -1;
                        if (a)for (c = this.element.getDocument().getById(this._.items[a]).getFirst(); a = b.getItem(++f);) {
                            if (a.equals(c)) {
                                this._.focusIndex = f;
                                break
                            }
        ...
        CKEDITOR.ui.button.prototype = {
            render: function (a, d) {
                ...
                var l = CKEDITOR.env, f = this._.id =
                    CKEDITOR.tools.getNextId(), h = "", k = this.command, g;
                this._.editor = a;
                var n = {
                ...
                if (this.directional)a.on("contentDirChanged",
                    function (b) {
                        var d = CKEDITOR.document.getById(this._.id), f = d.getFirst();
                        b = b.data;
                        b != a.lang.dir ? d.addClass("cke_" + b) : d.removeClass("cke_ltr").removeClass("cke_rtl");
                        f.setAttribute("style", CKEDITOR.skin.getIconStyle(w, "rtl" == b, this.icon, this.iconOffset))
                    }, this);
                k || (h += "off");
                    ...
                    renderHtml: function (a) {
                        ...
                        if (!this._.panel) {
                            var c = this._.panelDefinition,
                                d = this._.panelDefinition.block, e = c.parent || CKEDITOR.document.getBody(), l = "cke_combopanel__" + this.name, f = new CKEDITOR.ui.floatPanel(a, e, c), h = f.addListBlock(this.id, d), k = this;
                            f.onShow = function () {
                ...
                m && a.ui.addRichCombo("Format", {
                    ...
                    onRender: function () {
                        a.on("selectionChange", function (b) {
                            ...
                            b = b.data.path;
                            this.refresh();
                            for (var f in d)if (d[f].checkActive(b, a)) {
        ...
        CKEDITOR.plugins.add("image", {
            requires: "dialog", init: function (b) {
                ...
                function c(c) {
                    ...
                    if (m) {
                        if ("left" == c || "right" == c)m.on("exec", function (m) {
                            var f = a(b), h;
                            f && (h = e(f), h == c ? (f.removeStyle("float"), c == e(f) && f.removeAttribute("align")) :
                                f.setStyle("float", c), m.cancel())
                        });
                        m.on("refresh", function (m) {
                            var f = a(b);
                            f && (f = e(f), this.setState(f == c ? CKEDITOR.TRISTATE_ON : "right" == c || "left" == c ? CKEDITOR.TRISTATE_OFF : CKEDITOR.TRISTATE_DISABLED), m.cancel())
                        })
                    }
                }
        ...
        var e = CKEDITOR.htmlParser.cssStyle,
            b = CKEDITOR.tools.cssLength, c = /^((?:\d*(?:\.\d+))|(?:\d+))(.*)?$/i, d = {
                elements: {
                    $: function (b) {
                        var c = b.attributes;
        ...
        function b(b, c) {
            ...
            g = [d.compiledProtectionFunction.name,
                "("];
            for (var h = 0; h < f.length; h++)d = f[h].toLowerCase(), e = c[d], 0 < h && g.push(","), g.push("'", e ? a(encodeURIComponent(c[d])) : "", "'");
            g.push(")");
            return g.join("")
        }
...
CKEDITOR.dialog.isTabEnabled(a,"link","advanced")&&(b=b.replace("]",",accesskey,charset,dir,id,lang,name,rel,tabindex,title,type]{*}(*)"));CKEDITOR.dialog.isTabEnabled(a,"link","target")&&(b=b.replace("]",",target,onclick]"));a.addCommand("link",new CKEDITOR.dialogCommand("link",{allowedContent:b,requiredContent:"a[href]"}));a.addCommand("anchor",new CKEDITOR.dialogCommand("anchor",{allowedContent:"a[!name,id]",requiredContent:"a[name]"}));a.addCommand("unlink",new CKEDITOR.unlinkCommand);a.addCommand("removeAnchor",
                    new CKEDITOR.removeAnchorCommand);
                ...
                a.addMenuItems && a.addMenuItems({
                    anchor: {
                        label: a.lang.link.anchor.menu, command: "anchor",
                        group: "anchor", order: 1
                    },
                    removeAnchor: {
        ...
        var d = /^javascript:/, m = /^mailto:([^?]+)(?:\?(.+))?$/, l = /subject=([^;?:@&=$,\/]*)/i, f = /body=([^;?:@&=$,\/]*)/i, h = /^#(.*)$/, k = /^((?:http|https|ftp|news):\/\/)?(.*)$/, g = /^(_(?:self|top|parent|blank))$/, n = /^javascript:void\(location\.href='mailto:'\+String\.fromCharCode\(([^)]+)\)(?:\+'(.*)')?\)$/, u = /^javascript:([^(]+)\(([^)]+)\)$/, q = /\s*window.open\(\s*this\.href\s*,\s*(?:'([^']*)'|null)\s*,\s*'([^']*)'\s*\)\s*;\s*return\s*false;*\s*/,
            v = /(?:^|,)([^=]+)=(\d+|yes|no)/gi, r = {
                id: "advId",
                dir: "advLangDir",
        ...
        CKEDITOR.plugins.link = {
            getSelectedLink: function (a) {
                ...
                for (var b =
                    a.editable(), c = b.isInline() && !a.plugins.divarea ? a.document : b, b = c.getElementsByTag("a"), c = c.getElementsByTag("img"), d = [], f = 0, e; e = b.getItem(f++);)(e.data("cke-saved-name") || e.hasAttribute("name")) && d.push({
                ...
                var c = b && (b.data("cke-saved-href") || b.getAttribute("href")) || "", e = a.plugins.link.compiledProtectionFunction, t = a.config.emailProtection, z, E = {};
                c.match(d) && ("encode" == t ? c = c.replace(n, function (a, b, c) {
                    c = c || "";
                    return "mailto:" + String.fromCharCode.apply(String, b.split(",")) + c.replace(/\\'/g, "'")
                }) : t && c.replace(u, function (a, b, c) {
                    if (b == e.name) {
                        E.type = "email";
                        a = E.email =
                        {};
                ...
                if (!E.type)if (t = c.match(h))E.type = "anchor", E.anchor = {}, E.anchor.name = E.anchor.id = t[1]; else if (t = c.match(m)) {
                    z = c.match(l);
                    c = c.match(f);
                    E.type = "email";
                    var y = E.email = {};
                ...
                (E.type = "url", E.url = {}, E.url.protocol = z[1], E.url.url = z[2]);
                if (b) {
                    if (c = b.getAttribute("target"))E.target = {
                        type: c.match(g) ? c : "frame",
                        name: c
                    }; else if (c = (c = b.data("cke-pa-onclick") || b.getAttribute("onclick")) && c.match(q))for (E.target = {
                        type: "popup",
                        name: c[1]
                        ...
                        top: 1,
                        left: 1
                    } ? isFinite(t[2]) && (E.target[t[1]] = t[2]) : E.target[t[1]] = !0;
                    var c = {}, A;
                    for (A in r)(t = b.getAttribute(A)) && (c[r[A]] = t);
                ...
                if (d.target)if ("popup" == d.target.type) {
                    for (var f = ["window.open(this.href, '", d.target.name || "", "', '"], n = "resizable status location toolbar menubar fullscreen scrollbars dependent".split(" "),
                             h = n.length, m = function (a) {
                ...
                if (d.advanced) {
                    for (var q in r)(f = d.advanced[r[q]]) && (g[q] = f);
                ...
                d.advanced && CKEDITOR.tools.extend(q, r);
        ...
        CKEDITOR.unlinkCommand.prototype = {
            exec: function (a) {
                ...
                c && "a" == c.getName() && c.getAttribute("href") && c.getChildCount() ? this.setState(CKEDITOR.TRISTATE_OFF) :
                    this.setState(CKEDITOR.TRISTATE_DISABLED)
        ...
        function b(a) {
            ...
            if (b && n(b) && (b = b.getAscendant(a.triggers, !0)) && a.editable.contains(b)) {
                var c = l(b);
                if ("true" ==
                    c.getAttribute("contenteditable"))return b;
        ...
        function d(a, b, c) {
            return b = b[c ? "getPrevious" : "getNext"](function (b) {
                return b && b.type == CKEDITOR.NODE_TEXT && !ba(b) || n(b) && !u(b) && !g(a, b)
            })
        }
        ...
        function f(a) {
            var b = a.doc, c = G('\x3cspan contenteditable\x3d"false" style\x3d"' + Q + "position:absolute;border-top:1px dashed " + a.boxColor + '"\x3e\x3c/span\x3e', b), d = CKEDITOR.getUrl(this.path + "images/" + (F.hidpi ? "hidpi/" : "") + "icon" + (a.rtl ? "-rtl" : "") + ".png");
            A(c, {
                attach: function () {
                ...
                lineChildren: [A(G('\x3cspan title\x3d"' + a.editor.lang.magicline.title + '" contenteditable\x3d"false"\x3e\x26#8629;\x3c/span\x3e', b), {
                    base: Q + "height:17px;width:17px;" +
                    (a.rtl ? "left" : "right") + ":17px;background:url(" + d + ") center no-repeat " + a.boxColor + ";cursor:pointer;" + (F.hc ? "font-size: 15px;line-height:14px;border:1px solid #fff;text-align:center;" : "") + (F.hidpi ? "background-size: 9px 10px;" : ""),
                    ...
                    looks: ["border-width:8px 0 8px 8px;top:-8px", "border-width:8px 0 0 8px;top:-8px",
                ...
                place: function () {
                    var b = a.view, c = a.editable, d = a.trigger, f = d.upper,
                        e = d.lower, g = f || e, h = g.getParent(), k = {};
                    this.trigger = d;
                    f && t(a, f, !0);
                    e && t(a, e, !0);
                    t(a, h, !0);
                    ...
                    f && e ? k.top = f.size.margin.bottom === e.size.margin.top ? 0 | f.size.bottom + f.size.margin.bottom / 2 : f.size.margin.bottom < e.size.margin.top ?
                    f.size.bottom + f.size.margin.bottom : f.size.bottom + f.size.margin.bottom - e.size.margin.top : f ? e || (k.top = f.size.bottom + f.size.margin.bottom) : k.top = e.size.top - e.size.margin.top;
        ...
        function h(a, b, c) {
            ...
            F.ie && a.enterMode == CKEDITOR.ENTER_BR ? e = a.doc.createText(M) : (e = (e = l(a.element, !0)) && e.data("cke-enter-mode") || a.enterMode, e = new C(K[e], a.doc), e.is("br") ||
            a.doc.createText(M).appendTo(e));
        ...
        function k(a, c) {
            return {
                canUndo: !0, modes: {wysiwyg: 1}, exec: function () {
                    function f(b) {
                        var d = F.ie && 9 > F.version ? " " : M, e = a.hotNode && a.hotNode.getText() == d && a.element.equals(a.hotNode) && a.lastCmdDirection === !!c;
                        h(a, function (d) {
                    ...
                    return function (e) {
                        ...
                        var g;
                        e = e.getAscendant(L, 1);
                        if (!r(a, e) && e && !e.equals(a.editable) && !e.contains(a.editable)) {
                            (g = l(e)) && "false" == g.getAttribute("contenteditable") && (e = g);
                            a.element = e;
                            g = d(a, e, !c);
                            var h;
                            n(g) && g.is(a.triggers) && g.is(J) && (!d(a, g, !c) || (h = d(a, g, !c)) && n(h) && h.is(a.triggers)) ? f(g) : (h = b(a, e), n(h) && (d(a, h, !c) ? (e = d(a, h, !c)) &&
        ...
        function r(a, b) {
            if (!b)return !1;
            for (var c = b.getParents(1), d = c.length; d--;)for (var f = a.tabuList.length; f--;)if (c[d].hasAttribute(a.tabuList[f]))return !0;
            return !1
        }
        ...
        function w(a) {
            ...
            z(a);
            var h = c.y > (a.inInlineMode ? d.editable.top + d.editable.height / 2 : Math.min(d.editable.height, d.pane.height) /
        ...
        function x(a) {
            var c =
                a.mouse, f = a.view, g = a.triggerOffset, h = b(a);
            if (!h)return null;
            t(a, h);
            var g = Math.min(g, 0 | h.size.outerHeight / 2), k = [], l, q;
            if (m(c.y, h.size.top - 1, h.size.top + g))q = !1; else if (m(c.y, h.size.bottom - g, h.size.bottom + 1))q = !0; else return null;
            if (u(h) || p(a, h, q) || h.getParent().is(W))return null;
            var r = d(a, h, !q);
            if (r) {
                if (r && r.type == CKEDITOR.NODE_TEXT)return null;
                if (n(r)) {
                    if (u(r) || !v(a, r) || r.getParent().is(W))return null;
                    k = [r, h][q ? "reverse" : "concat"]().concat([R, P])
                }
            } else h.equals(a.editable[q ? "getLast" : "getFirst"](a.isRelevant)) ?
                (z(a), q && m(c.y, h.size.bottom - g, f.pane.height) && m(h.size.bottom, f.pane.height - g, f.pane.height) ? l = O : m(c.y, 0, h.size.top + g) && (l = T)) : l = Y, k = [null, h][q ? "reverse" : "concat"]().concat([q ? N : D, P, l, h.equals(a.editable[q ? "getLast" : "getFirst"](a.isRelevant)) ? q ? O : T : Y]);
            return 0 in k ? new e(k) : null
        }

        function B(a, b, c, d) {
            for (var f = b.getDocumentPosition(), e = {}, g = {}, h = {}, k = {}, m = ca.length; m--;)e[ca[m]] = parseInt(b.getComputedStyle.call(b, "border-" + ca[m] + "-width"), 10) || 0, h[ca[m]] = parseInt(b.getComputedStyle.call(b, "padding-" +
                    ca[m]), 10) || 0, g[ca[m]] = parseInt(b.getComputedStyle.call(b, "margin-" + ca[m]), 10) || 0;
            c && !d || E(a, d);
            k.top = f.y - (c ? 0 : a.view.scroll.y);
            k.left = f.x - (c ? 0 : a.view.scroll.x);
            k.outerWidth = b.$.offsetWidth;
            k.outerHeight = b.$.offsetHeight;
            k.height = k.outerHeight - (h.top + h.bottom + e.top + e.bottom);
            k.width = k.outerWidth - (h.left + h.right + e.left + e.right);
            ...
            return A({border: e, padding: h, margin: g, ignoreScroll: c},
                k, !0)
        }
        ...
        function y(a, b, c, d) {
            for (var f = d, g = d, h = 0, k = !1, m = !1, l = a.view.pane.height, n = a.mouse; n.y + h < l && 0 < n.y - h;) {
                k || (k = b(f, d));
                m || (m = b(g, d));
        ...
        CKEDITOR.plugins.add("magicline", {
            init: function (a) {
                var c = a.config, m = c.magicline_triggerOffset || 30, l = {
                    editor: a,
                    enterMode: c.enterMode,
                    triggerOffset: m,
                    holdDistance: 0 |
                    m * (c.magicline_holdDistance || .5),
                ...
                l.isRelevant = function (a) {
                    return n(a) && !g(l, a) && !u(a)
                };
                a.on("contentDom", function () {
                    var m = a.editable(), n = a.document, u = a.window;
                    A(l, {
                        editable: m,
                        inInlineMode: m.isInline(),
                        doc: n,
                        win: u,
                        hotNode: null
                    }, !0);
                    ...
                    m.is(H.$inline) || (l.inInlineMode && !q(m) && m.setStyles({
                        position: "relative",
                        top: null,
                        left: null
                    }), f.call(this, l), E(l), m.attachListener(a, "beforeUndoImage", function () {
                        l.line.detach()
                    }), m.attachListener(a, "beforeGetData", function () {
                        l.line.wrap.getParent() && (l.line.detach(), a.once("getData", function () {
                            l.line.attach()
                        }, null, null, 1E3))
                    }, null, null, 0), m.attachListener(l.inInlineMode ? n : n.getWindow().getFrame(), "mouseout", function (b) {
                        if ("wysiwyg" == a.mode)if (l.inInlineMode) {
                            ...
                            c > d.left - f.x && c < d.right - f.x && b > d.top - f.y && b < d.bottom - f.y || (clearTimeout(t), t = null, l.line.detach())
                        } else clearTimeout(t), t = null, l.line.detach()
                    }), m.attachListener(m, "keyup", function () {
                        l.hiddenMode = 0
                    }), m.attachListener(m, "keydown", function (b) {
                        if ("wysiwyg" == a.mode)switch (b.data.getKeystroke()) {
                            case 2228240:
                            case 16:
                                l.hiddenMode = 1, l.line.detach()
                        }
                    }), m.attachListener(l.inInlineMode ? m : n, "mousemove", function (b) {
                        v = !0;
                        if ("wysiwyg" == a.mode && !a.readOnly && !t) {
                            ...
                            t = setTimeout(function () {
                                ...
                                t = l.trigger = null;
                                E(l);
                                v && !l.hiddenMode && a.focusManager.hasFocus && !l.line.mouseNear() && (l.element = da(l, !0)) && ((l.trigger = w(l) || x(l) || ea(l)) && !r(l, l.trigger.upper || l.trigger.lower) ? l.line.attach().place() : (l.trigger = null, l.line.detach()), v = !1)
                            }, 30)
                        }
                    }), m.attachListener(u, "scroll", function () {
                        "wysiwyg" == a.mode && (l.line.detach(), F.webkit && (l.hiddenMode = 1, clearTimeout(p), p = setTimeout(function () {
                            l.mouseDown ||
                            (l.hiddenMode = 0)
                        }, 50)))
                    }), m.attachListener(I ? n : u, "mousedown", function () {
                        "wysiwyg" == a.mode && (l.line.detach(), l.hiddenMode = 1, l.mouseDown = 1)
                    }), m.attachListener(I ? n : u, "mouseup", function () {
                        l.hiddenMode = 0;
                        l.mouseDown = 0
                    }), a.addCommand("accessPreviousSpace", k(l)), a.addCommand("accessNextSpace", k(l, !0)), a.setKeystroke([[c.magicline_keystrokePrevious, "accessPreviousSpace"], [c.magicline_keystrokeNext, "accessNextSpace"]]), a.on("loadSnapshot", function () {
                        var b, c, d, f;
                        for (f in{
                            p: 1,
                            br: 1,
                            div: 1
                                   ...
                                   d = b.count(); d--;)if ((c = b.getItem(d)).data("cke-magicline-hot")) {
                            l.hotNode = c;
        ...
        var A = CKEDITOR.tools.extend, C = CKEDITOR.dom.element, G = C.createFromHtml, F = CKEDITOR.env, I = CKEDITOR.env.ie && 9 > CKEDITOR.env.version, H = CKEDITOR.dtd, K = {}, D = 128, N = 64, R = 32, P = 16, T = 4, O =
        ...
        var da = function () {
        ...
        }(), ba = CKEDITOR.dom.walker.whitespaces(), X = CKEDITOR.dom.walker.nodeType(CKEDITOR.NODE_COMMENT), ea = function () {
            function b(f) {
                var e =
                    f.element, h, g, k;
                ...
                h = k.upper;
                g = k.lower;
                if (a(f, h, g))return k.set(R, 8);
                if (h && e.contains(h))for (; !h.getParent().equals(e);)h = h.getParent(); else h = e.getFirst(function (a) {
                    return d(f, a)
                });
                ...
                t(f, h);
                t(f, g);
                if (!m(f.mouse.y, h.size.top, g.size.bottom))return null;
                for (var e = Number.MAX_VALUE, l, q, p, r; g && !g.equals(h) && (q = h.getNext(f.isRelevant));)l = Math.abs(c(f, h, q) - f.mouse.y), l < e && (e = l, p = h, r = q), h = q, t(f, h);
                if (!p || !r || !m(f.mouse.y, p.size.top, r.size.bottom))return null;
                k.upper = p;
                k.lower = r;
                return k.set(R, 8)
            }
            ...
            function d(a, b) {
                return !(b && b.type == CKEDITOR.NODE_TEXT || X(b) || u(b) || g(a, b) || b.type == CKEDITOR.NODE_ELEMENT && b.$ && b.is("br"))
            }
            ...
            return function (c) {
                ...
                if (f = d) {
                    f = d.upper;
                    var e = d.lower;
                    f = !f || !e || u(e) || u(f) || e.equals(f) || f.equals(e) || e.contains(f) || f.contains(e) ?
                        !1 : v(c, f) && v(c, e) && a(c, f, e) ? !0 : !1
                }
                return f ? d : null
            }
        ...
        CKEDITOR.plugins.add("maximize", {
            init: function (a) {
                ...
                if (a.elementMode != CKEDITOR.ELEMENT_MODE_INLINE) {
                    var f = a.lang, h = CKEDITOR.document, k = h.getWindow(), g, n, u, q = CKEDITOR.TRISTATE_OFF;
                    a.addCommand("maximize",
                        {
                            ...
                            if (this.state == CKEDITOR.TRISTATE_OFF) {
                                ...
                                h.getDocumentElement().setStyles(r);
                                !CKEDITOR.env.gecko && h.getDocumentElement().setStyle("position", "fixed");
                                CKEDITOR.env.gecko && CKEDITOR.env.quirks || h.getBody().setStyles(r);
                                ...
                                for (var p = [r, v], x = 0; x < p.length; x++)c(p[x], p[x].getCustomData("maximize_saved_styles")), p[x].removeCustomData("maximize_saved_styles");
                                for (p = a.container; p = p.getParent();)c(p, p.getCustomData("maximize_saved_styles")), p.removeCustomData("maximize_saved_styles");
                                CKEDITOR.env.ie ? setTimeout(function () {
                                    k.$.scrollTo(u.x, u.y)
                                }, 0) : k.$.scrollTo(u.x, u.y);
                            ...
                            this.toggleState();
                            if (p =
                                    this.uiItems[0])r = this.state == CKEDITOR.TRISTATE_OFF ? f.maximize.maximize : f.maximize.minimize, p = CKEDITOR.document.getById(p._.id), p.getChild(1).setHtml(r), p.setAttribute("title", r), p.setAttribute("href", 'javascript:void("' + r + '");');
                ...
                b.on("paste", function (e) {
                    ...
                    if (f && (c || /(class=\"?Mso|style=\"[^\"]*\bmso\-|w:WordDocument)/.test(f))) {
                        ...
                        var h = a(b, d, function () {
                            if (h)b.fire("paste", l); else if (!b.config.pasteFromWordPromptCleanup || c || confirm(b.lang.pastefromword.confirmCleanup))l.dataValue = CKEDITOR.cleanWord(f,
                                b);
                            c = 0
                        });
                        h && e.cancel()
                ...
                exec: function (a) {
                    for (var e = a._.removeFormatRegex || (a._.removeFormatRegex = new RegExp("^(?:" + a.config.removeFormatTags.replace(/,/g, "|") + ")$", "i")), b = a._.removeAttributes || (a._.removeAttributes = a.config.removeFormatAttributes.split(",")), c = CKEDITOR.plugins.removeformat.filter, d = a.getSelection().getRanges(), m = d.createIterator(), l = function (a) {
                        ...
                        if (g)for (n(g), k = k.getNextSourceNode(!0, CKEDITOR.NODE_ELEMENT); k && !k.equals(g);)if (k.isReadOnly()) {
                            ...
                            k = k.getNext(l)
                        } else n = k.getNextSourceNode(!1, CKEDITOR.NODE_ELEMENT), "img" == k.getName() && k.data("cke-realelement") || !c(a, k) || (e.test(k.getName()) ?
                            k.remove(1) : (k.removeAttributes(b), a.fire("removeFormatCleanup", k))), k = n;
                        f.moveToBookmark(h)
                    }
                    a.forceNextSelectionCheck();
        ...
        init: function (a) {
            ...
            if (!1 !== c.resize_enabled) {
                var l = null, f, h, k = ("both" == c.resize_dir ||
                    "horizontal" == c.resize_dir) && c.resize_minWidth != c.resize_maxWidth, g = ("both" == c.resize_dir || "vertical" == c.resize_dir) && c.resize_minHeight != c.resize_maxHeight, n = CKEDITOR.tools.addFunction(function (d) {
                    l || (l = a.getResizable());
                    h = {
                ...
                a.on("uiSpace", function (b) {
                    if ("bottom" == b.data.space) {
                        ...
                        var f = '\x3cspan id\x3d"' + d + '" class\x3d"cke_resizer' + c + " cke_resizer_" + m + '" title\x3d"' + CKEDITOR.tools.htmlEncode(a.lang.common.resize) + '" onmousedown\x3d"CKEDITOR.tools.callFunction(' + n + ', event)"\x3e' + ("ltr" ==
                            m ? "◢" : "◣") + "\x3c/span\x3e";
                        "ltr" == m && "ltr" == c ? b.data.html += f : b.data.html = f + b.data.html
                    }
                }, a, null, 100);
        ...
        init: function (a) {
            ...
            a.contextMenu && a.addMenuItems && (a.contextMenu.addListener(function (b, c) {
                var d = a.scayt, h;
                if (d) {
                    var k = d.getSelectionNode();
                    if (k = k ? k.getAttribute(d.getNodeAttribute()) : k)h = e.menuGenerator(a, k, e), d.showBanner("." + a.contextMenu._.definition.panel.className.split(" ").join(" ."))
                }
                return h
        ...
        addMenuItems: function (a) {
            ...
            if (c && c.length)for (var d = 0; d < c.length; d++)a.addMenuGroup("scayt_" + c[d], d - 10);
            a.addCommand("scaytToggle", {
                exec: function (a) {
                    var c = a.scayt;
                    b.state[a.name] = !b.state[a.name];
                    !0 === b.state[a.name] ? c || b.createScayt(a) : c && b.destroy(a)
                }
            });
            ...
            a.plugins.wsc && (c.WSC = {
                ...
                onClick: function () {
                    ...
                    (d = d.replace(/\s/g,
                        "")) ? (c && b.state[a.name] && c.setMarkupPaused && c.setMarkupPaused(!0), a.lockSelection(), a.execCommand("checkspell")) : alert("Nothing to check!")
                }
            });
            a.addMenuItems(c)
        },
        bindEvents: function (a) {
            ...
            var b = CKEDITOR.plugins.scayt, c = a.elementMode == CKEDITOR.ELEMENT_MODE_INLINE, d = function () {
                b.destroy(a)
            }, m = function () {
                ...
                b.attachListener(b, "focus",
                    function (b) {
                        CKEDITOR.plugins.scayt && !a.scayt && setTimeout(m, 0);
                        b = CKEDITOR.plugins.scayt && CKEDITOR.plugins.scayt.state[a.name] && a.scayt;
                        var d, f;
                        if ((c || b) && a._.savedSelection) {
                            b = a._.savedSelection.getSelectedElement();
                            b = !b && a._.savedSelection.getRanges();
                            for (var e = 0; e < b.length; e++)f = b[e], "string" === typeof f.startContainer.$.nodeValue && (d = f.startContainer.getText().length, (d < f.startOffset || d < f.endOffset) && a.unlockSelection(!1))
                        }
                    }, this, null, -10)
            }, f = function () {
                c ? (a.on("blur", d), a.on("focus", m), a.focusManager.hasFocus &&
                m()) : m();
                l()
            };
            a.on("contentDom", f);
            a.on("beforeCommandExec", function (c) {
                var d;
                if (c.data.name in b.options.disablingCommandExec && "wysiwyg" == a.mode) {
                    if (d = a.scayt)b.destroy(a), a.fire("scaytButtonState", CKEDITOR.TRISTATE_DISABLED)
                } else if ("bold" === c.data.name || "italic" === c.data.name || "underline" === c.data.name || "strike" === c.data.name || "subscript" === c.data.name || "superscript" === c.data.name || "enter" === c.data.name)if (d = a.scayt)d.removeMarkupInSelectionNode(), setTimeout(function () {
            ...
            a.on("beforeSetMode", function (c) {
                if ("source" == c.data) {
                    if (c = a.scayt)b.destroy(a), a.fire("scaytButtonState", CKEDITOR.TRISTATE_DISABLED);
            ...
            a.on("readOnly", function (c) {
                var d;
                c && (d = a.scayt, !0 === c.editor.readOnly ? d && d.fire("removeMarkupInDocument", {}) : d ? d.fire("startSpellCheck") :
                "wysiwyg" == c.editor.mode && !0 === b.state[c.editor.name] && (b.createScayt(a), c.editor.fire("scaytButtonState", CKEDITOR.TRISTATE_ON)))
            });
            ...
            a.on("paste", function (b) {
                (b = a.scayt) && b.removeMarkupInSelectionNode()
            }, null, null, 0)
        },
        parseConfig: function (a) {
            ...
            if (a.config.scayt_disableOptionsStorage) {
                ...
                a.config.scayt_disableOptionsStorage = function (a) {
                    for (var b = [], c = 0; c <
                    a.length; c++) {
                        var e = a[c], u = !!l(a, "options");
                        if (!l(d, e) || u && l(m, function (a) {
                                if ("lang" === a)return !1
                            }))return;
                        l(m, e) && m.splice(f(m, e), 1);
                        if ("all" === e || u && l(a, "lang"))return [];
                        "options" === e && (m = ["lang"])
                    }
                    return b = b.concat(m)
                }(e)
        ...
        addRule: function (a) {
            var e = a.dataProcessor, b = e && e.htmlFilter, c = a._.elementsPath && a._.elementsPath.filters, e = e && e.dataFilter, d = a.addRemoveFormatFilter, m = function (b) {
                var c = CKEDITOR.plugins.scayt;
                if (a.scayt && b.hasAttribute(c.options.data_attribute_name))return !1
            }, l = function (b) {
                var c =
                    CKEDITOR.plugins.scayt, d = !0;
                a.scayt && b.hasAttribute(c.options.data_attribute_name) && (d = !1);
                return d
            };
            c && c.push(m);
            e && e.addRules({
                elements: {
                    span: function (b) {
                        var c = CKEDITOR.plugins.scayt;
                        c && c.state[a.name] && b.classes && CKEDITOR.tools.search(b.classes, c.options.misspelled_word_class) && (b.classes && b.parent.type === CKEDITOR.NODE_DOCUMENT_FRAGMENT ? (delete b.attributes.style, delete b.name) : delete b.classes[CKEDITOR.tools.indexOf(b.classes, c.options.misspelled_word_class)]);
                        return b
                    }
                }
            });
            b && b.addRules({
                elements: {
                    span: function (b) {
                        ...
                        c && c.state[a.name] && b.hasClass(c.options.misspelled_word_class) && b.attributes[c.options.data_attribute_name] && (b.removeClass(c.options.misspelled_word_class), delete b.attributes[c.options.data_attribute_name], delete b.name);
                        return b
                    }
                }
            });
        ...
        buildSuggestionMenuItems: function (a, e) {
            var b = {}, c = {}, d = a.scayt;
            if (0 < e.length && "no_any_suggestions" !== e[0])for (var m = 0; m < e.length; m++) {
                var l = "scayt_suggest_" + CKEDITOR.plugins.scayt.suggestions[m].replace(" ", "_");
                a.addCommand(l, this.createCommand(CKEDITOR.plugins.scayt.suggestions[m]));
                m < a.config.scayt_maxSuggestions ? (a.addMenuItem(l, {
                    label: e[m],
                    command: l,
                    group: "scayt_suggest",
                    order: m + 1
                    ...
                    label: e[m],
                    command: l, group: "scayt_moresuggest", order: m + 1
                }), c[l] = CKEDITOR.TRISTATE_OFF, "on" === a.config.scayt_moreSuggestions && (a.addMenuItem("scayt_moresuggest", {
        ...
        menuGenerator: function (a, e) {
            ...
            if ("off" == a.config.scayt_contextCommands)return d;
            for (var l in c)if (-1 != CKEDITOR.tools.indexOf(m, l.replace("scayt_", "")) || "all" == a.config.scayt_contextCommands)d[l] = CKEDITOR.TRISTATE_OFF, "function" !== typeof c[l].verification ||
            c[l].verification(a) || delete d[l], a.addCommand(l, {exec: c[l].exec}), a.addMenuItem(l, {
        ...
        createScayt: function (a) {
            ...
            this.loadScaytLibrary(a, function (a) {
                var c = {
                    ...
                    container: "BODY" == a.editable().$.nodeName ?
                        a.document.getWindow().$.frameElement : a.editable().$,
                ...
                a.config.scayt_serviceProtocol && (c.service_protocol = a.config.scayt_serviceProtocol);
                a.config.scayt_serviceHost && (c.service_host = a.config.scayt_serviceHost);
                a.config.scayt_servicePort && (c.service_port = a.config.scayt_servicePort);
                a.config.scayt_servicePath && (c.service_path = a.config.scayt_servicePath);
                c = new SCAYT.CKSCAYT(c, function () {
                }, function () {
                });
                c.subscribe("suggestionListSend", function (a) {
                    for (var b = {}, c = [], f = 0; f < a.suggestionList.length; f++)b["word_" + a.suggestionList[f]] || (b["word_" + a.suggestionList[f]] =
                        a.suggestionList[f], c.push(a.suggestionList[f]));
                    CKEDITOR.plugins.scayt.suggestions = c
                });
                c.subscribe("selectionIsChanged", function (c) {
        ...
        loadScaytLibrary: function (a, e) {
            ...
            this.loadingHelper[a.name] || (this.loadingHelper[a.name] = e, this.loadingHelper.loadOrder.push(a.name), c = new Date, c = c.getTime(), c = a.config.scayt_srcUrl + "?" + c, CKEDITOR.scriptLoader.load(c, function (a) {
            ...
            (CKEDITOR.fireOnce("scaytReady"), a.scayt || "function" === typeof e && e(a))
        }
    },CKEDITOR.on("dialogDefinition", function (a) {
        ...
        if (!0 === CKEDITOR.config.scayt_handleCheckDirty) {
            ...
            a.checkDirty = CKEDITOR.tools.override(a.checkDirty, function (a) {
                return function () {
                    ...
                    if (CKEDITOR.plugins.scayt && CKEDITOR.plugins.scayt.state[this.name] &&
                        this.scayt) {
            ...
            a.resetDirty = CKEDITOR.tools.override(a.resetDirty, function (a) {
                return function () {
                    var c = this.scayt;
                    CKEDITOR.plugins.scayt && CKEDITOR.plugins.scayt.state[this.name] && this.scayt ? this._.previousValue = c.removeMarkupFromString(this.getSnapshot()) : a.call(this)
                }
            })
        }
        if (!0 === CKEDITOR.config.scayt_handleUndoRedo) {
            ...
            a[e] = CKEDITOR.tools.override(a[e], function (a) {
                return function (c) {
                    ...
                    CKEDITOR.plugins.scayt && CKEDITOR.plugins.scayt.state[c.editor.name] && c.editor.scayt && (this.contents = d.removeMarkupFromString(e) || "", c.contents = d.removeMarkupFromString(l) || "");
                ...
                requires: "richcombo", init: function (a) {
                    ...
                    a.ui.addRichCombo("Styles", {
                        ...
                        onOpen: function () {
                            ...
                            this.unmarkAll();
                            for (var e in c) {
                                var k = c[e], g = k._.type;
                                k.checkApplicable(d, a, a.activeFilter) ? f[g]++ : this.hideItem(e);
                                k.checkActive(d, a) && this.mark(e)
                            }
                ...
                exec: function (b) {
                    if (b.editable().hasFocus) {
                        ...
                        if (f = (new CKEDITOR.dom.elementPath(c.getCommonAncestor(), c.root)).contains({
                            ...
                            if (e || a)if (e)e = new CKEDITOR.dom.element(e), c.moveToElementEditStart(e), c.checkStartOfBlock() && c.checkEndOfBlock() || c.selectNodeContents(e); else return !0; else {
                                for (var k = f.getAscendant("table").$, e = f.getParent().$.cells, k = new CKEDITOR.dom.element(k.insertRow(-1), b.document), g = 0, n = e.length; g < n; g++)k.append((new CKEDITOR.dom.element(e[g], b.document)).clone(!1, !1)).appendBogus();
        ...
        for (var b = void 0 === e ? this.getTabIndex() : e, c, d, m, l = 0, f, h = this.getDocument().getBody().getLast(); h =
        ...
        function a(a) {
            function b(a) {
                0 <
                c.length || a.type != CKEDITOR.NODE_ELEMENT || !u.test(a.getName()) || a.getCustomData("selected_cell") || (CKEDITOR.dom.element.setMarker(d, a, "selected_cell", !0), c.push(a))
            }

            a = a.getRanges();
            for (var c = [], d = {}, f = 0; f < a.length; f++) {
                var e = a[f];
                if (e.collapsed)e = e.getCommonAncestor(), (e = e.getAscendant("td", !0) || e.getAscendant("th", !0)) && c.push(e); else {
                    var e = new CKEDITOR.dom.walker(e), g;
                    for (e.guard = b; g = e.next();)g.type == CKEDITOR.NODE_ELEMENT && g.is(CKEDITOR.dtd.table) || (g = g.getAscendant("td", !0) || g.getAscendant("th",
        ...
        function e(b, c) {
            for (var d = a(b), f = d[0], e = f.getAscendant("table"), f = f.getDocument(), g = d[0].getParent(), h = g.$.rowIndex, d = d[d.length - 1], k = d.getParent().$.rowIndex + d.$.rowSpan - 1, d = new CKEDITOR.dom.element(e.$.rows[k]), h = c ? h : k, g = c ? g : d, d = CKEDITOR.tools.buildTableMap(e), e = d[h], h = c ? d[h - 1] : d[h + 1], d = d[0].length, f = f.createElement("tr"), k = 0; e[k] && k < d; k++) {
                var l;
                1 < e[k].rowSpan && h && e[k] == h[k] ? (l = e[k], l.rowSpan += 1) : (l = (new CKEDITOR.dom.element(e[k])).clone(), l.removeAttribute("rowSpan"), l.appendBogus(), f.append(l), l = l.$);
                k += l.colSpan - 1
            }
        ...
        function b(c) {
            if (c instanceof CKEDITOR.dom.selection) {
                var d = a(c), f = d[0].getAscendant("table"), e = CKEDITOR.tools.buildTableMap(f);
                c = d[0].getParent().$.rowIndex;
                for (var d = d[d.length - 1], g = d.getParent().$.rowIndex + d.$.rowSpan - 1, d = [], h = c; h <= g; h++) {
                    for (var k = e[h], l = new CKEDITOR.dom.element(f.$.rows[h]),
                             m = 0; m < k.length; m++) {
                        var n = new CKEDITOR.dom.element(k[m]), u = n.getParent().$.rowIndex;
                        1 == n.$.rowSpan ? n.remove() : (--n.$.rowSpan, u == h && (u = e[h + 1], u[m - 1] ? n.insertAfter(new CKEDITOR.dom.element(u[m - 1])) : (new CKEDITOR.dom.element(f.$.rows[h + 1])).append(n, 1)));
                        m += n.$.colSpan - 1
                    }
                    d.push(l)
                }
        ...
        function c(a, b) {
            for (var c = b ? Infinity : 0, d = 0; d < a.length; d++) {
                var f;
                f = a[d];
                for (var e = b, g = f.getParent().$.cells, h = 0, k = 0; k < g.length; k++) {
                    var l = g[k], h = h + (e ? 1 : l.colSpan);
                    if (l == f.$)break
                }
                f = h - 1;
                if (b ? f < c : f > c)c = f
        ...
        function d(b, d) {
            for (var f = a(b), e = f[0].getAscendant("table"), g = c(f, 1), f = c(f), g = d ? g : f, h = CKEDITOR.tools.buildTableMap(e), e = [], f = [], k = h.length, l = 0; l < k; l++)e.push(h[l][g]), f.push(d ? h[l][g - 1] : h[l][g + 1]);
            for (l = 0; l < k; l++)e[l] && (1 < e[l].colSpan && f[l] == e[l] ? (g = e[l], g.colSpan += 1) : (g = (new CKEDITOR.dom.element(e[l])).clone(),
                g.removeAttribute("colSpan"), g.appendBogus(), g[d ? "insertBefore" : "insertAfter"].call(g, new CKEDITOR.dom.element(e[l])), g = g.$), l += g.rowSpan - 1)
        }
        ...
        function k(b, c, d) {
            var f = a(b), e;
            if ((c ? 1 != f.length : 2 > f.length) || (e = b.getCommonAncestor()) &&
                e.type == CKEDITOR.NODE_ELEMENT && e.is("table"))return !1;
            var g;
            b = f[0];
            e = b.getAscendant("table");
            var k = CKEDITOR.tools.buildTableMap(e), l = k.length, m = k[0].length, n = b.getParent().$.rowIndex, u = h(k, n, b);
            if (c) {
                var A;
                try {
                    var C = parseInt(b.getAttribute("rowspan"), 10) || 1;
                    g = parseInt(b.getAttribute("colspan"), 10) || 1;
                    A = k["up" == c ? n - C : "down" == c ? n + C : n]["left" == c ? u - g : "right" == c ? u + g : u]
                } catch (G) {
                    return !1
                }
                if (!A || b.$ == A)return !1;
                f["up" == c || "left" == c ? "unshift" : "push"](new CKEDITOR.dom.element(A))
            }
            c = b.getDocument();
            var F = n,
                C = A = 0, I = !d && new CKEDITOR.dom.documentFragment(c), H = 0;
            for (c = 0; c < f.length; c++) {
                g = f[c];
                var K = g.getParent(), D = g.getFirst(), N = g.$.colSpan, R = g.$.rowSpan, K = K.$.rowIndex, P = h(k, K, g), H = H + N * R, C = Math.max(C, P - u + N);
                A = Math.max(A, K - n + R);
        ...
        function g(b, c) {
            ...
            if (c)return !0;
            var d = d[0], f = d.getParent(), e = f.getAscendant("table"), g = CKEDITOR.tools.buildTableMap(e), k = f.$.rowIndex, l = h(g, k, d), m = d.$.rowSpan, n;
            if (1 < m) {
                n = Math.ceil(m / 2);
                for (var m = Math.floor(m /
                    2), f = k + n, e = new CKEDITOR.dom.element(e.$.rows[f]), g = h(g, f), u, f = d.clone(), k = 0; k < g.length; k++)if (u = g[k], u.parentNode == e.$ && k > l) {
                    f.insertBefore(new CKEDITOR.dom.element(u));
                    break
                } else u = null;
                u || e.append(f)
            } else for (m = n = 1, e = f.clone(), e.insertAfter(f), e.append(f = d.clone()), u = h(g, k), l = 0; l < u.length; l++)u[l].rowSpan++;
            f.appendBogus();
            d.$.rowSpan = n;
            f.$.rowSpan = m;
        ...
        function n(b, c) {
            ...
            if (c)return !0;
            var d =
                d[0], f = d.getParent(), e = f.getAscendant("table"), e = CKEDITOR.tools.buildTableMap(e), g = h(e, f.$.rowIndex, d), k = d.$.colSpan;
            if (1 < k)f = Math.ceil(k / 2), k = Math.floor(k / 2); else {
                for (var k = f = 1, l = [], m = 0; m < e.length; m++) {
                    var n = e[m];
                    l.push(n[g]);
                    1 < n[g].rowSpan && (m += n[g].rowSpan - 1)
                }
                for (e = 0; e < l.length; e++)l[e].colSpan++
            }
            e = d.clone();
            e.insertAfter(d);
            e.appendBogus();
        ...
        CKEDITOR.plugins.tabletools =
        {
            ...
            var p = c.lang.table;
            r("cellProperties", new CKEDITOR.dialogCommand("cellProperties", h({
        ...
        function a(a) {
            function b() {
                for (var g = c(), h = CKEDITOR.tools.clone(a.config.toolbarGroups) ||
                    e(a), k = 0; k < h.length; k++) {
                    var m = h[k];
                    if ("/" != m) {
                        "string" == typeof m && (m = h[k] = {name: m});
                        var r, p = m.groups;
                        if (p)for (var w = 0; w < p.length; w++)r = p[w], (r = g[r]) && f(m, r);
                        (r = g[m.name]) && f(m, r)
                    }
                }
                return h
            ...
            function f(b,
                ...
                if (c.length) {
                    ...
                    for (var f; f = c.shift();)f = "string" == typeof f ? f : f.name, k && -1 != CKEDITOR.tools.indexOf(k, f) || (f = a.ui.create(f)) && a.addFeature(f) && b.items.push(f)
                }
            }
        ...
        CKEDITOR.plugins.add("toolbar", {
            requires: "button", init: function (d) {
                var e,
                    l = function (a, b) {
                        var c, g = "rtl" == d.lang.dir, n = d.config.toolbarGroupCycling, u = g ? 37 : 39, g = g ? 39 : 37, n = void 0 === n || n;
                        switch (b) {
                            case 9:
                            case CKEDITOR.SHIFT + 9:
                ...
                d.on("uiSpace", function (c) {
                    if (c.data.space == d.config.toolbarLocation) {
                        c.removeListener();
                        d.toolbox = new b;
                        var e = CKEDITOR.tools.getNextId(), k = ['\x3cspan id\x3d"', e, '" class\x3d"cke_voice_label"\x3e', d.lang.toolbar.toolbars, "\x3c/span\x3e", '\x3cspan id\x3d"' + d.ui.spaceId("toolbox") + '" class\x3d"cke_toolbox" role\x3d"group" aria-labelledby\x3d"', e, '" onmousedown\x3d"return false;"\x3e'], e = !1 !== d.config.toolbarStartupExpanded, g, m;
                        ...
                        for (var u = d.toolbox.toolbars, q = a(d), v = 0; v < q.length; v++) {
                            var r, p = 0, w, x = q[v], B;
                            if (x)if (g && (k.push("\x3c/span\x3e"), m = g = 0), "/" === x)k.push('\x3cspan class\x3d"cke_toolbar_break"\x3e\x3c/span\x3e'); else {
                                B = x.items || x;
                                    ...
                                    if (z) {
                                        ...
                                        if (z.type == CKEDITOR.UI_SEPARATOR)m = g && z; else {
                                            ...
                                            if (!p) {
                                                ...
                                                p = {id: r, items: []};
                                                w = x.name && (d.lang.toolbar.toolbarGroups[x.name] || x.name);
                                                k.push('\x3cspan id\x3d"', r, '" class\x3d"cke_toolbar"', w ? ' aria-labelledby\x3d"' + r + '_label"' : "", ' role\x3d"toolbar"\x3e');
                                                w && k.push('\x3cspan id\x3d"', r, '_label" class\x3d"cke_voice_label"\x3e', w, "\x3c/span\x3e");
                                                k.push('\x3cspan class\x3d"cke_toolbar_start"\x3e\x3c/span\x3e');
                                                var A = u.push(p) - 1;
                                                0 < A && (p.previous = u[A - 1], p.previous.next = p)
                                            }
                                            E ? g || (k.push('\x3cspan class\x3d"cke_toolgroup" role\x3d"presentation"\x3e'),
                                                g = 1) : g && (k.push("\x3c/span\x3e"), g = 0);
                                            m && (y(m), m = 0);
                                            y(z)
                                        }
                                    }
                        ...
                        if (d.config.toolbarCanCollapse && d.elementMode != CKEDITOR.ELEMENT_MODE_INLINE) {
                            ...
                            d.addCommand("toolbarCollapse", {
                                readOnly: 1, exec: function (a) {
                                    var b =
                                        a.ui.space("toolbar_collapser"), c = b.getPrevious(), d = a.ui.space("contents"), f = c.getParent(), e = parseInt(d.$.style.height, 10), g = f.$.offsetHeight, h = b.hasClass("cke_toolbox_collapser_min");
                            ...
                            k.push('" onclick\x3d"CKEDITOR.tools.callFunction(' + C + ')"\x3e', '\x3cspan class\x3d"cke_arrow"\x3e\x26#9650;\x3c/span\x3e',
                                "\x3c/a\x3e")
                        }
                        k.push("\x3c/span\x3e");
                        c.data.html += k.join("")
        ...
        CKEDITOR.plugins.add("undo", {
            init: function (c) {
                ...
                var g = c.undoManager = new b(c), l = g.editingHandler = new m(g), u = c.addCommand("undo", {
                    exec: function () {
                ...
                g.onChange = function () {
                    u.setState(g.undoable() ? CKEDITOR.TRISTATE_OFF : CKEDITOR.TRISTATE_DISABLED);
        ...
        m.prototype =
        {
            ...
            if (!(b.ieFunctionalKeysBug(a) && this.lastKeydownImage && this.lastKeydownImage.equalsContent(new c(d.editor,
            ...
            c.attachListener(c, CKEDITOR.env.ie ?
                "keypress" : "input", d.onInput, d, null, 999);
        ...
        function a(a) {
            ...
            if (CKEDITOR.env.webkit || CKEDITOR.env.ie && 10 < CKEDITOR.env.version)f.getDocumentElement().on("mousedown",
                function (a) {
            ...
            CKEDITOR.tools.setTimeout(function () {
                ...
                (c.focus(), this._.isPendingFocus = !1);
                setTimeout(function () {
                    c.fire("dataReady")
                }, 0)
            }, 0, this)
        ...
        function e(a) {
            ...
            if (CKEDITOR.env.gecko)try {
                ...
                e.execCommand("enableInlineTableEditing",
        ...
        CKEDITOR.plugins.add("wysiwygarea", {
            init: function (a) {
                ...
                a.addMode("wysiwyg", function (b) {
                    ...
                    var f = "document.open();" + (CKEDITOR.env.ie ? "(" + CKEDITOR.tools.fixDomain +
                        ")();" : "") + "document.close();", f = CKEDITOR.env.air ? "javascript:void(0)" : CKEDITOR.env.ie && !CKEDITOR.env.edge ? "javascript:void(function(){" + encodeURIComponent(f) + "}())" : "", h = CKEDITOR.dom.element.createFromHtml('\x3ciframe src\x3d"' + f + '" frameBorder\x3d"0"\x3e\x3c/iframe\x3e');
                    ...
                    if (n) {
                        var g = CKEDITOR.tools.getNextId(), u = CKEDITOR.dom.element.createFromHtml('\x3cspan id\x3d"' + g + '" class\x3d"cke_voice_label"\x3e' + n + "\x3c/span\x3e");
                        f.append(u, 1);
                ...
                setData: function (a, c) {
                    ...
                    if (c)this.setHtml(a), this.fixInitialSelection(), e.fire("dataReady");
                        ...
                        (a = "\x3cbody\x3e" + a), /<html[\s|>]/.test(a) || (a = "\x3chtml\x3e" + a + "\x3c/html\x3e"), /<head[\s|>]/.test(a) ? /<title[\s|>]/.test(a) || (a = a.replace(/<head[^>]*>/, "$\x26\x3ctitle\x3e\x3c/title\x3e")) : a = a.replace(/<html[^>]*>/, "$\x26\x3chead\x3e\x3ctitle\x3e\x3c/title\x3e\x3c/head\x3e"), n && (a = a.replace(/<head[^>]*?>/, "$\x26" + n)), a = a.replace(/<\/head\s*>/, g + "$\x26"), a = k + a) : a = f.docType + '\x3chtml dir\x3d"' + f.contentsLangDirection + '" lang\x3d"' + (f.contentsLanguage || e.langCode) + '"\x3e\x3chead\x3e\x3ctitle\x3e' +
                            this._.docTitle + "\x3c/title\x3e" + n + g + "\x3c/head\x3e\x3cbody" + (f.bodyId ? ' id\x3d"' + f.bodyId + '"' : "") + (f.bodyClass ? ' class\x3d"' + f.bodyClass + '"' : "") + "\x3e" + a + "\x3c/body\x3e\x3c/html\x3e";
                        ...
                        f = '\x3cscript id\x3d"cke_actscrpt" type\x3d"text/javascript"' + (CKEDITOR.env.ie ? ' defer\x3d"defer" ' : "") + "\x3evar wasLoaded\x3d0;function onload(){if(!wasLoaded)window.parent.CKEDITOR.tools.callFunction(" +
                    ...
                    a = this.editor;
                    var b = a.config, c = b.fullPage, e = c && a.docType, h = c && a.xmlDeclaration, k = this.getDocument(), c = c ? k.getDocumentElement().getOuterHtml() : k.getBody().getHtml();
                    ...
                    e && e.getParent() ? (e.clearCustomData(), (a = e.removeCustomData("onResize")) && a.removeListener(),
