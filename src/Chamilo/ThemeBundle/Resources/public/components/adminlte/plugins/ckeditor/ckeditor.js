...
(function () {
    ...
    CKEDITOR.dtd = function () {
        var a = CKEDITOR.tools.extend, e = function (a, d) {
            ...
            script: 1,
            style: 1
        }, g = {}, n = {"#": 1}, i = {center: 1, dir: 1, noframes: 1};
        a(b, {
            a: 1,
            abbr: 1,
            area: 1,
    ...
    (function () {
        ...
        function h(a) {
            var b, e = a.getRanges()[0], d = a.root, k = {
                table: 1,
                ul: 1,
                ol: 1,
                dl: 1
            ...
            var a = f ? function () {
                ...
                var b = function (b, c) {
                    ...
                    for (var e = d.children, f, g, h = b.duplicate(), l = 0, m = e.length - 1, j = -1, i, o; l <= m;) {
                        ...
                        if (i > 0)m = j - 1; else if (i < 0)l = j + 1; else return {
                            container: d,
                            offset: a(f)
                        }
                    }
        ...
        commands: {
            source: {
                modes: {
                    wysiwyg: 1,
                    source: 1
                }, editorFocus: !1, readOnly: 1, exec: function (c) {
