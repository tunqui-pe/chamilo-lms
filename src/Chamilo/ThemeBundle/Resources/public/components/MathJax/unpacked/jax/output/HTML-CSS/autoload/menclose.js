...
MathJax.Hub.Register.StartupHook("HTML-CSS Jax Ready", function () {
    ...
    MML.menclose.Augment({
                    ...
                    case MML.NOTATION.ROUNDEDBOX:
                        if (HTMLCSS.useVML) {
                            ...
                            this.HTMLvmlElement(vml, "shape", {
                                style: {
                                    width: this.HTMLpx(W - 2 * t),
                                    height: this.HTMLpx(H + D - 2 * t),
                                    left: this.HTMLpx(t, .5),
                                    top: this.HTMLpx(t, .5)
                                },
                            ...
                            this.HTMLsvgElement(svg.firstChild, "rect", {
                                x: 1,
                                y: 1,
                                width: this.HTMLpx(W - t) - 1,
                                height: this.HTMLpx(H + D - t) - 1,
                                rx: this.HTMLpx(Math.min(H + D, W) / 4)
                            });
                        }
                        break;
                    ...
                    case MML.NOTATION.CIRCLE:
                        if (HTMLCSS.useVML) {
                            ...
                            this.HTMLsvgElement(svg.firstChild, "ellipse", {
                                rx: this.HTMLpx(W / 2 - t),
                                ry: this.HTMLpx((H + D) / 2 - t),
                                cx: this.HTMLpx(W / 2),
                                cy: this.HTMLpx((H + D) / 2)
                            });
                        }
                        break;
                    ...
                    case MML.NOTATION.DOWNDIAGONALSTRIKE:
                        if (HTMLCSS.useVML) {
                            ...
                            this.HTMLvmlElement(vml, "line", {
                                from: "0,0",
                                to: this.HTMLpx(W) + "," + this.HTMLpx(H + D - t)
                            });
                        } else {
                            if (!svg) {
                                svg = this.HTMLsvg(stack, H, D, W, t, values.mathcolor)
        ...
        HTMLsvg: function (stack, H, D, W, t, color) {
            ...
            this.HTMLsvgElement(svg, "g", {
                fill: "none",
                stroke: color,
                "stroke-width": t * HTMLCSS.em
            });
            return svg;
        },
