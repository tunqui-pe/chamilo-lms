...
(function (HTMLCSS) {
    ...
    var delim = {
        ...
        0x21A5: {
            ...
            HW: [[0.816, ARROWS]],
            stretch: {
                bot: [0x5F, MAIN, 0.050, -0.010, 0.800],
                ext: [0x23D0, MAIN],
                top: [0x2191, MAIN]
            }
        },
        ...
        0x21A7: {
            ...
            HW: [[0.816, ARROWS]],
            stretch: {
                top: [0x22A4, MAINBOLD, 0.040, 0.000, 0.600],
                ext: [0x23D0, MAIN],
                bot: [0x2193, MAIN]
            }
        },
        ...
        0x2906: {
            ...
            stretch: {
                left: [0x21D0, MAIN],
                rep: [0x3D, MAIN],
                right: [0x2AE4, OPERATORS, 0.000, -0.090]
            }
        },
        0x2907: {
            dir: H,
        ...
        0x295A: {
            ...
            stretch: {
                left: [0x21BC, MAIN],
                rep: [0x2212, MAIN],
                right: [0x22A3, MAINBOLD, 0.000, 0.100, 0.600]
            }
        },
        0x295B: {
            dir: H,
        ...
        0x2997: {
            ...
            HW: [[0.932, MAIN]],
            stretch: {
                top: [0xE10D, SHAPES, 0.100, 0.050],
                ext: [0x23D0, MAIN, -0.100],
                bot: [0xE10C, SHAPES, 0.100]
            }
        },
        0x2998: {
            dir: V,
            HW: [[0.932, MAIN]],
            stretch: {
                top: [0xE10C, SHAPES, -0.100, 0.050],
                ext: [0x23D0, MAIN],
                bot: [0xE10D, SHAPES, -0.100]
            }
        },
        0x2A00: {
            dir: V,
