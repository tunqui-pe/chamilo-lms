...
(function (HTMLCSS) {
    ...
    var delim = {
        ...
        0x219E: // left two-headed arrow
        {
            dir: H,
            HW: [[1, AMS]],
            stretch: {left: [0x219E, AMS], rep: [0x2212, MAIN]}
        },
        0x21A0: // right two-headed arrow
        {
            dir: H,
            HW: [[1, AMS]],
            stretch: {right: [0x21A0, AMS], rep: [0x2212, MAIN]}
        },
        ...
        0x23B4: // top square bracket
        {
            ...
            stretch: {
                min: .5,
                left: [0x250C, AMS, 0, -.1],
                rep: [0x2212, MAIN, 0, .35],
                right: [0x2510, AMS, 0, -.1]
            }
        },
        ...
        0x294F: // up barb right down barb right harpoon
        {
            ...
            stretch: {
                min: .5,
                top: [0x21BE, AMS, .12, 0, 1.1],
                ext: [0x23D0, SIZE1],
                bot: [0x21C2, AMS, .12, 0, 1.1]
            }
        },
        ...
        0x2951: // up barb left down barb left harpoon
        {
            ...
            stretch: {
                min: .5,
                top: [0x21BF, AMS, .12, 0, 1.1],
                ext: [0x23D0, SIZE1],
                bot: [0x21C3, AMS, .12, 0, 1.1]
            }
        },
