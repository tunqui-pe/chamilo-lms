  ...
  d.Augment({
    ...
    createSpace: function (p, n, o, q, m, s) {
      ...
      if (p.isBox || s) {
        ...
        p = this.addElement(p, "span", {
          style: {height: r, verticalAlign: k},
          isMathJax: true
        })
      }
      if (q >= 0) {
    ...
    createRule: function (r, n, p, s, l) {
      ...
      var q = this.addElement(r, "span", {
        ...
        bbox: {h: n, d: p, w: s, rw: s, lw: 0, exactW: true},
        noAdjust: true,
        HH: n + p,
        isMathJax: true
      });
    ...
    createFrame: function (s, q, r, u, x, l) {
      ...
      var n = this.addElement(s, "span", {
        ...
        bbox: {h: q, d: r, w: u, rw: u, lw: 0, exactW: true},
        noAdjust: true,
        HH: q + r,
        isMathJax: true
      });
    ...
    alignBox: function (s, o, q, v) {
      ...
      b.Insert(s.style, ({
        right: {left: "", right: this.Em(k - v)},
        center: {left: n, marginLeft: p}
      })[o])
    },
          ...
          if (!this.isMultiline && this.Get("display") === "block" && A.bbox.width == null) {
            ...
            if (B) {
              ...
              b.Insert(A.style, ({
                ...
                right: {
                  marginLeft: d.Em(Math.max(0, A.bbox.w + B)),
                  marginRight: d.Em(-B)
                },
