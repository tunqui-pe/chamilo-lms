...
(function (e) {
    var Webcam = {
        ...
        init: function () {
            ...
            this.userMedia = this.userMedia && !!navigator.mediaDevices && !!e.URL;
        ...
        attach: function (t) {
            ...
            if (this.userMedia) {
                ...
                navigator.mediaDevices.getUserMedia({
                    ...
                    return o.dispatch("error", "Could not access webcam: " + e.name + ": " + e.message, e)
                })
            } else {
                e.Webcam = Webcam;
            ...
            if (this.params.crop_width && this.params.crop_height) {
                var n = Math.floor(this.params.crop_width * i);
                var l = Math.floor(this.params.crop_height * s);
                t.style.width = "" + n + "px";
                t.style.height = "" + l + "px";
                t.style.overflow = "hidden";
                t.scrollLeft = Math.floor(this.params.width / 2 - n / 2);
                t.scrollTop = Math.floor(this.params.height / 2 - l / 2)
            } else {
        ...
        dispatch: function () {
            ...
            if (this.hooks[t] && this.hooks[t].length) {
                for (var i = 0, s = this.hooks[t].length; i < s; i++) {
                    var r = this.hooks[t][i];
                    if (typeof r == "function") {
                        r.apply(this, a)
                    } else if (typeof r == "object" && r.length == 2) {
                        r[0][r[1]].apply(r[0], a)
                    } else if (e[r]) {
                        e[r].apply(e, a)
                    }
        ...
        getSWFHTML: function () {
            ...
            if (!this.swfURL) {
                ...
                if (a)this.swfURL = a + "/webcam.swf"; else this.swfURL = "webcam.swf"
            }
        ...
        upload: function (e, t, a) {
            ...
            var n = new Blob([this.base64DecToArr(r)], {type: "image/" + s});
            var l = new FormData;
            l.append(i, n, i + "." + s.replace(/e/, ""));
            o.send(l)
        }
    };
    Webcam.init();
