...
(function (e, t) {
    ...
    s.VERSION = "2.4.3", s.noConflict = function () {
    ...
    return s.Error = s.extend.call(Error, {
        ...
        show: function (e, t) {
            if (this._ensureElement()) {
                ...
                if (a && this.triggerMethod("before:swapOut", this.currentView, this, t), this.currentView && delete this.currentView._parent, d ? this.empty() : a && l && this.currentView.off("destroy", this.empty, this), l) {
                    e.once("destroy", this.empty, this), this._renderView(e), e._parent = this, a && this.triggerMethod("before:swap", e, this, t), this.triggerMethod("before:show", e, this, t), s.triggerMethodOn(e, "before:show", e, this, t), a && this.triggerMethod("swapOut", this.currentView, this, t);
        ...
        _triggerEventOnBehaviors: function (e) {
            for (var t = s._triggerMethod, i = this._behaviors, n = 0, r = i && i.length; r > n; n++)t(i[n], e)
        },
        _triggerEventOnParentLayout: function (e, t) {
            ...
            if (n) {
                ...
                var a = s.getOption(n, "childEvents"), d = n.normalizeMethods(a);
        ...
        childViewEventPrefix: "childview", sort: !0, constructor: function () {
            ...
            var e = this.children, t = this._filteredSortedModels(), n = i.find(t, function (t) {
            ...
            var i, n = this.getOption("sort") && this.children.length - 1 > t;
            ...
            this.listenTo(e, "all", function () {
                ...
                n[0] = t + ":" + r, n.splice(1, 0, e), s !== void 0 && i.isFunction(s[r]) && s[r].apply(this, n.slice(1)), this.triggerMethod.apply(this, n)
            })
        }, _getImmediateChildren: function () {
        ...
        constructor: function () {
            ...
            var t, i = s.getOption(e, "childViewContainer");
            if (i) {
                var n = s._getValue(i, e);
                if (t = "@" === n.charAt(0) && e.ui ? e.ui[n.substr(4)] : e.$(n), 0 >= t.length)throw new s.Error({
        ...
        create: function (e, t, n) {
            ...
            var s = i.extend({}, r), o = this.getClass(r), h = e[t];
            return h || (h = new o(t, n, s), e[t] = h, e.submodules[t] = h), h
        }, getClass: function (e) {
            var t = s.Module;
            ...
            var n;
            return i.isFunction(e) && e.prototype instanceof s.Module ? (n = t.constructor.prototype.startWithParent, i.isUndefined(n) ? !0 : n) : i.isObject(e) ? (n = e.startWithParent, i.isUndefined(n) ? !0 : n) : !0
