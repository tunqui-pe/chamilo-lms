...
//{input:"\\S", tag:"mo", output:"\u00A7", ttype:CONST},
    ...
    {
        input: "\\usepackage[usenames]{color}",
        tag: "mstyle",
        atname: "mathvariant",
        output: "X",
        atval: "false",
