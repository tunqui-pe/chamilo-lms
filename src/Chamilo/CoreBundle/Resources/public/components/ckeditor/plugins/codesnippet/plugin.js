...
(function () {
    ...
    function l(a) {
        ...
        a.widgets.add("codeSnippet", {
            ...
            highlight: function () {
                var e = this, f = this.data, b = function (a) {
    ...
    CKEDITOR.plugins.add("codesnippet", {
        ...
        lang: "bg,ca,cs,da,de,el,en,en-gb,eo,es,et,fa,fi,fr,fr-ca,he,hr,hu,it,ja,km,ku,lt,lv,nb,nl,no,pl,pt,pt-br,ro,ru,sk,sl,sq,sv,th,tr,tt,ug,uk,vi,zh,zh-cn",
        icons: "codesnippet",
        hidpi: !0,
        ...
        afterInit: function (a) {
            ...
            this.setHighlighter(new CKEDITOR.plugins.codesnippet.highlighter({
                languages: {
                    apache: "Apache",
                    bash: "Bash",
                    ...
                    var h = this;
                    k && CKEDITOR.scriptLoader.load(b + "lib/highlight/highlight.pack.js",
                        function () {
                            h.hljs = window.hljs;
                            c()
                        });
