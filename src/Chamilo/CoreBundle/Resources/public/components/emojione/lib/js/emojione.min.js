...
!function (a) {
    a.emojioneList = {
    ...
    }, a.shortnames = Object.keys(a.emojioneList).map(function (a) {
        return a.replace(/[+]/g, "\\$&")
    }).join("|"), a.asciiList = {
        "<3": "2764",
        "</3": "1f494",
        ...
        "😁": "1F601",
        "😀": "1F600"
    }, a.imagePathPNG = "//cdn.jsdelivr.net/emojione/assets/png/", a.imagePathSVG = "//cdn.jsdelivr.net/emojione/assets/svg/", a.imagePathSVGSprites = "./../assets/sprites/emojione.sprites.svg", a.imageType = "png", a.sprites = !1, a.unicodeAlt = !0, a.ascii = !1, a.cacheBustParam = "?v=1.2.4", a.toImage = function (b) {
        ...
        return b = b.replace(new RegExp("<object[^>]*>.*?</object>|<span[^>]*>.*?</span>|<(?:object|embed|svg|img|div|span|p|a)[^>]*>|(" + a.shortnames + ")", "gi"), function (b) {
        ...
        for (var c in a.emojioneList)if (a.emojioneList.hasOwnProperty(c))for (var d = 0, e = a.emojioneList[c].length; e > d; d++) {
            var f = a.emojioneList[c][d].toUpperCase();
            b = a.replaceAll(b, a.convert(f), c)
        }
        return b
        ...
        var b = {};
        for (var c in a.emojioneList)if (a.emojioneList.hasOwnProperty(c))for (var d = 0, e = a.emojioneList[c].length; e > d; d++)b[a.emojioneList[c][d].toUpperCase()] = c;
        return b
