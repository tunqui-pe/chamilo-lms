 ...
 * Usergroup changes
 */
class Version20150522112023 implements Migration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema, QueryBag $queries)
    {
        ...
        $queries->addQuery(
            'ALTER TABLE usergroup ADD group_type INT NOT NULL, ADD created_at DATETIME NOT NULL, ADD updated_at DATETIME NOT NULL'
        );
        $queries->addQuery(
            'ALTER TABLE usergroup ADD picture VARCHAR(255) DEFAULT NULL, ADD url VARCHAR(255) DEFAULT NULL, ADD visibility VARCHAR(255) NOT NULL, ADD allow_members_leave_group INT NOT NULL, CHANGE description description LONGTEXT DEFAULT NULL'
        );
        $queries->addQuery(
        ...
        $queries->addQuery(
            'ALTER TABLE usergroup_rel_user ADD relation_type INT'
        );
