    ...
    VersionedFixtureInterface
{
    ...
    public function createSettings(ObjectManager $manager)
    {
        ...
        $setting->setCategory('Security');
        $setting->setSelectedValue(
            'htm;html;jpg;jpeg;gif;png;swf;avi;mpg;mpeg;mov;flv;doc;docx;xls;xlsx;ppt;pptx;odt;odp;ods;pdf,webm,oga,ogg,ogv,h264'
        );
...
*/
        ...
        $setting->setComment(
            'DocumentsDefaultVisibilityDefinedInCourseComment'
        );
        $setting->setScope('');
        $setting->setSubkeytext('');
        $setting->setAccessUrlChangeable('1');
