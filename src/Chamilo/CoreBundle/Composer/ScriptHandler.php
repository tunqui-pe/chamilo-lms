...
class ScriptHandler
{
    ...
    public static function deleteOldFilesFrom19x()
    {
        $paths = [
            ...
            __DIR__.'/../../../../main/inc/lib/mimetex/',
            __DIR__.'/../../../../main/inc/lib/mp3player/',
            __DIR__.'/../../../../main/inc/lib/flv_player/',
        ...
        $files = [
            ...
            __DIR__.'/../../../../main/inc/global_error_message.inc.php',
            __DIR__.'/../../../../main/inc/introductionSection.inc.php',
            __DIR__.'/../../../../main/inc/local.inc.php',
