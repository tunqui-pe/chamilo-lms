...
$cataloguePagination = $pageTotal > 1 ?
    CourseCategoryManager::getCatalogPagination($pageCurrent, $pageLength, $pageTotal) :
    '';
...
<div class="row">
    <div class="col-md-4">
        ...
        if ($showCourses) {
            ...
            <form class="form-horizontal" method="post" action="<?php echo CourseCategoryManager::getCourseCategoryUrl(1, $pageLength, 'ALL', 0, 'subscribe'); ?>">
...
<?php
    if ($showSessions) { ?>
        <div class="col-md-4">
            ...
            <a class="btn btn-default btn-block" href="<?php echo CourseCategoryManager::getCourseCategoryUrl(1, $pageLength, null, 0, 'display_sessions'); ?>">
