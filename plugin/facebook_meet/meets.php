<?php
/**
 * This script initiates a video conference session, c the Facebook Meet.
 */
        ...
        if ($action) {
            switch ($action) {
                case 'delete':
                    ...
                    if ($res) {
                        $url = api_get_path(WEB_PLUGIN_PATH).'facebook_meet/start.php?'.api_get_cidreq();
                        header('Location: '.$url);
                    }
                ...
                case 'add':
                    $actionLinks .= Display::url(
                        ...
                        api_get_path(WEB_PLUGIN_PATH).'facebook_meet/start.php?'.api_get_cidreq()
                    );
                    //create form
                    ...
                    $form->addText(
                        'meet_url',
                        [
                            $plugin->get_lang('FacebookMeetURL'),
                            sprintf($plugin->get_lang('FacebookMeetURLHelp'), FacebookMeetPlugin::FACEBOOK_MEET_URL),
                        ],
                        true,
                        [
                            'title' => sprintf($plugin->get_lang('FacebookMeetURLHelp'), FacebookMeetPlugin::FACEBOOK_MEET_URL),
                        ]
                    );
