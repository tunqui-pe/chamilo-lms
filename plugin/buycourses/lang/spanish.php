...
$strings['TheActualPlatformCommissionIsX'] = "La actual comisión de la plataforma es de <strong> %s </strong>, este porcentaje será descontado del total del precio del producto cuya diferencia será el monto base para aplicar estas comisiones.";
...
$strings['CautionThisProcessCantBeCanceled'] = "<strong>Precaución</strong>: este proceso puede tomar unos minutos y no puede ser cancelado.";
$strings['ProcessingPayoutsDontCloseThisWindow'] = "<strong>Procesando los pagos, no cierre esta ventana hasta que haya finalizado</strong>";
...
$strings['CourseListOnSale'] = "Lista de cursos y diplomados a la venta";
...
$strings['PaymentMethods'] = "Escoge un método de pago";
...
$strings['SubscriptionToCourseXSuccessful'] = "<p class=\"lead\">Tu subscripción al curso se realizó correctamente, puedes dirigirte a <a class='my-courses-links' href=\"%s\"><strong>\"%s\"</strong></a> .</p>";
...
$strings['PendingReasonByAddress'] = "<strong>Pendiente</strong>. No has ingresado una dirección de correo confirmada.";
$strings['PendingReasonByAuthorization'] = "<strong>Pendiente</strong>. No hemos recibido los fondos.";
$strings['PendingReasonByEcheck'] = "<strong>Pendiente</strong>. El pago fue hecho a través de un eCheck que aún no está declarado";
$strings['PendingReasonByIntl'] = "<strong>Pendiente</strong>. No tenemos un mecanismo de retiro de fondos.";
$strings['PendingReasonByMulticurrency'] = "<strong>Pending</strong>. No podemos realizar el cambio de moneda.";
$strings['PendingReasonByOrder'] = "<strong>Pendiente</strong>. Pedido realizado. No hemos recibido los fondos.";
$strings['PendingReasonByPaymentReview'] = "<strong>Pendiente</strong>. El pago está siendo revisado por PayPal por riesgo.";
$strings['PendingReasonByRegulatoryReview'] = "<strong>Pendiente</strong>. El pago está siendo revisado por cumplimiento con regulaciones gubernamentales.";
$strings['PendingReasonByUnilateral'] = "<strong>Pendiente</strong>. La dirección de correo electrónico aún no está registrada o confirmada.";
$strings['PendingReasonByUpgrade'] = "<strong>Pendiente</strong>. El pago fue realizado a través de una tarjeta de crédito.";
$strings['PendingReasonByVerify'] = "<strong>Pendiente</strong>. Lo sentimos. Todavía no estamos verificados en PayPal.";
$strings['PendingReasonByOther'] = "<strong>Pendiente</strong>. Por favor contacta al administrador de la plataforma.";
...
$strings['ShowOnCourseCatalog'] = "Mostrar en el catálogo de cursos, si no esta marcado los valores son reseteados.";
...
$strings['TextTransferData'] = "Una vez realizada la transferencia o depósito bancario, debes enviarnos tu comprobante de pago al e-mail <strong>karen@educacionchile.cl</strong> junto con tu <strong>nombre, e-mail y curso</strong>. Con estos datos, podremos validar tu inscripción y habilitar el acceso a tu curso online.";
...
$strings['Rut'] = "RUT";
$strings['Headline'] = "Titular";
$strings['CheckYourEmailAndFollowInstructions'] = "Ingresar tu nueva contraseña para el acceso a tu plataforma.";
$strings['toCompleteYourRegistration'] = "Esperando que te encuentres bien y para poder completar tu inscripción, te solicitamos por favor realizar el depósito o transferencia, a la siguiente cuenta bancaria.";
$strings['ResendProof'] = "Una vez realizada, debes enviarnos tu comprobante de pago al email <strong>karen@educacionchile.cl</strong> junto con tu <strong>nombre, e-mail y curso</strong>. Con estos datos, podremos validar tu inscripción y habilitar el acceso a tu curso online.";
$strings['weAcceptDeposit'] = "Una vez que validemos tu deposito, habilitaremos e informaremos vía email.";
$strings['weAlreadyAppreciate'] = "Desde ya agradecemos tu interés por participar en nuestros cursos y diplomados online";
$strings['registrationData'] = "Datos de inscripción";
$strings['regardsEducaChile'] = "Saludos.<br> EQUIPO ONLINE<br>Educación Chile";
$strings['helloUser'] = 'Hola!';
$strings['howAreYour'] = '¿cómo estás?';
$strings['payPal'] = "<strong>PAYPAL:</strong> Tarjeta de Crédito Internacional (Para cursos internacionales)";
$strings['serviPag'] = "<strong>SERVIPAG:</strong>  Bancos, tarjetas de casas comerciales y pago en efectivo (Bancos nacionales, tarjetas Cencosud, Ripley y CMR y sucursales Servipag).";
...
$strings['wireTransfer']="<strong>TRANSFERENCIA BANCARIA:</strong> Transferencia o depósito bancario nacional (Chile).";
$strings['payCajaAndes']="<strong>CAJA LOS ANDES:</strong> Convenio para afiliados a la caja de compensación Los Andes.";
...
$strings['confirmWebPay'] = "Te queremos confirmar que tu pago ha sido recibido correctamente, a traves de WebPay Plus";
$strings['Detailsofpayment'] = "Datos del pago";
$strings['CardNumber'] = "Número de tarjeta";
$strings['DateAndTime'] = "Fecha";
$strings['Establishment'] = "Establecimiento";
$strings['AuthorizationCode'] = "Código de autorización";
$strings['PaymentType'] = "Tipo de pago";
$strings['TheNextPurchase'] = "Se está procediendo a realizar la siguiente compra";
$strings['TransbankFailureMessage'] = "Pago fallido o cancelado.";
...
$strings['TheCourses'] = "Cursos";
$strings['TheGraduates'] = "Diplomados";
$strings['AndesBoxBenefits'] = 'Información beneficio Caja los Andes';
$strings['ApplyYourDiscount'] = 'Con estos datos, podremos validar y aplicar tu descuento.';
$strings['WaitingBoxAndesValidation'] = '<strong>Pendiente.</strong> Esperando validación Caja Los Andes';
$strings['AndesBoxInformation'] = 'Para poder obtener el beneficio de descuento como afiliado a Caja Los Andes, deberás enviarnos un e-mail a <strong>karen@educacionchile.cl</strong>, junto con tu Rut, nombre completo, e-mail y curso o diplomado.';
