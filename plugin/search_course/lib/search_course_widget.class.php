...
EOT;
    ...
    function display_list($courses)
    {
        ...
        $display_coursecode = (api_get_setting('course.display_coursecode_in_courselist') == 'true');
        $display_teacher = (api_get_setting('course.display_teacher_in_courselist') == 'true');
