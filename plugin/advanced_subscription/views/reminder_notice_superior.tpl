                    ...
                    <td valign="top"><p>{{ "MailDear" | get_plugin_lang("AdvancedSubscriptionPlugin") }}</p>
                        ...
                        <table width="100%" border="0" cellspacing="3" cellpadding="4" style="background:#EDE9EA">
                            ...
                            <tr>
                                ...
                                <td valign="middle"><a href="{{ student.acceptUrl }}">
                                    <img src="{{ asset('plugins/advanced_subscription/img/aprobar.png') }}" width="90" height="25" alt=""></a></td>
                                <td valign="middle"><a href="{{ student.rejectUrl }}">
                                    <img src="{{ asset('plugins/advanced_subscription/img/desaprobar.png') }}" width="90" height="25" alt=""></a></td>
                            </tr>
                            {% endfor %}
                        </table>
